...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Asistența pentru baze de date nu a fost găsită. Asigurați-vă că aveți driverele necesare pentru unul dintre următoarele tipuri de baze de date acceptate: MySQL, MS SQLServer, Oracle sau DB2. S-ar putea să fie necesar să scoateți extensia din fișierul php.ini sau să recompilați cu fișierul binar corect, în funcție de versiunea dvs. PHP. Consultați manualul PHP pentru mai multe informații despre cum să activați Asistența pentru baza de date.',
