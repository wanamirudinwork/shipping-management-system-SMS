...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Поддръжката на базата данни не беше намерена.  Моля, уверете се, че имате необходимите драйвери за един от следните поддържани типове бази данни: MySQL, MS SQLServer, Oracle или DB2.  Може да се наложи да отмените коментара на разширението в php.ini файла или да го прекомпилирате с правилния двоичен файл, в зависимост от вашата версия на PHP.  Моля, вижте вашето ръководство за PHP за повече информация как да активирате поддръжката на бази данни.',
