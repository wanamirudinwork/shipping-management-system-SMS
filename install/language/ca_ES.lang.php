...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat el suport de la base de dades.  Assegureu-vos que teniu els controladors necessaris per a un dels següents tipus de bases de dades compatibles: MySQL, MS SQLServer, Oracle o DB2.  És possible que hàgiu de descomentar l\'extensió al fitxer php.ini o tornar a compilar amb el fitxer binari correcte, depenent de la vostra versió de PHP.  Consulteu el manual de PHP per obtenir més informació sobre com habilitar el suport de bases de dades.',
