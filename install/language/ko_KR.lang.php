...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '데이터베이스 지원을 찾을 수 없습니다.  지원되는 데이터베이스 유형 MySQL, MS SQLServer, Oracle 또는 DB2 중 하나에 필요한 드라이버가 있는지 확인하십시오.  PHP 버전에 따라 php.ini 파일에서 확장 기능의 주석 처리를 제거하거나 올바른 이진 파일로 다시 컴파일해야 할 수 있습니다.  데이터베이스 지원을 활성화하는 방법에 대한 자세한 내용은 PHP 설명서를 참조하십시오.',
