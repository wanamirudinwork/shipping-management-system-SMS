...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se encontró soporte para bases de datos.  Asegúrese de tener los controladores necesarios para uno de los siguientes tipos de bases de datos compatibles: MySQL, MS SQLServer, Oracle o DB2.  Es posible que deba descomentar la extensión en el archivo php.ini o volver a compilar con el archivo binario correcto, en función de su versión de PHP.  Consulte su manual de PHP para obtener más información sobre cómo habilitar el soporte de bases de datos.',
