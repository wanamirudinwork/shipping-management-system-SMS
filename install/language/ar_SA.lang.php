...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على دعم قاعدة البيانات.  يرجى التأكد من أن لديك برامج التشغيل اللازمة لأحد أنواع قواعد البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2.  قد تحتاج إلى إلغاء ربط الامتداد في ملف php.ini، أو إعادة التحويل البرمجي باستخدام الملف الثنائي الصحيح، اعتمادا على إصدار PHP الخاص بك.  يرجى الرجوع إلى دليل PHP لديك للحصول على مزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
