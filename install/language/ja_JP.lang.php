...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'データベースサポートが見つかりませんでした。 サポートされているデータベースタイプ (MySQL、MS SQLServer、Oracle、またはDB2) のいずれかに必要なドライバーがあることを確認してください。 PHP のバージョンによっては、php.ini ファイル内の拡張子のコメントを削除するか、適切なバイナリファイルで再コンパイルする必要がある場合があります。 データベースサポートを有効にする方法の詳細については、PHPマニュアルを参照してください。',
