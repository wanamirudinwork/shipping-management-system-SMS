...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri Tabanı Desteği bulunamadı.  Lütfen şu desteklenen Veri Tabanı Türlerinden biri için gerekli sürücülere sahip olduğunuzdan emin olun: MySQL, MS SQLServer, Oracle veya DB2.  PHP sürümünüze bağlı olarak php.ini dosyasındaki uzantıyı kaldırmanız veya doğru ikili dosyayla yeniden derlemeniz gerekebilir.  Veri Tabanı Desteğinin nasıl etkinleştirileceği ile ilgili daha fazla bilgi için lütfen PHP Kılavuzunuza bakın.',
