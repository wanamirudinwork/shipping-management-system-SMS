...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podrška za bazu podataka nije pronađena.  Proverite da li imate potrebne upravljačke programe za jedan od sledećih podržanih tipova baze podataka: MySQL, MS SQLServer, Oracle ili DB2.  Možda ćete morati da poništite komentar za ekstenziju u php.ini datoteci  ili da ponovo kompajlirate sa odgovarajućom binarnom datotekom, u zavisnosti od vaše verzije PHP-a. Pogledajte svoj PHP priručnik za više informacija o tome kako omogućiti podršku za bazu podataka.',
