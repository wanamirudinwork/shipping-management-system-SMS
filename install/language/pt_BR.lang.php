...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte ao banco de dados não foi encontrado.  Certifique-se de ter os drivers necessários para um dos seguintes tipos de banco de dados suportados: MySQL, MS SQLServer, Oracle ou DB2.  Pode ser necessário descomentar a extensão no arquivo php.ini ou recompilar com o arquivo binário correto, dependendo da sua versão do PHP.  Consulte o Manual do PHP para obter mais informações sobre como habilitar o Suporte ao Banco de Dados.',
