...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Database-ondersteuning is niet gevonden.  Zorg ervoor dat u over de benodigde stuurprogramma\'s beschikt voor een van de volgende ondersteunde databasetypen: MySQL, MS SQLServer, Oracle of DB2.  Mogelijk moet u de extensie in het php.ini bestand verwijderen of opnieuw compileren met het juiste binaire bestand, afhankelijk van uw versie van PHP.  Raadpleeg uw PHP-handleiding voor meer informatie over het inschakelen van databaseondersteuning.',
