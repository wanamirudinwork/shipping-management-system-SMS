...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '找不到数据库支持。请确保您拥有以下受支持数据库类型之一所需的驱动程序：MySQL、MS SQLServer、Oracle 或 DB2。您可能需要取消 php.ini 文件中的扩展名注释，或者使用正确的二进制文件重新编译，具体取决于您的 PHP 版本。有关如何启用数据库支持的更多信息，请参阅您的 PHP 手册。',
