...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Datenbankunterstützung wurde nicht gefunden. Bitte stellen Sie sicher, dass Sie über die erforderlichen Treiber für einen der folgenden unterstützten Datenbanktypen verfügen: MySQL, MS SQLServer, Oracle oder DB2. Je nach PHP-Version müssen Sie möglicherweise die Erweiterung in der php.ini-Datei auskommentieren oder mit der richtigen Binärdatei neu kompilieren. Bitte lesen Sie in Ihrem PHP-Handbuch nach, um weitere Informationen darüber zu erhalten, wie Sie die Datenbankunterstützung aktivieren können.',
