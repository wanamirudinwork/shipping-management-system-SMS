...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Supporto database non trovato.  Assicurati di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SQLServer, Oracle o DB2.  Potrebbe essere necessario decommentare l\'estensione nel file php.ini o ricompilare con il file binario corretto, a seconda della versione di PHP in uso. Consulta il manuale PHP per ulteriori informazioni su come abilitare il supporto del database.',
