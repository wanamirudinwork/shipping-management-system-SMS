...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '找不到資料庫支援。請確保您擁有以下支援資料庫類型之一所需的驅動程式：MySQL、MS SQLServer、Oracle 或 DB2。 可能需要取消 php.ini 檔中的副檔名註解，或者使用正確的二進位檔重新編譯，具體取決於您的 PHP 版本。如需更多啟用資料庫支援方法的相關資訊，請參閱 PHP 手冊。',
