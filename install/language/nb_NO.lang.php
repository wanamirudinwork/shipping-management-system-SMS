...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasestøtte ikke funnet.  Sørg for at du har de nødvendige driverne for en av følgende støttede databasetyper: MySQL, MS SQLServer, Oracle eller DB2.  Du må kanskje fjerne kommentaren til utvidelsen i php.ini filen, eller sette sammen på nytt med riktig binær fil, avhengig av din versjon av PHP.  Se PHP-håndboken for mer informasjon om hvordan du aktiverer databasestøtte.',
