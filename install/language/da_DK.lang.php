...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databaseunderstøttelse blev ikke fundet.  Sørg for, at du har de nødvendige drivere til en af følgende understøttede databasetyper: MySQL, MS SQLServer, Oracle eller DB2.  Du skal muligvis fjerne kommentaren til udvidelsen i php.ini filen eller kompilere igen med den rigtige binære fil, afhængigt af din version af PHP.  Se venligst din PHP-manual for mere information om, hvordan du aktiverer databaseunderstøttelse.',
