...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'לא נמצאה תמיכה במסד הנתונים. ודא/י שברשותך מנהלי ההתקנים הדרושים לאחד מהסוגים הנתמכים הבאים של מסדי נתונים: MySQL‏, MS SQLServer‏, Oracle או DB2. ייתכן שיהיה צורך להסיר את הסיומת ממעמד של הערה בקובץ php.ini או לבצע הידור מחדש עם הקובץ הבינארי המתאים, בהתאם לגרסת ה-PHP שלך. במדריך ה-PHP אפשר למצוא מידע נוסף המסביר איך לאפשר תמיכה במסדי נתונים.',
