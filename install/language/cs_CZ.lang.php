...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podpora databáze nebyla nalezena.  Ujistěte se, že máte potřebné ovladače pro jeden z následujících podporovaných typů databází: MySQL, MS SQLServer, Oracle nebo DB2.  V závislosti na verzi PHP může být nutné odkomentovat příponu v souboru php.ini nebo znovu zkompilovat pomocí správného binárního souboru.  Další informace o tom, jak povolit podporu databáze, naleznete v příručce PHP.',
