...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt.  Varmista, että sinulla on tarvittavat ohjaimet jollekin seuraavista tuetuista tietokantatyypeistä: MySQL, MS SQLServer, Oracle tai DB2.  Sinun on ehkä poistettava php.ini tiedoston päätteen kommentti tai käännettävä uudelleen oikealla binääritiedostolla PHP-versiostasi riippuen.  Katso PHP-oppaastasi lisätietoja tietokantatuen käyttöönotosta.',
