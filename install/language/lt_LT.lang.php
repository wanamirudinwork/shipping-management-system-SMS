...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Duomenų bazės palaikymas nerastas.  Įsitikinkite, kad turite reikiamas tvarkykles vienam iš šių palaikomų duomenų bazių tipų: MySQL, MS SQLServer, Oracle arba DB2.  Gali tekti panaikinti plėtinio komentarus php.ini faile arba perkompiliuoti naudojant tinkamą dvejetainį failą, atsižvelgiant į jūsų PHP versiją.  Daugiau informacijos apie tai, kaip įjungti duomenų bazės palaikymą, rasite savo PHP vadove.',
