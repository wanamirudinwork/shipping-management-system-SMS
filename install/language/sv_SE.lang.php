...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Det gick inte att hitta databassupport.  Se till att du har de nödvändiga drivrutinerna för någon av följande databastyper som stöds: MySQL, MS SQLServer, Oracle eller DB2.  Du kan behöva ta bort kommentaren till tillägget i filen php.ini eller kompilera om med rätt binär fil, beroende på din version av PHP.  Se din PHP-manual för mer information om hur du aktiverar databasstöd.',
