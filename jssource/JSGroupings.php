...
$js_groupings = [
    ...
    $sugar_grp_sidecar = array_merge(
        ...
        [
            ...
            'sidecar/node_modules/date-fns/cdn.min.js' => 'include/javascript/sugar_sidecar.js',
            'sidecar/node_modules/chartjs-adapter-date-fns/dist/chartjs-adapter-date-fns.min.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/chartjs/chartjs-plugin-annotation.min.js' => 'include/javascript/sugar_sidecar.min.js',
            ...
            'include/javascript/sugar7/plugins/QuotesConversionRateLocking.js' => 'include/javascript/sugar_sidecar.min.js',
    ...
    $sugar_grp_sugar7 = [
        ...
        'include/javascript/jszip/jszip.min.js' => 'include/javascript/sugar_grp7.min.js',
        'include/javascript/filesaver/FileSaver.min.js' => 'include/javascript/sugar_grp7.min.js',
    ],
    ...
    $sugar_grp_calendar = [
        ...
        'include/javascript/calendar/fonts.js' => 'include/javascript/sugar_grp_calendar.js',
    ],
];
