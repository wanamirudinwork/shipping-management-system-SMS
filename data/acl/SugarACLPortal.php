...
class SugarACLPortal extends SugarACLStatic
{
    ...
    /**
     * List of fields portal users cannot read.
     * @var array
     */
    protected $fieldsNoReadList = [
        'team_id',
        'team_set_id',
        'acl_team_set_id',
        'teams',
    ...
    protected function fieldACL($module, $action, $context)
    {
        ...
        if ($accessGranted !== false && !empty($context['field']) &&
            in_array($action, ['list', 'read']) &&
            in_array($context['field'], $this->fieldsNoReadList)) {
            $accessGranted = false;
        }
