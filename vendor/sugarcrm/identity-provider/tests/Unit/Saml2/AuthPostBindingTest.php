 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Saml2\AuthPostBinding::class)]
class AuthPostBindingTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var string
     */
