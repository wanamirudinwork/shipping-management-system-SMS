 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Saml2\Request\LogoutPostRequest::class)]
class LogoutPostRequestTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testNotSignedLogoutRequest()
    {
        ...
        self::assertStringNotContainsString('<ds:SignatureMethod Algorithm', $xmlRequest);
    }
    ...
    {
        $this->expectException(\Sugarcrm\IdentityProvider\Authentication\Exception\ConfigurationException::class);
