 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Saml2\AuthRedirectBinding::class)]
class AuthRedirectBindingTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var AuthRedirectBinding | \PHPUnit\Framework\MockObject\MockObject
     */
    protected $auth = null;
    ...
    public function testLogout()
    {
        ...
        self::assertStringContainsString('http://idp.com/saml/slo?SAMLRequest=', $result->getUrl());
    }
    ...
    public function testProcessServiceSLOLogoutResponseNotCreated()
    {
        ...
        $this->expectExceptionMessage('SAML response is not valid');
    ...
    {
        $this->expectException(\OneLogin\Saml2\Error::class);
        $this->expectExceptionMessage('SAML response is not success');
    ...
    {
        $this->expectException(\OneLogin\Saml2\Error::class);
        $this->expectExceptionMessage('SAML request is not valid');
     ...
     * @return array
     */
    public static function processIdpSLOProvider()
    {
        return [
     ...
     *
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('processIdpSLOProvider')]
     ...
     * @return array
     */
    public static function isUserProvisionNeededDataProvider()
    {
        return [
     ...
     * @param bool $result
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('isUserProvisionNeededDataProvider')]
     ...
     * @return array
     */
    public static function neededValidationRequestIdProvider()
    {
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('neededValidationRequestIdProvider')]
