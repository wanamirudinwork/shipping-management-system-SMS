...
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Authentication\Token\SAML\ResultToken::class)]
class ResultTokenTest extends \PHPUnit\Framework\TestCase
{
    public function testTokenCreation()
    {
        ...
        $this->assertEquals(Providers::PROVIDER_KEY_SAML, $resultToken->getProviderKey());
    }
}
