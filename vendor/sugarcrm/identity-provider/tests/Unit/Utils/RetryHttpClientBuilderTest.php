...
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Utils\RetryHttpClientBuilder::class)]
class RetryHttpClientBuilderTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return array
     */
    public static function delayExponentialProvider()
    {
        return [
            [0, 0],
            [1, 1000],
     ...
     *
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('delayExponentialProvider')]
     ...
     * @return array
     */
    public static function delayLinearProvider()
    {
        return [
            [0, 0],
            [1, 1000],
     ...
     *
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('delayLinearProvider')]
     ...
     * @return array
     */
    public static function getDelayStrategyProvider()
    {
        return [
            [[], 5000],
            [
     ...
     *
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('getDelayStrategyProvider')]
     ...
     * @return array
     */
    public static function retryDeciderProvider()
    {
        return [
     ...
     *
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('retryDeciderProvider')]
