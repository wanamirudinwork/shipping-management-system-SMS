...
final class SocketServer extends EventEmitter implements ServerInterface
{
    ...
    public function __construct($uri, array $context = array(), $loop = null)
    {
        if ($loop !== null && !$loop instanceof LoopInterface) {
            ...
            throw new \InvalidArgumentException('_PHPStan_14faee166\\Argument #3 ($loop) expected null|React\\EventLoop\\LoopInterface');
        }
    ...
    public static function errno($errstr)
    {
        ...
        if ($strerror !== null) {
            ...
            for ($errno = 1, $max = \defined('_PHPStan_14faee166\\MAX_ERRNO') ? \_PHPStan_14faee166\MAX_ERRNO : 4095; $errno <= $max; ++$errno) {
