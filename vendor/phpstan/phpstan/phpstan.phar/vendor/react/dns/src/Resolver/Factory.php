...
namespace _PHPStan_14faee166\React\Dns\Resolver;

use _PHPStan_14faee166\React\Cache\ArrayCache;
use _PHPStan_14faee166\React\Cache\CacheInterface;
use _PHPStan_14faee166\React\Dns\Config\Config;
use _PHPStan_14faee166\React\Dns\Config\HostsFile;
use _PHPStan_14faee166\React\Dns\Query\CachingExecutor;
use _PHPStan_14faee166\React\Dns\Query\CoopExecutor;
use _PHPStan_14faee166\React\Dns\Query\ExecutorInterface;
use _PHPStan_14faee166\React\Dns\Query\FallbackExecutor;
use _PHPStan_14faee166\React\Dns\Query\HostsFileExecutor;
use _PHPStan_14faee166\React\Dns\Query\RetryExecutor;
use _PHPStan_14faee166\React\Dns\Query\SelectiveTransportExecutor;
use _PHPStan_14faee166\React\Dns\Query\TcpTransportExecutor;
use _PHPStan_14faee166\React\Dns\Query\TimeoutExecutor;
use _PHPStan_14faee166\React\Dns\Query\UdpTransportExecutor;
use _PHPStan_14faee166\React\EventLoop\Loop;
...
final class Factory
{
    ...
    public function create($config, $loop = null)
    {
        if ($loop !== null && !$loop instanceof LoopInterface) {
            ...
            throw new \InvalidArgumentException('_PHPStan_14faee166\\Argument #2 ($loop) expected null|React\\EventLoop\\LoopInterface');
        }
    ...
    public function createCached($config, $loop = null, $cache = null)
    {
        ...
        if ($cache !== null && !$cache instanceof CacheInterface) {
            // manual type check to support legacy PHP < 7.1
            throw new \InvalidArgumentException('_PHPStan_14faee166\\Argument #3 ($cache) expected null|React\\Cache\\CacheInterface');
        }
