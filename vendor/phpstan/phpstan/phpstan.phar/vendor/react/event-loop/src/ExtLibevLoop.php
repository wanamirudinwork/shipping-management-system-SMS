...
use _PHPStan_14faee166\libev\EventLoop;
use _PHPStan_14faee166\libev\IOEvent;
use _PHPStan_14faee166\libev\SignalEvent;
use _PHPStan_14faee166\libev\TimerEvent;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('_PHPStan_14faee166\\libev\\EventLoop', \false)) {
