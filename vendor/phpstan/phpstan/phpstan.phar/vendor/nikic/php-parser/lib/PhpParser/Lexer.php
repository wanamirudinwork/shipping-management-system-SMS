...
class Lexer
{
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('_PHPStan_14faee166\\T_ONUMBER')) {
            $tokenMap[\_PHPStan_14faee166\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('_PHPStan_14faee166\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\_PHPStan_14faee166\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
