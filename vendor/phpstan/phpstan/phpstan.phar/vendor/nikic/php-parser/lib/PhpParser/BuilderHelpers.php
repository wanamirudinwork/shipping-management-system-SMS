...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('_PHPStan_14faee166\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('_PHPStan_14faee166\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    public static function normalizeName($name) : Name
    {
        ...
        throw new \LogicException('_PHPStan_14faee166\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeNameOrExpr($name)
    {
        ...
        if (!\is_string($name) && !$name instanceof Name) {
            throw new \LogicException('_PHPStan_14faee166\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
