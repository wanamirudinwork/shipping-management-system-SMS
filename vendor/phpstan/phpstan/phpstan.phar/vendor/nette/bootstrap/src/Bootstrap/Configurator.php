...
namespace _PHPStan_14faee166\Nette\Bootstrap;

use _PHPStan_14faee166\Composer\Autoload\ClassLoader;
use _PHPStan_14faee166\Latte;
use _PHPStan_14faee166\Nette;
use _PHPStan_14faee166\Nette\DI;
use _PHPStan_14faee166\Tracy;
/**
