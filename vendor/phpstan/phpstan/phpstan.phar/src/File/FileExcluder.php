...
final class FileExcluder
{
     ...
     * @var string[]
     */
    private $literalAnalyseDirectoryExcludes = [];
    /**
     * Files to exclude from analysing
     *
     * @var string[]
     */
    private $literalAnalyseFilesExcludes = [];
    /**
     ...
     */
    public function __construct(\PHPStan\File\FileHelper $fileHelper, array $analyseExcludes, bool $noImplicitWildcard)
    {
        $this->noImplicitWildcard = $noImplicitWildcard;
