...
use _PHPStan_14faee166\Nette\Bootstrap\Extensions\PhpExtension;
use _PHPStan_14faee166\Nette\DI\Config\Adapters\PhpAdapter;
use _PHPStan_14faee166\Nette\DI\Definitions\Statement;
use _PHPStan_14faee166\Nette\DI\Extensions\ExtensionsExtension;
use _PHPStan_14faee166\Nette\DI\Helpers;
use _PHPStan_14faee166\Nette\Schema\Context as SchemaContext;
use _PHPStan_14faee166\Nette\Schema\Elements\AnyOf;
use _PHPStan_14faee166\Nette\Schema\Elements\Structure;
use _PHPStan_14faee166\Nette\Schema\Elements\Type;
use _PHPStan_14faee166\Nette\Schema\Expect;
use _PHPStan_14faee166\Nette\Schema\Processor;
use _PHPStan_14faee166\Nette\Schema\Schema;
use _PHPStan_14faee166\Nette\Utils\Strings;
use _PHPStan_14faee166\Nette\Utils\Validators;
use Phar;
...
class ContainerFactory
{
     ...
     * @var ?int
     */
    private static $lastInitializedContainerId = null;
    /** @api */
    ...
    private function detectDuplicateIncludedFiles(array $configFiles, array $loaderParameters) : array
    {
        ...
        foreach ($configFiles as $configFile) {
            ...
            $configArray = \_PHPStan_14faee166\Nette\Schema\Helpers::merge($tmpConfigArray, $configArray);
        }
    ...
    private static function getConfigFiles(FileHelper $fileHelper, \PHPStan\DependencyInjection\NeonAdapter $neonAdapter, PhpAdapter $phpAdapter, string $configFile, array $loaderParameters, ?string $generateBaselineFile) : array
    {
        ...
        if (isset($data['includes'])) {
            ...
            foreach ($includes as $include) {
                ...
                $data = \_PHPStan_14faee166\Nette\Schema\Helpers::merge($tmpConfigArray, $data);
            }
        }
