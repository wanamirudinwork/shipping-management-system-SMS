...
class HasOffsetValueType implements CompoundType, \PHPStan\Type\Accessory\AccessoryType
{
    ...
    public function isSuperTypeOfWithReason(Type $type) : IsSuperTypeOfResult
    {
        ...
        return $result->and($this->valueType->isSuperTypeOfWithReason($type->getOffsetValueType($this->offsetType)));
    }
    ...
    public function isSubTypeOfWithReason(Type $otherType) : IsSuperTypeOfResult
    {
        ...
        return $result->and($otherType->getOffsetValueType($this->offsetType)->isSuperTypeOfWithReason($this->valueType))->and($otherType instanceof self ? IsSuperTypeOfResult::createYes() : IsSuperTypeOfResult::createMaybe());
    }
