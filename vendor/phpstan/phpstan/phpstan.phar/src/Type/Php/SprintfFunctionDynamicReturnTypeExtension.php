...
final class SprintfFunctionDynamicReturnTypeExtension implements DynamicFunctionReturnTypeExtension
{
    ...
    public function getTypeFromFunctionCall(FunctionReflection $functionReflection, FuncCall $functionCall, Scope $scope) : ?Type
    {
        ...
        $isLowercase = $formatType->isLowercaseString()->yes() && $this->allValuesSatisfies($functionReflection, $scope, $args, static function (Type $type) : bool {
            return $type->toString()->isLowercaseString()->yes();
        });
        ...
        if (!$isNonEmpty && $formatType->isNonEmptyString()->yes()) {
            $isNonEmpty = $this->allValuesSatisfies($functionReflection, $scope, $args, static function (Type $type) : bool {
                return $type->toString()->isNonEmptyString()->yes();
            });
        }
        if ($isNonEmpty) {
