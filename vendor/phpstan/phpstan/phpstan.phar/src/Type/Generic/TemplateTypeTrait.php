...
trait TemplateTypeTrait
{
    ...
    public function isSuperTypeOfWithReason(Type $type) : IsSuperTypeOfResult
    {
        ...
        return $this->getBound()->isSuperTypeOfWithReason($type)->and(IsSuperTypeOfResult::createMaybe());
    }
    ...
    public function isSubTypeOfWithReason(Type $type) : IsSuperTypeOfResult
    {
        ...
        return $type->getBound()->isSuperTypeOfWithReason($this->getBound())->and(IsSuperTypeOfResult::createMaybe());
    }
    ...
    {
        return new self($properties['scope'], $properties['strategy'], $properties['variance'], $properties['name'], $properties['bound'], $properties['default'] ?? null);
    }
}
