...
use _PHPStan_14faee166\Symfony\Component\Console\Input\StringInput;
use _PHPStan_14faee166\Symfony\Component\Console\Output\OutputInterface;
use _PHPStan_14faee166\Symfony\Component\Console\Output\StreamOutput;
use Throwable;
...
final class AnalyseCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (count($internalErrorsTuples) > 0) {
            $analysisResult = new \PHPStan\Command\AnalysisResult(array_values($internalFileSpecificErrors), array_map(static function (InternalError $internalError) {
                return $internalError->getMessage();
            }, $internalErrors), [], [], [], $analysisResult->isDefaultLevelUsed(), $analysisResult->getProjectConfigFile(), $analysisResult->isResultCacheSaved(), $analysisResult->getPeakMemoryUsageBytes(), $analysisResult->isResultCacheUsed(), $analysisResult->getChangedProjectExtensionFilesOutsideOfAnalysedPaths());
