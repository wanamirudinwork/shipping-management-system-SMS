...
class Error implements JsonSerializable
{
    ...
    public function withIdentifier(string $identifier) : self
    {
        ...
        return new self($this->message, $this->file, $this->line, $this->canBeIgnored, $this->filePath, $this->traitFilePath, $this->tip, $this->nodeLine, $this->nodeType, $identifier, $this->metadata);
    }
    /**
     * @param mixed[] $metadata
     */
    public function withMetadata(array $metadata) : self
    {
        ...
        return new self($this->message, $this->file, $this->line, $this->canBeIgnored, $this->filePath, $this->traitFilePath, $this->tip, $this->nodeLine, $this->nodeType, $this->identifier, $metadata);
    }
