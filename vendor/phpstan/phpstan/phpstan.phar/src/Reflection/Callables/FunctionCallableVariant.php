...
use function count;
final class FunctionCallableVariant implements \PHPStan\Reflection\Callables\CallableParametersAcceptor, ParametersAcceptorWithPhpDocs
{
    /**
     * @var FunctionReflection|ExtendedMethodReflection
     */
    private $function;
    /**
    ...
    private $throwPoints = null;
    /** @var SimpleImpurePoint[]|null  */
    private $impurePoints = null;
    /**
     * @param FunctionReflection|ExtendedMethodReflection $function
     */
    public function __construct($function, ParametersAcceptorWithPhpDocs $variant)
    {
    ...
    {
        return array_map(static function (ParametersAcceptorWithPhpDocs $variant) use($function) {
            return new self($function, $variant);
        }, $variants);
    }
