...
final class NativeFunctionReflection implements FunctionReflection
{
     ...
     */
    private $namedArgumentsVariants;
    /**
     * @var ?Type
     */
    private $throwType;
     ...
     */
    public function __construct(string $name, array $variants, ?array $namedArgumentsVariants, ?Type $throwType, TrinaryLogic $hasSideEffects, bool $isDeprecated, ?Assertions $assertions = null, ?string $phpDocComment = null, ?TrinaryLogic $returnsByReference = null, bool $acceptsNamedArguments = \true)
    {
        $this->name = $name;
