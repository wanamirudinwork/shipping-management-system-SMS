...
final class NativeMethodReflection implements ExtendedMethodReflection
{
     ...
     */
    public function __construct(ReflectionProvider $reflectionProvider, ClassReflection $declaringClass, BuiltinMethodReflection $reflection, array $variants, ?array $namedArgumentsVariants, TrinaryLogic $hasSideEffects, ?Type $throwType, Assertions $assertions, bool $acceptsNamedArguments, ?Type $selfOutType, ?string $phpDocComment)
    {
