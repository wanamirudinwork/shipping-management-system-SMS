...
class ClassReflection
{
    ...
    private $displayName;
    /**
     * @var ReflectionClass|ReflectionEnum
     */
    private $reflection;
    /**
     * @var ?string
    ...
    public function allowsDynamicProperties() : bool
    {
        ...
        if (UniversalObjectCratesClassReflectionExtension::isUniversalObjectCrate($this->reflectionProvider, $this->universalObjectCratesClasses, $this)) {
            return \true;
        }
        $class = $this;
    ...
    private function wrapExtendedProperty(\PHPStan\Reflection\PropertyReflection $method) : \PHPStan\Reflection\ExtendedPropertyReflection
    {
        if ($method instanceof \PHPStan\Reflection\ExtendedPropertyReflection) {
            return $method;
        }
        return new \PHPStan\Reflection\WrappedExtendedPropertyReflection($method);
    }
    ...
    public function getConstant(string $name) : \PHPStan\Reflection\ClassConstantReflection
    {
        if (!isset($this->constants[$name])) {
            ...
            $this->constants[$name] = new \PHPStan\Reflection\ClassConstantReflection($this->initializerExprTypeResolver, $declaringClass, $reflectionConstant, $nativeType, $phpDocType, $deprecatedDescription, $isDeprecated, $isInternal, $isFinal);
        }
    ...
    {
        return new self($this->reflectionProvider, $this->initializerExprTypeResolver, $this->fileTypeMapper, $this->stubPhpDocProvider, $this->phpDocInheritanceResolver, $this->phpVersion, $this->signatureMapProvider, $this->propertiesClassReflectionExtensions, $this->methodsClassReflectionExtensions, $this->allowedSubTypesClassReflectionExtensions, $this->requireExtendsPropertiesClassReflectionExtension, $this->requireExtendsMethodsClassReflectionExtension, $this->displayName, $this->reflection, $this->anonymousFilename, $this->resolvedTemplateTypeMap, $this->stubPhpDocBlock, $this->universalObjectCratesClasses, null, $this->varianceMapFromList($variances));
    }
