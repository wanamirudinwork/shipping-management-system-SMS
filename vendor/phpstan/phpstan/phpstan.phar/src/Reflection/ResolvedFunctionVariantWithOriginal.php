...
final class ResolvedFunctionVariantWithOriginal implements \PHPStan\Reflection\ResolvedFunctionVariant
{
     ...
     * @var ?Type
     */
    private $returnTypeWithUnresolvableTemplateTypes = null;
    /**
     * @var ?Type
     */
    private $phpDocReturnTypeWithUnresolvableTemplateTypes = null;
    /**
     * @var ?Type
     */
    ...
    public function getParameters() : array
    {
        ...
        if ($parameters === null) {
            $parameters = array_map(function (\PHPStan\Reflection\ParameterReflectionWithPhpDocs $param) : \PHPStan\Reflection\ParameterReflectionWithPhpDocs {
                ...
                return new DummyParameterWithPhpDocs($param->getName(), $paramType, $param->isOptional(), $param->passedByReference(), $param->isVariadic(), $param->getDefaultValue(), $param->getNativeType(), $param->getPhpDocType(), $paramOutType, $param->isImmediatelyInvokedCallable(), $closureThisType);
