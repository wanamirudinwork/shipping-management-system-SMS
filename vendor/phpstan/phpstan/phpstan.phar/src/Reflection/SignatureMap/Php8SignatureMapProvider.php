    ...
    private function getMergedSignatures(\PHPStan\Reflection\SignatureMap\FunctionSignature $nativeSignature, array $functionMapSignatures) : array
    {
        ...
        foreach ($functionMapSignatures['positional'] as $functionMapSignature) {
            ...
            foreach ($functionMapSignature->getParameters() as $i => $functionParam) {
                ...
                $parameters[] = new \PHPStan\Reflection\SignatureMap\ParameterSignature($nativeParam->getName(), $functionParam->isOptional(), $functionParam->getType(), $functionParam->getNativeType(), $functionParam->passedByReference(), $functionParam->isVariadic(), $functionParam->getDefaultValue(), $functionParam->getOutType());
            }
