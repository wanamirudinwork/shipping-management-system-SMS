...
final class StrictComparisonOfDifferentTypesRule implements Rule
{
    ...
    public function __construct(RicherScopeGetTypeHelper $richerScopeGetTypeHelper, bool $checkAlwaysTrueStrictComparison, bool $treatPhpDocTypesAsCertain, bool $reportAlwaysTrueInLastCondition, bool $treatPhpDocTypesAsCertainTip)
    {
