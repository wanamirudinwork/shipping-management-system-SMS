...
final class ReturnTypeRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        if (count($errors) === 1 && $errors[0]->getIdentifier() === 'return.type' && !$errors[0] instanceof TipRuleError && $errors[0] instanceof LineRuleError && $method->getDeclaringClass()->isSubclassOf(Rule::class) && strtolower($method->getName()) === 'processnode' && $node->expr !== null) {
