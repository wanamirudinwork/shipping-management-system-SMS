...
final class ImplodeFunctionRule implements Rule
{
     ...
     */
    private $disabled;
    public function __construct(ReflectionProvider $reflectionProvider, RuleLevelHelper $ruleLevelHelper, bool $disabled)
    {
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        return [RuleErrorBuilder::message(sprintf('Parameter #%d $array of function %s expects array<string>, %s given.', $paramNo, $functionName, $typeResult->getType()->describe(VerbosityLevel::typeOnly())))->identifier('argument.type')->build()];
    }
}
