...
final class AccessStaticPropertiesRule implements Rule
{
     ...
     */
    private $classCheck;
    public function __construct(ReflectionProvider $reflectionProvider, RuleLevelHelper $ruleLevelHelper, ClassNameCheck $classCheck)
    {
        ...
        if ($node->class instanceof Name) {
            ...
            if (in_array($lowercasedClass, ['self', 'static'], \true)) {
                ...
                if (!$this->reflectionProvider->hasClass($class)) {
                    ...
                    return [RuleErrorBuilder::message(sprintf('Access to static property $%s on an unknown class %s.', $name, $class))->discoveringSymbolsTip()->identifier('class.notFound')->build()];
                }
