...
Tue Jan  2 2024 Alexey Klimko [BR-7959] – SPIKE Figure out what started to cause the Network Error in Case 411388
                    when HTTP/2 was enable in ondemandus01 stack

Tue Feb  6 2024 Alex Tatulchenkov BR-11222: Generated Quote PDF is not formatted correctly from 13.0 onward

Fri Jan 26 2024 mlozynski-sugarcrm BR-10845 fix warnings.

Thu Nov  9 2023 Alexey Klimko [BR-11004] – Analyze and suggest a plan to fix Core PHP Warning that will be fatals in PHP82

Wed Nov  1 2023 Alex Tatulchenkov BR-10782: Sugar Mobile PenTest by Cobalt.io - SSRF - #PT18282_16

Wed Jul  5 2023 Alexey Klimko [BR-10347] – Run Rector against SugarCRM code for PHP82

Wed Jun 21 2023 Alexey Klimko [BR-10520] – Reformat PHP code to follow code standards Single quotes and array reformat.

Wed Jun 14 2023 Alexey Klimko [BR-10520] - Reformat PHP code to follow code standards Array conversion

Thu Jan 19 2023 Dmitri Pluschaev BR-9686 (SI 80759) Only the first href link in a PDF template works

Tue Dec  6 2022 Alexey Klimko [BR-9567] – Upgrade to PHP 8.2 – Rector up to PHP 7.0

Tue Oct 18 2022 Cristinel Mitoi CA-1446: Export pdf in PHP 8 - chart on dark background

Tue Oct  5 2021 Alexander Melekhovets BR-8617: fix batch of php warnings

Thu Oct  7 2021 Jianzhong Zhu BR-8370 There are many PHP notices thrown when Print AS PDF is clicked from a Report detailed view

Tue Jul 20 2021 Alexander Melekhovets BR-8305: PHP8 deprecations          remove 'create_function'          remove 'each' calls          remove magic_quotes related function calls          fix datetime format constants          fix 'optional parameter is provided before required'          fix signature compatibility in parent classes          some other changes          add type hints

Wed Apr 15 2020 Sergei Morozov [BR-7123] Fixed offset access syntax in vendor/tcpdf

Fri Nov  8 2019 Sergei Morozov [BR-7123] Fixed some Trying to access array offset on value of type bool|null notices

Mon Jun 17 2019 Sergei Morozov [BR-7123] Fixed chr() expects parameter 1 to be int, string given

Wed Jan  3 2018 Vladimir Skrobot BR-5807: Possible remote file inclusion in tcpdf.php
