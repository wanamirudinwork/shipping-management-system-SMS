...
class GlobalSearchPortalApi extends SugarApi
{
    ...
    public function registerApiRest()
    {
        return [
            /**
             * @deprecated 'globalSearch' endpoint is deprecated and will be removed in a future release.
             */
            // /globalsearch
            'globalSearch' => [
                'reqType' => ['GET', 'POST'],
            ...
            /**
             * @deprecated 'modulesGlobalSearch' endpoint is deprecated and will be removed in a future release.
             */
            // /<module>/globalsearch
            'modulesGlobalSearch' => [
                'reqType' => ['GET', 'POST'],
    ...
    {
        $msg = 'This endpoint is deprecated and will be removed in a future release.';
