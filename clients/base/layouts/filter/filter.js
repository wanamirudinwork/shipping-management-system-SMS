...
({
    ...
    initialize: function(opts) {
        ...
        this.layout.on('filter:toggle:savestate', () => this.context.trigger('filter:toggle:savestate'));
        this.layout.on('filter:create:close', () => this.context.trigger('filter:create:close'));
    },
