...
({
    ...
    load: function(def) {
        ...
        drawers.$next
            .addClass('drawer active border-[--border-base] ltr:border-l rtl:border-r ltr:left-14 rtl:right-14')
            .css({
                top: top,
                height: height
            });
    ...
    _animateOpenDrawer: function(callback) {
        ...
        drawers.$next.addClass(
            'drawer active border-[--border-base] ltr:border-l rtl:border-r ltr:left-14 rtl:right-14'
        );
    ...
    _cleanUpAfterClose: function(drawers) {
        ...
        if (this._isMainAppContent(drawers.$bottom)) {
            drawers.$bottom.removeClass('drawer active border-l border-[--border-base]').trigger('drawer:remove');
            $('body').removeClass('noscroll');
            app.$contentEl.removeClass('noscroll');
        } else {
