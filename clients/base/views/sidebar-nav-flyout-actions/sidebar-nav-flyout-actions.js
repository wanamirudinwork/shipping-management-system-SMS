 ...
 */
({
    className: 'group/sidebar-nav-flyout-actions',
    ...
    /**
     * Initializes configuration values for the view
     *
     * @private
     */
    _initConfig: function() {
        this.moduleColor = this.context.get('moduleColor');
    },
