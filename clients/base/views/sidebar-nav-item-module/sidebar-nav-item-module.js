...
({
    ...
    _determineActiveStatus: function() {
        ...
        if (moduleIsActive !== this.active) {
            this.setActive(moduleIsActive);
    ...
    _getFlyoutClasses: function() {
        return `module-color-${this.color} bg-module-default`;
    },
    ...
    _getFlyoutContext: function() {
        let flyoutContext = new app.Context({
            module: this.module,
            moduleColor: this.color
        });
        flyoutContext.parent = this.context;
