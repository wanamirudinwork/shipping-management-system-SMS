 ...
 */
/**
 * @class View.Views.Base.LegendView
 * @alias SUGAR.App.view.views.BaseLegendView
 * @extends View.View
 */
({
    ...
    _render: function() {
        ...
        this._applyStyle();
        _.debounce(_.bind(this._arrangeElements,this))();
    },
    ...
    _arrangeElements: function() {
        ...
        if (this._needDropdown()) {
            const maxWidthAvailable = this._getMaxWidthAvailable();
            ...
            dropdownToggle.off('click').on('click', () => {
                ...
                const ltrLeft = togglePos.left - dropdownElements.width() + dropdownContainer.width() / 2;
                const rtlLeft = togglePos.left;

                dropdownElements.css({
                    top: togglePos.top + this.$('.dropdown-toggle').height() * 2 + heightOffset,
                    left: app.lang.direction === 'ltr' ? ltrLeft : rtlLeft,
                    right: 'auto',
                });
    ...
    /**
     * Reset the visibility of the legend items
     */
    _resetLegendVisibility: function() {
        const inlineElements = this.$('#inline-elements');
        const legendItemContainerId = `[data-container="legend-item-container${this._id}"]`;
        const inlineLegendId = '[data-container="inline-legend-item"]';
        const dropdownLegendId = '[data-container="dropdown-legend-item"]';
    ...
    _needDropdown: function() {
        ...
        return elementsWidth > legendContainerWidth;
    },
    ...
    _getMaxWidthAvailable: function() {
        ...
        return legendContainerWidth - dropdownWidth - minDisplayWidthOffset;
    },
