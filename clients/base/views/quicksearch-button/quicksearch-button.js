 ...
 */
({
    className: 'quicksearch-button-wrapper flex flex-row items-center min-w-[0rem] flex-1',

    events: {
        'click [data-action=search_icon]': 'searchIconClickHandler',
        'mouseover button': 'onOver',
        'mouseout button': 'onOut'
    },
    ...
    onOver: function() {
        this.$el.closest('.navbar-search').addClass('hover');
    },

    onOut: function() {
        this.$el.closest('.navbar-search').removeClass('hover');
    },
