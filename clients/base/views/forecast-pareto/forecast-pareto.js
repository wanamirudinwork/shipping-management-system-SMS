...
({
    ...
    loadData: function(options) {
        const chartField = this.getField('paretoChart');
    ...
    toggleRepOptionsVisibility: function() {
        const displayManager = this.settings.get('display_manager');

        this.$('div.groupByOptions').toggleClass('hide', displayManager);
        this.$(`#${this.cid}-mgr-toggle`).toggleClass('mt-2', !displayManager);
    },
