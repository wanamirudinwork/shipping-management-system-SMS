    ...
    _removeOtherCalendar: function(e) {
        ...
        app.alert.show('message', {
            ...
            onConfirm: _.bind(function() {
                const newCalendars = _.filter(this.model.get(this.name), _.bind(function(calendar) {
                    if (
                        calendar.calendarId === this._calendarToRemove.calendarId &&
                        calendar.userId === this._calendarToRemove.userId &&
                        calendar.teamId === this._calendarToRemove.teamId
                    ) {
                        return false;
                    } else {
                        return true;
