...
use Sugarcrm\Sugarcrm\SugarCloud\MFAApi;
...
class CurrentUserApi extends SugarApi
{
    ...
    protected $userPrefMeta = [
        ...
        'sugarpdf_pdf_calendar_font_name_data' => 'sugarpdf_pdf_calendar_font_name_data',
    ];
    ...
    protected function getUserData(ServiceBase $api, array $options)
    {
        ...
        $user_data['preferences']['sugarpdf_pdf_calendar_font_name_data'] =
            $current_user->getPreference('sugarpdf_pdf_calendar_font_name_data');
    ...
    public function mfaReset(ServiceBase $api, array $args): array
    {
        ...
        $mfaApi = new MFAApi($httpClient, $discovery, $container);

        if (!$mfaApi->resetMfa($userSrn, $api->grabToken())) {
