...
class CloudDriveApi extends SugarApi
{
    ...
    public function createDrivePath(ServiceBase $api, array $args): string
    {
        ...
        if (!$drivePath && array_key_exists('pathId', $args)) {
        ...
        if (array_key_exists('variablePath', $args)) {
            $drivePath->variable_path = $args['variablePath'];
        } else {
            $drivePath->variable_path = null;
        }
    ...
    public function getDrivePath(ServiceBase $api, array $args): ?array
    {
        ...
        try {
            ...
            throw new SugarApiException('LBL_CLOUD_DRIVE_PATHS_MISSING_FOLDER_ID');
        }
    }
