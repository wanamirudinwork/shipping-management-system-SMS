...
class FileApi extends SugarApi
{
    ...
    {
        if (!$bean->ACLAccess('view') || ($field === 'filename' && !$bean->ACLAccess('edit'))) {
            throw new SugarApiExceptionNotAuthorized('No access to view or edit records for module: ' . $args['module']);
        }
