...
class DbImplementation
{
    ...
    public function __construct()
    {
        ...
        if ($dbManagerFactory) {
            ...
            $this->isAvailable = DbImplementation::getTableExists();
        }
    }
    ...
    /**
     * @param \DBManager $dbManagerFactory
     * @return bool
     */
    private static function getTableExists(): bool
    {
        if (DbImplementation::$tableExists) {
            return true;
        }
        self::$tableExists = DBManagerFactory::getInstance()->tableExists(self::TABLE);
        return DbImplementation::$tableExists;
    }
}
