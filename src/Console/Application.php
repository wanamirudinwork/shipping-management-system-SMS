...
use Sugarcrm\Sugarcrm\Console\Command\EmailTextUngzip\EmailTextUngzip;
use Sugarcrm\Sugarcrm\Console\Command\EmailTextUngzip\ProcessBatchCommand;
...
class Application extends BaseApplication
{
    ...
    public static function create($mode)
    {
        ...
        $registry->addCommands([
            ...
            // Email text ungzip/gzip command
            new EmailTextUngzip(),
