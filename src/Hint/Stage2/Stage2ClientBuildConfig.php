...
$config = [
    ...
    'EU_WEST' => [
        'service-url' => 'https://hint-data-enrichment-eu-west-2.service.sugarcrm.com',
        'hint-iss-service-url' => 'https://hint-interest-subscription-eu-west-2.service.sugarcrm.com',
        'hint-notifications-service-url' => 'https://hint-notifications-eu-west-2.service.sugarcrm.com',
    ],
    'hint_version' => '5.4.2',
    'package_type' => 'prod',
];
