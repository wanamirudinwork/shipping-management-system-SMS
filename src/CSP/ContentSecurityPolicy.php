...
class ContentSecurityPolicy
{
    ...
    {
        $sugarDomains = '*.sugarcrm.com *.salesfusion.com *.salesfusion360.com *.sugarapps.com *.sugarapps.eu *.sugarapps.com.au *.sugarapps.uk sugarcrm-release-archive.s3.amazonaws.com';
        ...
        return [
            ...
            'connect-src' => "'self' wss://*.sugarapps.com wss://*.sugarapps.com.au wss://*.sugarapps.eu wss://*.sugarapps.uk " . $trustedDomains,
