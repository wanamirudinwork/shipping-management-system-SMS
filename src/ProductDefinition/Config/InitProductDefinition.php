        ...
        return <<<JSON
{
    "MODULES": {
        ...
        "sf_Dialogs":["MARKET"],
        "sf_EventManagement":["MARKET"],
        "sf_webActivity":["MARKET"],
        "sf_WebActivityDetail":["MARKET"]
    },
    "DASHLETS": {
    ...
    "RECORDS": {
        "Dashboards": {
            ...
            "1ae9f19e-5294-11ec-9832-525400bc1033":["MARKET"],
            "1ae9f19e-5294-11ec-9832-525400bc1087":["MARKET"],
            "1ae9f19e-5294-11ec-9832-525400bc1038":["MARKET"],
            "1ae9f19e-5294-11ec-9832-525400bc1333":["MARKET"]
        },
        "Reports": {
    ...
    "FIELDS": {
        ...
        "Leads": {
            ...
            "dri_workflow_template_id":["AUTOMATE"],
            "dri_workflow_template_name":["AUTOMATE"],
            "sf_lastactivity_default":["MARKET"]
        },
        "Opportunities": {
        ...
        "Campaigns": {
            ...
            "forwards":["MARKET"],
            "notreported":["MARKET"],
            "peoplewhoclicked":["MARKET"],
            "peoplewhoopened":["MARKET"],
            "postdate":["MARKET"],
            "sent":["MARKET"],
            "social":["MARKET"],
            "totalclicks":["MARKET"],
        ...
        "Prospects": {
            "clicked":["MARKET"],
            "deliverymessage":["MARKET"],
            "deliverystatus":["MARKET"],
            "forms":["MARKET"],
            "friendforward":["MARKET"],
            "opened":["MARKET"],
            "unsub":["MARKET"]
        }
    },
