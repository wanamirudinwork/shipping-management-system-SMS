...
<td>
	...
	<td ><slot><input type="text" onblur="parseDate(this, '{$CALENDAR_DATEFORMAT|escape:'javascript'|escape:'html'}');" name="start_date" id="start_date" tabindex="2" size="11" value="{$START_DATE|escape:'html'}" />
	...
	<td ><slot><input type="text" onblur="parseDate(this, '{$CALENDAR_DATEFORMAT|escape:'javascript'|escape:'html'}');" name="end_date" id="end_date" tabindex="2" size="11" value="{$END_DATE|escape:'html'}" />
			{sugar_getimage name="jscalendar" ext=".gif" alt=$APP.LBL_ENTER_DATE other_attributes='align="absmiddle" id="end_date_trigger" '}
			<span class="dateFormat">{$USER_DATE_FORMAT|escape:'html'}</span></slot></td>
	<td></td><td></td>
	</tr>
	</table>
	</form>
