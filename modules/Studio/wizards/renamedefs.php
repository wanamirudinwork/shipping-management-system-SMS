...
$renamedefs = [
    'modules' => [
        ...
        'Forecasts' => [
            ...
            ['name' => 'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED', 'type' => 'plural', 'source' => 'Forecasts'],
            ['name' => 'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN', 'type' => 'plural', 'source' => 'Forecasts'],
        ],
