 ...
 */
$mod_strings = [
    'LBL_HOMEPAGE_TITLE' => 'I miei modelli della Smart Guide',
    'LBL_LIST_FORM_TITLE' => 'Elenco modelli della Smart Guide',
    'LNK_IMPORT_CUSTOMER_JOURNEY_TEMPLATES' => 'Importa modelli della Smart Guide',
    'LBL_MODULE_TITLE' => 'Modelli della Smart Guide',
    'LBL_MODULE_NAME' => 'Modelli della Smart Guide',
    'LBL_NEW_FORM_TITLE' => 'Nuovo modello della Smart Guide',
    'LBL_REMOVE' => 'Rimuovi',
    'LBL_SEARCH_FORM_TITLE' => 'Cerca i modelli della Smart Guide',
    'LBL_TYPE' => 'Tipo',
    'LNK_LIST' => 'Modelli della Smart Guide',
    'LNK_NEW_RECORD' => 'Crea modello della Smart Guide',
    'LBL_COPIES' => 'Copie',
    ...
    'LNK_VIEW_RECORDS' => 'Visualizza modelli della Smart Guide',
    'LNK_DRI_WORKFLOW_TEMPLATE_LIST' => 'Visualizza i modelli della Smart Guide',
    ...
    'LBL_CUSTOMER_JOURNEY_TEMPLATE_IMPORT_TEXT' => 'Crea/Aggiorna automaticamente un nuovo record Modello della Smart Guide importando un file *.json dal tuo file system.',
    ...
    'LBL_FORMS' => 'Moduli',
    'LBL_ACTIVE_LIMIT' => 'Limite di Smart Guides attive',
    'LBL_WEB_HOOKS' => 'Web hook',
    'LBL_START_NEXT_JOURNEY_ACTIVITIES' => 'Prossima attività di inizio della Smart Guide',
    'LBL_START_NEXT_JOURNEY_STAGES' => 'Avvia il collegamento alla fase della Smart Guide successiva',
    'LBL_SMART_GUIDE_ACCESSIBLE' => 'Scegli i moduli in cui la Smart Guide dovrebbe essere accessibile',
    'LBL_SMART_GUIDE_MODIFY_ACTIONS' => 'In una fase puoi aggiungere altre attività o eliminarle. Disabilita le azioni a cui non vuoi che l&#39;utente abbia accesso in questa Smart Guide',
    'LBL_SMART_GUIDE_DISABLE_ACTIONS' => 'In un&#39;attività puoi aggiungere altre attività come attività secondarie. Disabilita le azioni a cui non vuoi che l&#39;utente abbia accesso in questa Smart Guide',
    'LBL_SMART_GUIDE_ACTIVATES' => 'Quante di questa Smart Guide possono essere attive su un record contemporaneamente',
    'LBL_SMART_GUIDE_TARGET_ASSIGNEE' => 'Se si seleziona Se Assegnatario di Destinazione = Assegnatario padre, quando l&#39;utente "Assegnato a" viene modificato in un genitore, gli utenti "Assegnato a" cambieranno automaticamente anche nelle Smart Guide, fasi e attività. Si noti che le impostazioni di Assegnatario di Destinazione nei modelli di attività hanno la precedenza sul modello della Smart Guide.',
    ...
    'LBL_MODULE_NAME_SINGULAR' => 'Modello di Smart Guide',
    'LBL_SORT_ORDER' => 'Ordina',
];
