...
$mod_strings = [
    ...
    'LBL_INVALID_CONFIGURATION' => 'Could not connect to the email server. Please make sure that your email configuration has been set up correctly.',
...
You may apply a predefined template using the Template button or include one of your signatures using the Signature button. Use the Upload New button to add an attachment to the email.',
    ...
    'LBL_BODY_IS_TOO_LONG_EXTERNAL_CLIENT' => 'Message is too long. It may open incorrectly in external client. <br> <br> Open in <strong> external client </strong> anyway?',
];
