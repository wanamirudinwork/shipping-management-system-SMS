...
({
    ...
    _renderView: function() {
        ...
        if (this.$el.find('iframe').length === 0) {
            iFrame = $('<iframe>', {
                src: '',
                class: 'htmleditable w-full' + (this.def.span ? ' span' + this.def.span : ''),
                frameborder: 0,
                name: this.name
            });
    ...
    _setViewContentInternal: function(editable, value, styleSrc = 'styleguide/assets/css/iframe-sugar.css') {
        this._super('_setViewContentInternal', [editable, value, styleSrc]);
        ...
        _.debounce(_.bind(function() {
            ...
            if (contentHeight > padding) {
                ...
                editable.css('height', contentHeight);
                if (this.view) {
