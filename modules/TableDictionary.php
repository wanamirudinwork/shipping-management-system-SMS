...
// Market
include 'metadata/sf_dialogs_contactsMetaData.php';
include 'metadata/sf_dialogs_leadsMetaData.php';
include 'metadata/sf_eventmanagement_contactsMetaData.php';
include 'metadata/sf_eventmanagement_leadsMetaData.php';
include 'metadata/sf_webactivity_accountsMetaData.php';
include 'metadata/sf_webactivity_contactsMetaData.php';
include 'metadata/sf_webactivity_leadsMetaData.php';
include 'metadata/sf_webactivitydetail_sf_webactivityMetaData.php';
