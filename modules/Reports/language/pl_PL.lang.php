...
$mod_strings = [
    ...
    'LBL_SELECT_DISTINCT' => 'Pokaż odrębne wyniki',
    'LBL_OPTIONAL_SELECT_DISTINCT_HELP' => 'Po włączeniu opcja usuwa powielone wyniki raportu. Powielone wyniki mogą wystąpić, gdy rekord jest wielokrotnie wyłapywany przez filtr raportu ze względu na powiązane z nim rekordy, co powoduje, że jest wymieniony więcej niż raz. Pamiętaj, że włączenie tej opcji może spowodować wykluczenie prawidłowych rekordów, w zależności od kryteriów raportu.',
