...
$mod_strings = [
    ...
    'LBL_SELECT_DISTINCT' => 'Показване на различни резултати',
    'LBL_OPTIONAL_SELECT_DISTINCT_HELP' => 'Когато е активирана, тази опция премахва дублиращите се резултати от отчета. Може да възникнат дублиращи се, когато даден запис отговаря на филтъра на отчета няколко пъти поради свързаните с него записи, което води до изброяването му повече от веднъж. Моля, имайте предвид, че активирането на тази опция може да доведе до изключване на валидни записи в зависимост от критериите за отчитане.',
