...
$mod_strings = [
    ...
    'LBL_SELECT_DISTINCT' => 'Показывать четкие результаты',
    'LBL_OPTIONAL_SELECT_DISTINCT_HELP' => 'Когда эта опция включена, она удаляет дубликаты результатов отчета. Дубликаты могут возникать, когда запись несколько раз соответствует фильтру отчета из-за связанных с ней записей, что приводит к ее перечислению более одного раза. Обратите внимание, что включение этого параметра может привести к исключению действительных записей, в зависимости от критериев вашего отчета.',
