...
$mod_strings = [
    ...
    'LBL_SELECT_DISTINCT' => 'Mostra risultati distinti',
    'LBL_OPTIONAL_SELECT_DISTINCT_HELP' => 'Se abilitata, questa opzione rimuove i risultati duplicati del rapporto. I duplicati possono verificarsi quando un record soddisfa più volte un filtro a causa dei record correlati, causandone l&#39;elencazione più di una volta. L&#39;abilitazione di questa opzione può comportare l&#39;esclusione di record validi, a seconda dei criteri del rapporto.',
