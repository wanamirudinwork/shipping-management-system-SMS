...
$mod_strings = [
    ...
    'LBL_SELECT_DISTINCT' => 'הצג תוצאות מובחנות',
    'LBL_OPTIONAL_SELECT_DISTINCT_HELP' => 'כאשר אפשרות זו מופעלת, היא מסירה תוצאות כפולות של דוחות. כפילויות עלולות להתרחש כאשר רשומה מסוימת עומדת בהגדרות של מסנן דוח מספר פעמים עקב הרשומות הקשורות אליה, מה שגורם לה להירשם יותר מפעם אחת. חשוב לשים לב שהפעלת אפשרות זו עלולה לגרום לאי-הכללה של רשומות חוקיות, בהתאם לקריטריוני הדוח שבחרת.',
