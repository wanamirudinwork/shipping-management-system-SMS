...
{sugar_csrf_form_token}
	...
	<div id='report_details_div' style="display:none">
		...
		<table id="report_details_table" border="0"  width="100%" cellspacing="0" cellpadding="0" >
			...
			{/if}
			<tr>
				<td scope='row'><label for='show_distinct'>{$MOD.LBL_SELECT_DISTINCT}: {$show_distinct_image}</label></td>
				<td><input type="checkbox" class="checkbox" name="show_distinct" id='show_distinct'  {if ($show_distinct)}CHECKED{/if}></td>
			</tr>	
			<tr>
