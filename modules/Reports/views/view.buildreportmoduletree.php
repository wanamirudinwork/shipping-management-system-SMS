...
class ReportsViewBuildreportmoduletree extends SugarView
{
     ...
     * @var array
     */
    protected $nonReportableModules = [
        'Currencies' => true,
    ];
    ...
    public function display()
    {
        ...
        foreach ($linked_fields as $linked_field) {
            ...
            } elseif (isset($beanList[$relationship->lhs_module])) {
    ...
    protected function _populateNodeItem($bean_name, $link_module, $linked_field)
    {
        ...
        $node['href'] = "javascript:SUGAR.reports.populateFieldGrid('" . $link_module . "','" . $linked_field['relationship'] . "','" . $bean_name . "','" . str_replace(['&#039;', '&#39;','%27'], "\'", $linked_field['label']) . "');";
        $node['leaf'] = false;
