...
$help_distinct_img = smarty_function_sugar_help(['text' => $mod_strings['LBL_OPTIONAL_SELECT_DISTINCT_HELP']], $sugar_smarty);
...
$sugar_smarty->assign('show_distinct_image', $help_distinct_img);
...
if ($runQuery == 1) {
    ...
    $sugar_smarty->assign('report_def_str', $args['reporter']->report_def_str);
    $sugar_smarty->assign('show_distinct', $args['reporter']->show_distinct);
