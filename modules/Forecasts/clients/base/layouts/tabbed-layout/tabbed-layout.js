...
({
    ...
    tabClickHandle: function(e) {
        let index;
        let parentElement = $(e.currentTarget).parent('li');

        if ($(e.currentTarget).has('data-tab-index')) {
            index = $(e.currentTarget).attr('data-tab-index');
        } else if (parentElement && parentElement.has('data-tab-index')) {
            index = parentElement.attr('data-tab-index');
        }
