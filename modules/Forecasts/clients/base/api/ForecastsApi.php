...
class ForecastsApi extends ModuleApi
{
    ...
    public function forecastsInitialization(ServiceBase $api, array $args)
    {
        ...
        //add all the current timeperiods, this is to check if the current timeperiod from local storage is still valid
        $returnInitData['timePeriodOptions'] = $this->timeperiod($api, $args);
