...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '配置您希望如何对 {{forecastByModule}} 进行分类。<br><br>请注意，首次提交后无法更改范围设置。对于升级后的实例，“范围”设置与现有“预测”数据锁定。<br><br>您可以根据概率范围选择两个或多个类别，也可以创建不基于概率的类别。 <br><br>自定义类别的左侧有复选框；使用这些复选框可决定哪些范围将包含在提交并报告给管理人员的预测金额中。<br><br>用户可在工作表中手动更改 {{forecastByModule}} 的包含/排除状态和类别。',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => '尚未配置预测，需要设置预测才能使用这个 dashlet。请与您的系统管理员联系。',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => '尚未配置预测，需要设置预测才能使用这个 dashlet。<a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>请点击此处以配置“预测”模块。</a>',
