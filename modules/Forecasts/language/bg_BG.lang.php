...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигуриране на начина, по който искате да категоризирате {{forecastByModule}}. <br><br>Моля, имайте предвид, че настройките на обхвата не могат да се променят след първото къмитиране. За надстроени екземпляри настройката Диапазон е заключена със съществуващите данни за прогнозата.<br><br>Можете да изберете две или повече категории въз основа на вероятностни диапазони или да създадете категории, които не се основават на вероятността. <br><br>Вляво от вашите персонализирани категории има квадратчета за отметка; да ги използвате, за да решите кои диапазони ще бъдат включени в прогнозната сума, за която е поети задължения и докладвана на мениджърите. <br><br>Потребителят може да промени статуса и категорията на включване/изключване {{forecastByModule}} ръчно от работния си лист.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Прогнозите не са конфигурирани и необходимо да се извърши настройка, за да се използва този панел. Моля, свържете се със системния администратор.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Прогнозите не са конфигурирани и необходимо да се извърши настройка, за да се използва този панел. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Моля, щракнете тук, за да конфигурирате модула Прогнози.</a>',
