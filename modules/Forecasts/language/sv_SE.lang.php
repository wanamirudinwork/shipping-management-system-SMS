...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Observera att intervallinställningarna inte kan ändras efter den första incheckningen. För uppgraderade instanser är inställningen Intervall låst med befintliga prognosdata.<br><br>Du kan välja två eller flera kategorier baserat på sannolikhetsintervall eller skapa kategorier som inte är baserade på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka intervall som ska ingå i det prognosbelopp som avsatts och rapporterats till cheferna. <br><br>En användare kan ändra inkluderings-/exkluderingsstatus och kategori för {{forecastByModule}} manuellt från dess arbetsblad.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Prognoser har inte konfigurerats och måste ställas in för att använda denna dashlet. Kontakta systemadministratören.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Prognoser har inte konfigurerats och måste ställas in för att använda denna dashlet. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Klicka här för att konfigurera modulen Prognoser.</a>',
