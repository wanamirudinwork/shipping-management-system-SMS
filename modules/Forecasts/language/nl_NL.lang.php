...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren. <br><br>Let op: de bereikinstellingen kunnen niet meer gewijzigd worden na de eerste vastlegging. Voor geüpgradede exemplaren is de bereikinstelling vergrendeld met bestaande prognosegegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheidsbereik of categorieën maken die niet op waarschijnlijkheid zijn gebaseerd. <br><br>Er zijn selectievakjes aan de linkerkant van uw aangepaste categorieën; gebruik deze om te beslissen welke bereiken worden opgenomen in het voorspelde bedrag dat is vastgelegd en gerapporteerd aan managers. <br><br>Een gebruiker kan de status opnemen/uitsluiten en de categorie van {{forecastByModule}} handmatig uit hun werkblad.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Forecasts zijn niet geconfigureerd en dienen ingesteld te worden om gebruik te maken van deze dashlet. Neem contact op met uw beheerder.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Forecasts zijn niet geconfigureerd en dienen ingesteld te worden om gebruik te maken van deze dashlet. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;> Neem contact op met uw beheerder.</a>',
