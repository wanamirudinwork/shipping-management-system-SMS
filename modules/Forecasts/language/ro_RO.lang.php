...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configurați modul în care doriți să clasificați {{forecastByModule}}. <br><br>Rețineți că setările pentru Interval nu pot fi modificate după prima confirmare. Pentru instanțele actualizate, setarea pentru Interval este blocată cu datele de prognoză existente.<br><br>Puteți selecta două sau mai multe categorii pe baza intervalelor de probabilitate sau puteți crea categorii care nu se bazează pe probabilitate. <br><br>Există casete de selectare în stânga categoriilor personalizate; utilizați-le pentru a decide ce intervale vor fi incluse în suma prognozată angajată și raportată managerilor. <br><br>Un utilizator poate schimba manual starea de includere/excludere și categoria de {{forecastByModule}} din foaia de lucru.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Previziunile nu au fost configurate și trebuie configurate pentru a utiliza acest dashlet. Vă rugăm să contactați administratorul de sistem.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Previziunile nu au fost configurate și trebuie configurate pentru a utiliza acest dashlet. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Vă rugăm să faceți clic aici pentru a configura modulul Previziuni.</a>',
