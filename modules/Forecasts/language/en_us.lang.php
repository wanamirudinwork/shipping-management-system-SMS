...
$mod_strings = [
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Forecasts have not been configured and need to be setup in order to use this dashlet. Please contact your system administrator.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Forecasts have not been configured and need to be setup in order to use this dashlet. <a href=\'#{{buildRoute module="Forecasts"}}\'>Please click here to configure the Forecasts module.</a>',
