...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configura la modalità di categorizzazione di {{forecastByModule}}. <br><br>Notare che le impostazioni dell&#39;intervallo non possono essere modificate dopo la prima conferma. Per le istanze aggiornate, l&#39;impostazione Intervallo è bloccata con i dati di previsione esistenti.<br><br>È possibile selezionare due o più categorie basate sugli intervalli di probabilità o creare delle categorie che non si basano sulla probabilità. <br><br>Ci sono delle caselle di spunta a sinistra delle categorie personalizzate; utilizzarle per decidere quali intervalli saranno inclusi nell&#39;importo di previsione impegnato e segnalato ai dirigenti. <br><br>Un utente può modificare manualmente lo stato di inclusione/esclusione e la categoria di {{forecastByModule}} dal foglio di lavoro.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Le previsioni non sono state configurate e devono essere impostate per utilizzare questo dashlet. Si prega di contattare l´amministratore di sistema.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Le previsioni non sono state configurate e devono essere impostate per utilizzare questo dashlet. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Clicca qui per configurare il modulo Previsioni.</a>',
