...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}. <br><br>Merk at områdeinnstillingene ikke kan endres etter den første lagringen. For oppgraderte forekomster er områdeinnstillingen låst med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder eller opprette kategorier som ikke baserer seg på sannsynlighet. <br><br>Det er avmerkingsbokser til venstre for dine egendefinerte kategorier; Bruk disse til å bestemme hvilke områder som skal inkluderes i prognosebeløpet som er forpliktet og rapportert til ledere. <br><br>En bruker kan endre inkluder/ekskluder-status og kategori for {{forecastByModule}} manuelt fra arbeidsarket.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Prognoser har ikke blitt konfigurert og må settes opp for å bruke denne dashleten. Kontakt systemadministratoren din.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Prognoser er ikke konfigurert og må settes opp for å kunne bruke denne dashleten. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Klikk her for å konfigurere prognosemodulen.</a>',
