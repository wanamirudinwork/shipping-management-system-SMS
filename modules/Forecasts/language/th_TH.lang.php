...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กําหนดค่าวิธีที่คุณต้องการจัดหมวดหมู่ {{forecastByModule}} <br><br>โปรดทราบว่าการตั้งค่าช่วงไม่สามารถเปลี่ยนแปลงได้หลังจากการยืนยันครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรดแล้ว การตั้งค่าช่วงจะถูกล็อกด้วยข้อมูลประมาณการที่มีอยู่<br><br>คุณสามารถเลือกหมวดหมู่ได้ตั้งแต่สองหมวดหมู่ขึ้นไปตามช่วงความน่าจะเป็น หรือสร้างหมวดหมู่ที่ไม่ได้อิงตามความน่าจะเป็น <br><br>มีช่องทําเครื่องหมายทางด้านซ้ายของหมวดหมู่ที่กําหนดเองของคุณ ใช้เพื่อตัดสินใจว่าช่วงใดจะรวมอยู่ในยอดเงินประมาณการที่ยืนยันแล้วและรายงานให้ผู้จัดการทราบ <br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวม และหมวดหมู่ของ {{forecastByModule}} ด้วยตนเองจากเวิร์กชีทของตน',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'ไม่ได้กำหนดค่าประมาณการไว้ ต้องมีการตั้งค่าประมาณการเพื่อใช้ส่วนข้อมูลนี้ โปรดติดต่อผู้ดูแลระบบของคุณ',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'ไม่ได้กำหนดค่าประมาณการไว้ ต้องมีการตั้งค่าประมาณการเพื่อใช้ส่วนข้อมูลนี้ <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;> โปรดคลิกที่นี่เพื่อกำหนดโมดูลประมาณการของคุณ</a>',
