...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Настройте, как вы хотите классифицировать {{forecastByModule}}. <br><br>Обратите внимание, что настройки диапазона не могут быть изменены после первого подтверждения. Для обновленных экземпляров настройка Range привязана к существующим данным прогноза.<br><br>Вы можете выбрать две или более категорий на основе диапазонов вероятностей или создать категории, которые не основаны на вероятности. <br><br>Слева от ваших пользовательских категорий есть флажки; используйте их, чтобы решить, какие диапазоны будут включены в сумму прогноза, подтвержденную и сообщенную менеджерам. <br><br>Пользователь может изменить статус включения/исключения и категорию {{forecastByModule}} вручную из своего листа прогнозов.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Прогнозы не были настроены. Для корректного использования этого раздела необходимо их установить. Обратитесь к системному администратору.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Прогнозы не были настроены. Для корректного использования этого раздела необходимо их установить. <a href=&#39;#{{buildRoute module="Прогнозы"}}&#39;>Чтобы настроить модуль прогнозов, нажмите здесь.</a>',
