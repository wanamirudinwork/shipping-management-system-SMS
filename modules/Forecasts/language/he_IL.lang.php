...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר/י איך לסווג את {{forecastByModule}}. <br><br>לידיעתך, אי אפשר לשנות את הגדרות הטווח אחרי ההתחייבות (commit) הראשונה. בסביבות משודרגות, הגדרת הטווח נעולה על נתוני התחזית הקיימים.<br><br>אפשר לבחור שתי קטגוריות או יותר, לפי טווחי ההסתברות, או ליצור קטגוריות שלא מבוססות על הסתברות. <br><br>לצד הקטגוריות המותאמות אישית מופיעות תיבות סימון; באמצעותן, אפשר לקבוע אילו טווחים לכלול בסכום התחזית המחויב ולדווח למנהלים. <br><br>המשתמש יכול לשנות ידנית את סטטוס הכלילה/אי-כלילה ואת הקטגוריה של {{forecastByModule}} מגיליון העבודה שלו.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'לא הוגדרו תחזיות, ויש להגדיר אותן כדי להשתמש בחלונית זו. נא לפנות למנהל המערכת.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'לא הוגדרו תחזיות, ויש להגדיר אותן כדי להשתמש בחלונית זו. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>נא ללחוץ כאן כדי להגדיר את המודול &#39;תחזיות&#39;.</a>',
