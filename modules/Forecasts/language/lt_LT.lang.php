...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigūruokite, kaip norite suskirstyti į kategorijas {{forecastByModule}}. <br><br>Atkreipkite dėmesį, kad po pirmojo patvirtinimo intervalų nustatymų keisti negalima. Atnaujintiems egzemplioriams intervalų nustatymas yra užrakintas kartu su turimais prognozės duomenimis.<br><br>Galite pasirinkti dvi ar daugiau kategorijų pagal tikimybių intervalus arba sukurti kategorijas, kurios nėra pagrįstos tikimybėmis. <br><br>Kairėje pasirinktinių kategorijų pusėje yra žymimieji langeliai; jais naudodamiesi nuspręskite, kurie intervalai bus įtraukti į prognozuojamą skiriamą ir vadovams pateikiamą sumą. <br><br>Naudotojas gali rankiniu būdu pakeisti {{forecastByModule}} įtraukimo/neįtraukimo statusą ir kategoriją savo darbo lentelėje.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => 'Prognozės nebuvo sukonfigūruotos ir jas reikia nustatyti, kad būtų galima naudoti šią brūkšninę dalį. Susisiekite su sistemos administratoriumi.',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => 'Prognozės nebuvo sukonfigūruotos ir jas reikia nustatyti, kad būtų galima naudoti šią brūkšninę dalį. <a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>Spustelėkite čia, kad sukonfigūruotumėte prognozių modulį.</a>',
