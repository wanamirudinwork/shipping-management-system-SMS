...
$mod_strings = [
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '{{forecastByModule}} を分類する方法を構成します。 <br><br>最初のコミット後に範囲設定を変更することはできませんのでご注意ください。アップグレードされたインスタンスの場合、範囲設定は既存の予測データに固定されます。<br><br>確率の範囲に基づいて 2 つ以上のカテゴリを選択するか、確率に基づかないカテゴリを作成することができます。 <br><br>カスタムカテゴリの左側にチェックボックスがあります。これらを使用して、コミットされ、マネージャーに報告される予測金額に含める範囲を決定します。 <br><br>ユーザーは、ワークシートから {{forecastByModule}} の包含/除外ステータスとカテゴリを手動で変更できます。',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED' => '売上予測が設定されていないため、このウィジェットを使用するには設定が必要です。システム管理者に連絡してください。',
    'LBL_PIPELINE_METRICS_DASHLET_FORECASTS_NOT_CONFIGURED_ADMIN' => '売上予測が設定されていないため、このダッシュレットを使用するには設定が必要です。<a href=&#39;#{{buildRoute module="Forecasts"}}&#39;>売上予測モジュールを設定するにはここをクリックしてください。</a>',
