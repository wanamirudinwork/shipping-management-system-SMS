...
({
        ...
        if (!_.isEmpty(value)) {
            ...
            if (elemArr.length > 0) {
                ...
                _.each(elemArr, function(elem) {
                    ...
                    // Text elements don't have 'outerHTML' property. Use 'textContent' instead
                    value += elem.outerHTML || elem.textContent || '';
                });
                value += '</div>';
            }
        }
    ...
    updateBodyHeight: function($element) {
        ...
        var contentHeight = this._getContentHeight($element);
