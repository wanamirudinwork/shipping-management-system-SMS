...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => '開始事件有多個類似的標準。請刪除重複的標準，或使每個標準唯一。',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => '選定的下拉式選單欄位包含無效選項',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => '此動作元素中將更新的下拉式選單欄位具有無效選項。您可以取消選擇該動作元素中的欄位，或檢閱代碼自訂中的欄位清單設定。',
