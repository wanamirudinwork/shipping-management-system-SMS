...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'start 事件具有多个相似的标准。请删除重复的标准，或使每个标准都具有唯一值。',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => '选定的下拉列表字段包含无效选项',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => '此操作元素中将更新的下拉列表字段具有无效选项。您可以在操作元素中取消选择此字段，或查看代码自定义中的字段列表设置。',
