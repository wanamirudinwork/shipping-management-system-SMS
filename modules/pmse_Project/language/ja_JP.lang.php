...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => '開始イベントには、複数の類似した条件があります。重複する条件を削除するか、各条件を一意にしてください。',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => '選択されたドロップダウンフィールドに無効なオプションが含まれています',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'この Action 要素で更新されるドロップダウン フィールドには、無効なオプションがあります。Action 要素でフィールドの選択を解除するか、コードのカスタマイズでフィールド リストの設定を確認できます。',
