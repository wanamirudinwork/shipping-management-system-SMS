...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'Lähtötapahtumalla on useita samanlaisia kriteerejä. Poista päällekkäiset kriteerit tai tee jokaisesta kriteeristä yksilöllinen.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'Valittu pudotusvalikkokenttä sisältää virheellisiä vaihtoehtoja',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'Tässä toimintoelementissä päivitettävässä pudotusvalikkokentässä on virheellisiä vaihtoehtoja. Voit joko poistaa kentän valinnan toimintoelementissä tai tarkistaa kenttäluettelon asetukset koodin mukauttamisessa.',
