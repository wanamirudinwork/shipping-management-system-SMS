...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'يحتوي حدث البداية على العديد من المعايير المتشابهة. يرجى إزالة المعايير المكررة، أو جعل كل معيار فريدا.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'يحتوي الحقل المنسدل المحدد على خيارات غير صالحة',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'يحتوي حقل القائمة المنسدلة الذي يتم تحديثه في عنصر الإجراء هذا على خيارات غير صالحة. يمكنك إما إلغاء تحديد الحقل في عنصر الإجراء أو مراجعة إعدادات قائمة الحقول في تخصيص التعليمات البرمجية.',
