...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'Початкова подія має кілька схожих критеріїв. Видаліть повторювані критерії або зробіть кожен критерій унікальним.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'Вибране поле випадаючого списку містить неприпустимі параметри',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'У полі випадаючого списку, яке оновлюється в цьому елементі «Дія», містяться неприпустимі параметри. Ви можете або зняти позначку з поля в елементі «Дія», або переглянути налаштування списку полів у налаштуванні коду.',
