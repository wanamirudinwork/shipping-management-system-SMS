...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'The start event has multiple similar criteria. Please remove duplicate criteria, or make each criterion unique.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'Selected dropdown field contains invalid options',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'A dropdown field being updated in this Action element has invalid options. You can either unselect the field in the Action element or review the field list settings in the code customization.',
