...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'Startevenemanget har flera liknande kriterier. Ta bort dubbletter av kriterier eller gör varje kriterium unikt.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'Valda rullgardinsfält innehåller ogiltiga alternativ',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'Ett rullgardinsfält som uppdateras i det här åtgärdselementet har ogiltiga alternativ. Du kan antingen avmarkera fältet i åtgärdselementet eller granska inställningarna för fältlistan i kodanpassningen.',
