...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'Událost start má několik podobných kritérií. Odstraňte prosím duplicitní kritéria nebo vytvořte každé kritérium jedinečné.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'Vybrané rozbalovací pole obsahuje neplatné možnosti',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'Rozbalovací pole aktualizované v tomto prvku akce má neplatné možnosti. Můžete buď zrušit výběr pole v prvku Akce, nebo zkontrolovat nastavení seznamu polí v přizpůsobení kódu.',
