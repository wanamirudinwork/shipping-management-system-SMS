...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => '시작 이벤트에는 여러 유사한 기준이 있습니다. 중복된 기준을 제거하거나 각 기준을 고유하게 설정하세요.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => '선택한 드롭다운 필드에 유효하지 않은 옵션이 포함되어 있음',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => '이 작업 요소에서 업데이트 중인 드롭다운 필드에 유효하지 않은 옵션이 있습니다. 작업 요소에서 필드를 선택 해제하거나 코드 사용자 지정에서 필드 목록 설정을 검토할 수 있습니다.',
