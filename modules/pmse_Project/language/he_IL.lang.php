...
$mod_strings = [
    ...
    'LBL_PMSE_FORM_ERROR_MULTIPLE_CRITERIA' => 'לאירוע ההתחלה יש מספר קריטריונים דומים. נא להסיר קריטריונים כפולים או להפוך כל קריטריון לייחודי.',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    ...
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS' => 'השדה הנפתח הנבחר מכיל אפשרויות לא חוקיות',
    'LBL_PMSE_ERROR_ACTION_CHANGE_FIELD_INVALID_OPTIONS_INFO' => 'שדה נפתח המתעדכן ברכיב פעולה זה כולל אפשרויות לא חוקיות. אפשר לבטל את הבחירה בשדה זה מתוך רכיב הפעולה או לבדוק את הגדרות רשימת השדות בהתאמה האישית של הקוד.',
