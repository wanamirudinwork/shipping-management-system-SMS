...
({
    ...
    toggleMinify: function (evt) {
        ...
        if (collapsed) {
            $('.dashlet-toggle > i').removeClass('sicon-chevron-up');
            $('.dashlet-toggle > i').addClass('sicon-chevron-down');
        } else {
            $('.dashlet-toggle > i').removeClass('sicon-chevron-down');
            $('.dashlet-toggle > i').addClass('sicon-chevron-up');
        }
