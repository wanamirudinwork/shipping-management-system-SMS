...
class AdministrationController extends SugarController
{
    public function action_savetabs()
    {
        ...
        if (isset($_REQUEST['disabled_tabs'])) {
            ...
            $disabledTabsKeyArray = $this->handle_disabled_tabs($disabledTabs, $modInvisList);
    ...
    public function handle_disabled_tabs(array $disabledTabs, array $modInvisList): array
    {
        ...
        if (!safeInArray('project', $disabledTabsKeyArray) && safeInArray('Project', $modInvisList)) {
            $disabledTabsKeyArray['project'] = 'project';
        }
        ...
        if (!safeInArray('revenuelineitems', $disabledTabsKeyArray) && safeInArray('RevenueLineItems', $modInvisList)) {
            $disabledTabsKeyArray['revenuelineitems'] = 'revenuelineitems';
        }

        return $disabledTabsKeyArray;
    }
