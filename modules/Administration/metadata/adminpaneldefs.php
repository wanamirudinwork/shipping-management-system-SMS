...
$admin_option_defs['Administration']['package_builder'] = ['PackageBuilder', 'icon' => 'sicon-package-lg', 'LBL_PACKAGE_BUILDER_TITLE', 'LBL_PACKAGE_BUILDER_DESC', 'javascript:void(parent.SUGAR.App.router.navigate("Administration/package-builder", {trigger: true}));'];
