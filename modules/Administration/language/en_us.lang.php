...
$mod_strings = [
    ...
    'LBL_ML_INSTALLATION_SUCCESSFUL' => 'The package has been installed successfully.',
    'LBL_ML_PACKAGE_INSTALLING' => 'Package installing...',
    'LBL_ML_INSTALLATION_ERROR' => 'The package failed to install with an error.',
    'LBL_ML_INSTALLATION_FATAL' => 'The install failed. See details in package_install.log.',
    'LBL_ML_UNINSTALLATION_SUCCESSFUL' => 'The package has been uninstalled successfully.',
    'LBL_ML_PACKAGE_UNINSTALLING' => 'Package uninstalling...',
    'LBL_ML_UNINSTALLATION_ERROR' => 'The package failed to uninstall with an error.',
    'LBL_ML_UNINSTALLATION_FATAL' => 'The uninstall failed. See details in package_install.log.  ',
...
//END SUGARCRM flav=een
    ...
    'WARN_LICENSE_SEATS_USER_CREATE' => '<b>Warning:</b> You will not be able to create additional active users.'
        . ' Please purchase more subscriptions.',
    'WARN_MARKET_SEAT_FOR_SERVE' => 'Sugar Market license must be assigned with a Sugar Sell or Enterprise license. ',
    ...
    // Package Builder
    'LBL_PACKAGE_BUILDER_TITLE' => 'Package Builder and Deployer',
    'LBL_PACKAGE_BUILDER_DESC' => 'Export configurations and customizations to move to another Sugar instance',
    'LBL_PACKAGE_BUILDER_HEADER' => 'Package Builder and Deployer',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG' => 'Setup',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS' => 'Customizations',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES' => 'Packages',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_HELP' => 'Choose which customizations to get from the local instance',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_HELP' => 'Create a package from a selected list of customizations',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_HELP' => 'Connect to a remote instance and manage local and remote packages',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_CATEGORIES' => 'Categories',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_CATEGORIES_HELP' => 'Select the categories from which to extract the customizations',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_FETCH_C_BUTTON' => 'Get Customizations',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_FETCH_C_BUTTON_DESC' => 'Retrieves customizations in the selected categories.',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_SELECT_ALL_BUTTON' => 'Select All',
    'LBL_PACKAGE_BUILDER_TAB_CONFIG_EMPTY_C_BUTTON' => 'Please select a category.',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_SELECT_CHECKBOX' => 'Include record in the package',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_SELECT_ALL' => 'Select all records to be included in the package',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_FIELDS_T' => 'Fields',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_DROPDOWNS_T' => 'Dropdowns',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_RELATIONSHIPS_T' => 'Relationships',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_LAYOUTS_T' => 'Layouts',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_LANGUAGE_T' => 'Language',
    ...
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_ADVANCEDWORKFLOWS_T' => 'Process Definitions',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_REPORTS_T' => 'Reports',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_ACL_T' => 'Roles',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_MISCELLANEOUS_T' => 'Miscellaneous',
    'LBL_PACKAGE_BUILDER_TAB_CUSTOMIZATIONS_SEARCHL_T' => 'Search Layouts',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_CONNECTION_T' => 'Connection',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_I_PACKAGES_T' => 'Local Packages',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_REMOTE_PACKAGES_T' => 'Remote Packages',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_URL' => 'Instance URL',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_USERNAME' => 'Username',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_PASSWORD' => 'Password',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_CONNECT_BUTTON' => 'Connect',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_EMPTY_FIELD_ERROR' => 'Please fill in all the fields.',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_PUSH_P_BUTTON' => 'Push',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_PUSH_ALL_BUTTON' => 'Push All',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_MAX_SIZE_ERR' => 'The file is too large. Max upload size is <max_size> MB.',
    'LBL_PACKAGE_BUILDER_TAB_PACKAGES_EXT_PACk_SUCCESS' => 'External package uploaded successfully',
    'LBL_PACKAGE_BUILDER_TAB_CREATE_PACKAGE_OVER_LIMIT' => 'The package that needs to be generated exceeds the Sugar max upload size limit and you will not be able to deploy that package on a Sugar instance. Please redo your selection and generate smaller packages.',
    'LBL_PACKAGE_BUILDER_TAB_CREATE_PACKAGE_INVALID_NAME' => 'Package name contains invalid characters: ',
    'LBL_PACKAGE_BUILDER_CATEGORY_RECEIVED' => '{{category}} received!',
    'LBL_PACKAGE_BUILDER_CATEGORY_RETRIEVE_FAILED' => '{{category}} retrieve failed.',
    'LBL_PACKAGE_BUILDER_COMPLETE' => 'Complete',
    'LBL_PACKAGE_BUILDER_FETCHING_CUSTOMIZATIONS' => 'Fetching customizations',
    'LBL_PACKAGE_BUILDER_CUSTOMIZATIONS_FETCHED' => 'Customizations fetched',
    'LBL_PACKAGE_BUILDER_CUSTOMIZATIONS_FETCHING_FAILED' => 'Getting customizations failed.',
    'LBL_PACKAGE_BUILDER_ACCESS_DENIED' => 'Access denied. Please check your connection information.',
    'LBL_PACKAGE_BUILDER_CONNECTION_SUCCESS' => 'Connection successful!',
    'LBL_PACKAGE_BUILDER_CONNECTION_FAILED' => 'Connection failed.',
    'LBL_PACKAGE_BUILDER_NO_DATA' => 'No data found.',
    'LBL_PACKAGE_BUILDER_REPORT_SUMMATION' => 'Summation',
    'LBL_PACKAGE_BUILDER_REPORT_ROWS_AND_COLUMNS' => 'Rows And Columns',
    'LBL_PACKAGE_BUILDER_REPORT_SUMMATION_WITH_DETAILS' => 'Summation With Details',
    'LBL_PACKAGE_BUILDER_REPORT_MATRIX' => 'Matrix',
    'LBL_PACKAGE_BUILDER_FILTERING' => 'Filtering...',
    'LBL_PACKAGE_BUILDER_CATEGORY' => 'Category',
    'LBL_PACKAGE_BUILDER_DESCRIPTION' => 'Description',
    'LBL_PACKAGE_BUILDER_NAME' => 'Name',
    'LBL_PACKAGE_BUILDER_TYPE' => 'Type',
    'LBL_PACKAGE_BUILDER_CUSTOM_MODULE' => 'Custom Module',
    'LBL_PACKAGE_BUILDER_DATE_MODIFIED' => 'Date Modified',
    'LBL_PACKAGE_BUILDER_LEFT_MODULE' => 'Left Module',
    'LBL_PACKAGE_BUILDER_RIGHT_MODULE' => 'Right Module',
    'LBL_PACKAGE_BUILDER_FROM_STUDIO' => 'From Studio',
    'LBL_PACKAGE_BUILDER_MODULE' => 'Module',
    'LBL_PACKAGE_BUILDER_CLIENT' => 'Client',
    'LBL_PACKAGE_BUILDER_VIEW' => 'View',
    'LBL_PACKAGE_BUILDER_FILTERS' => 'Filters',
    'LBL_PACKAGE_BUILDER_DROPDOWN_NAME' => 'Dropdown Name',
    'LBL_PACKAGE_BUILDER_ID' => 'ID',
    'LBL_PACKAGE_BUILDER_DASHBOARD_MODULE' => 'Dashboard Module',
    'LBL_PACKAGE_BUILDER_DEFAULT_DASHBOARD' => 'Default Dashboard',
    'LBL_PACKAGE_BUILDER_BASE_MODULE' => 'Base Module',
    'LBL_PACKAGE_BUILDER_ASSIGNED_USER' => 'Assigned User',
    'LBL_PACKAGE_BUILDER_TEAM' => 'Team',
    'LBL_PACKAGE_BUILDER_REPORT_NAME' => 'Report Name',
    'LBL_PACKAGE_BUILDER_REPORT_TYPE' => 'Report Type',
    'LBL_PACKAGE_BUILDER_STATUS' => 'Status',
    'LBL_PACKAGE_BUILDER_VERSION' => 'Version',
    'LBL_PACKAGE_BUILDER_ACTIONS' => 'Actions',
    'LBL_PACKAGE_BUILDER_SHOW_DISABLED_ROWS' => 'Show disabled rows',
    'LBL_PACKAGE_BUILDER_HIDE_DISABLED_ROWS' => 'Hide disabled rows',
    'LBL_PACKAGE_BUILDER_NO_DESCRIPTION' => 'No description found',
    'LBL_PACKAGE_BUILDER_PULL_PACKAGE_TOOLTIP' => 'Pull package from remotely connected instance',
    'LBL_PACKAGE_BUILDER_PULL_PACKAGE_TOOLTIP_DISABLED' => 'This version of the package is already installed on the connected instance',
    'LBL_PACKAGE_BUILDER_PULL_PACKAGE' => 'Pull Package',
    'LBL_PACKAGE_BUILDER_UPDATE_PACKAGE' => 'Upgrade Package',
    'LBL_PACKAGE_BUILDER_UPDATE_PACKAGE_TOOLTIP' => 'Upgrade package from remotely connected instance',
    'LBL_PACKAGE_BUILDER_REPLACE' => 'Replace',
    'LBL_PACKAGE_BUILDER_CANCEL' => 'Cancel',
    'LBL_PACKAGE_BUILDER_CLOSE' => 'Close',
    'LBL_PACKAGE_BUILDER_PACKAGE_ALREADY_INSTALLED' => 'Package is already installed.',
    'LBL_PACKAGE_BUILDER_ACCESS_DENIED_WRONG_CONNECTION' => 'Access denied. Please check your connection information.',
    'LBL_PACKAGE_BUILDER_WRONG_UPLOAD' => 'Something went wrong with the package upload.',
    'LBL_PACKAGE_BUILDER_WRONG_UNINSTALL' => 'Something went wrong with the package uninstallation.',
    'LBL_PACKAGE_BUILDER_UPLOAD_SUCCESS' => 'Package uploaded successfully...',
    'LBL_PACKAGE_BUILDER_PULLING_PACKAGE' => 'Pulling Package',
    'LBL_PACKAGE_BUILDER_PULL_SUCCESS' => 'Package Pulled Successfully!',
    'LBL_PACKAGE_BUILDER_PULL_FAILED' => 'Package Pull Failed.',
    'LBL_PACKAGE_BUILDER_UPDATING_PACKAGE' => 'Upgrading Package',
    'LBL_PACKAGE_BUILDER_UPDATE_SUCCESS' => 'Package Upgraded Successfully!',
    'LBL_PACKAGE_BUILDER_UPDATE_FAILED' => 'Package Upgrade Failed.',
    'LBL_PACKAGE_BUILDER_UPLOADING' => 'Uploading',
    'LBL_PACKAGE_BUILDER_UNINSTALLING' => 'Uninstalling',
    'LBL_PACKAGE_BUILDER_INSTALL_FAILED' => 'Something went wrong with the package installation.',
    'LBL_PACKAGE_BUILDER_PACKAGE_INSTALLED' => 'Package Installed',
    'LBL_PACKAGE_BUILDER_INSTALLING' => 'Installing',
    'LBL_PACKAGE_BUILDER_PLEASE_CONFIRM' => 'Please confirm if you want to replace {{}} with {{}}.',
    'LBL_PACKAGE_BUILDER_UNINSTALL_SUCCESS' => 'Uninstallation complete ...',
    'LBL_PACKAGE_BUILDER_DISPLAY_LOG' => 'Display Log',
    'LBL_PACKAGE_BUILDER_NEED_FETCH_CUSTOMIZATIONS' => 'Customizations need to be fetched first.',
    'LBL_PACKAGE_BUILDER_NEED_SELECT_CUSTOMIZATIONS' => 'No selections have been made.',
    'LBL_PACKAGE_BUILDER_PACKAGE_NAME' => 'Package Name',
    'LBL_PACKAGE_BUILDER_CREATE_PACKAGE_SUCCESS' => 'Customizations Package Created!',
    'LBL_PACKAGE_BUILDER_CREATING_PACKAGE' => 'Creating package...',
    'LBL_PACKAGE_BUILDER_ERROR_LOADING_DATA' => 'There was an error loading the data.',
    'LBL_PACKAGE_BUILDER_CLEAR_FILTER' => 'Clear Filter',
    'LBL_PACKAGE_BUILDER_INVALID_SCHEME' => 'Only HTTPS connections are allowed',
    'LBL_PACKAGE_BUILDER_FILE_READ_ERROR' => 'Failed to read package file',
    'LBL_PACKAGE_BUILDER_SEARCHING' => 'Search...',
    'LBL_PACKAGE_BUILDER_PACKAGE_SAVE_MESSAGE' => 'The package will be saved to your device.',
    'LBL_PACKAGE_BUILDER_ADD_TO_LOCAL_PACKAGES' => 'Add to Local Packages',
    'LBL_PACKAGE_BUILDER_ADD_TO_LOCAL_SUCCESS_MESSAGE' => 'Package added successfully!',
    'LBL_PACKAGE_BUILDER_ADD_TO_LOCAL_PACKAGES_LABEL' => 'The package will be added to your local packages.',
    'LBL_PACKAGE_BUILDER_DOWNLOAD_PACKAGE' => 'Download Package',
    ...
    'LBL_PACKAGE_BUILDER_CONFIRM_PULL_PACKAGE' => 'Clicking "Confirm" will install the package and may temporarily impact performance in the instance. It is recommended to install packages to production instances during off-peak hours.',
    ...
    'ML_PHP_COMPATIBILITY' => 'PHP Compatibility',
    'ML_PHP_COMPATIBILITY_SCAN_FAILED' => 'PHP compatibility scan failed for unknown reasons',
    'ML_PHP_COMPATIBILITY_SCAN_INCOMPATIBLE_CODE' => 'Package contains code that is incompatible with newer PHP versions. Please see suggested fixes in the report.',
    'ML_PHP_COMPATIBILITY_DOWNLOAD_REPORT' => 'Download report',
...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_DISALLOW_ACTION' => 'Please wait for the current operation to complete',
    'LBL_VALIDATE_ROOT_PATH' => 'Validate Root Path',
    'LBL_DRIVE_ERROR_CREATING_FOLDER' => 'Error creating folder',
    ...
    'LBL_PATH_ERROR' => 'Path Error',
    'LBL_PATH_SAVED' => 'New path saved',
    'LBL_PATH_REQUIRED' => 'Path is required',
    ...
    'LBL_CLOUD_DRIVE_PATHS_MISSING_FOLDER_ID' => 'Onedrive/Sharepoint path configuration error: folder is missing',
