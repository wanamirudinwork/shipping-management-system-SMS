...
class DocuSignApi extends SugarApi
{
    ...
    public function send(ServiceBase $api, array $args): array
    {
        ...
        try {
            ...
            $envelopeViewRequest = new DocuSign\Model\EnvelopeViewRequest();
            $envelopeViewRequest->setReturnUrl($returnUrl);

            $senderView = $extApi->createSenderView($createdEnvelopeId, $envelopeViewRequest);
