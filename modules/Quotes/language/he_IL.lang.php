...
$mod_strings = [
    ...
    'LBL_CONVERSION_RATE_LOCK_FIELDSET' => 'שער המרה ו-Lock Fieldset',
    'LBL_CURRENCY_RATE' => 'שער מטבע',
    'LBL_LOCK_CONVERSION_RATES' => 'לנעול שערי המרה',
    ...
    'LBL_QUOTES_CONVERSION_LOCK_CONFIRM' => 'הפעלת השדה {{lockConversionRatesName}} תנעל את שער ההמרה של שורות הצעת המחיר הקשורות להצעת מחיר זו. להמשיך?',
    'LBL_QUOTES_CONVERSION_LOCK_MASSUPDATE_CONFIRM' => 'הפעלת השדה {{lockConversionRatesName}} תנעל את שער ההמרה של שורות הצעת המחיר הקשורות להצעות מחיר אלה. להמשיך?',
    'LBL_QUOTES_CONVERSION_UNLOCK_CONFIRM' => 'השבתת השדה {{lockConversionRatesName}} תעדכן את שורות הצעת המחיר הקשורות להצעת מחיר זו, באמצעות שערי ההמרה העדכניים ביותר. להמשיך?',
    'LBL_QUOTES_CONVERSION_UNLOCK_MASSUPDATE_CONFIRM' => 'השבתת השדה {{lockConversionRatesName}} תעדכן את שורות הצעת המחיר הקשורות להצעות מחיר אלה, באמצעות שערי ההמרה העדכניים ביותר. להמשיך?',
];
