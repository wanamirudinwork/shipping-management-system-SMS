...
$mod_strings = [
    ...
    'LBL_CONVERSION_RATE_LOCK_FIELDSET' => 'Conversion Rate and Lock Fieldset',
    'LBL_CURRENCY_RATE' => 'Currency Rate',
    'LBL_LOCK_CONVERSION_RATES' => 'Lock Conversion Rates',
    ...
    'LBL_QUOTES_CONVERSION_LOCK_CONFIRM' => 'Enabling the {{lockConversionRatesName}} field will lock the currency conversion rate for the Quoted Line Items related to this Quote. Do you want to proceed?',
    'LBL_QUOTES_CONVERSION_LOCK_MASSUPDATE_CONFIRM' => 'Enabling the {{lockConversionRatesName}} field will lock the currency conversion rate for the Quoted Line Items related to these Quotes. Do you want to proceed?',
    'LBL_QUOTES_CONVERSION_UNLOCK_CONFIRM' => 'Disabling the {{lockConversionRatesName}} field will update the Quoted Line Items related to this Quote using the most recent conversion rates. Do you want to proceed?',
    'LBL_QUOTES_CONVERSION_UNLOCK_MASSUPDATE_CONFIRM' => 'Disabling the {{lockConversionRatesName}} field will update the Quoted Line Items related to these Quotes using the most recent conversion rates. Do you want to proceed?',
];
