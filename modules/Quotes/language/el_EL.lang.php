...
$mod_strings = [
    ...
    'LBL_CONVERSION_RATE_LOCK_FIELDSET' => 'Ισοτιμία και ρύθμιση κλειδώματος πεδίου',
    'LBL_CURRENCY_RATE' => 'Ισοτιμία Νομίσματος',
    'LBL_LOCK_CONVERSION_RATES' => 'Κλείδωμα ισοτιμιών',
    ...
    'LBL_QUOTES_CONVERSION_LOCK_CONFIRM' => 'Η ενεργοποίηση του πεδίου {{lockConversionRatesName}} θα κλειδώσει την ισοτιμία μετατροπής νομίσματος για τη Γραμμή Εισηγμένων Στοιχείων που σχετίζεται με αυτήν την προσφορά. Θέλετε να συνεχίσετε;',
    'LBL_QUOTES_CONVERSION_LOCK_MASSUPDATE_CONFIRM' => 'Η ενεργοποίηση του πεδίου {{lockConversionRatesName}} θα κλειδώσει την ισοτιμία μετατροπής νομίσματος για τη Γραμμή Εισηγμένων Στοιχείων που σχετίζεται με αυτές τις προσφορές. Θέλετε να συνεχίσετε;',
    'LBL_QUOTES_CONVERSION_UNLOCK_CONFIRM' => 'Η απενεργοποίηση του πεδίου {{lockConversionRatesName}} θα ενημερώσει τη Γραμμή Εισηγμένων Στοιχείων που σχετίζεται με αυτήν την προσφορά με τις πιο πρόσφατες τιμές μετατροπής ισοτιμίας. Θέλετε να συνεχίσετε;',
    'LBL_QUOTES_CONVERSION_UNLOCK_MASSUPDATE_CONFIRM' => 'Η απενεργοποίηση του πεδίου {{lockConversionRatesName}} θα ενημερώσει τη Γραμμή Εισηγμένων Στοιχείων που σχετίζεται με αυτές τις προσφορές με τις πιο πρόσφατες τιμές μετατροπής ισοτιμίας. Θέλετε να συνεχίσετε;',
];
