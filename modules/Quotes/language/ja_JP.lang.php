...
$mod_strings = [
    ...
    'LBL_CONVERSION_RATE_LOCK_FIELDSET' => 'コンバージョン率とロックフィールドセット',
    'LBL_CURRENCY_RATE' => '通貨レート',
    'LBL_LOCK_CONVERSION_RATES' => 'コンバージョン率をロックする',
    'LBL_LINE_NUMBER' => '行番号',
    'LBL_STATE' => '都道府県:',
    ...
    'LBL_QUOTES_CONVERSION_LOCK_CONFIRM' => '{{lockConversionRatesName}} フィールドを有効にすると、この Quote に関連する Quote ラインアイテムの通貨換算レートをロックします。続行しますか？',
    'LBL_QUOTES_CONVERSION_LOCK_MASSUPDATE_CONFIRM' => '{{lockConversionRatesName}} フィールドを有効にすると、この Quote に関連する Quote ラインアイテムの通貨換算レートをロックします。続行しますか？',
    'LBL_QUOTES_CONVERSION_UNLOCK_CONFIRM' => '{{lockConversionRatesName}} フィールド無効にすると、この Quote に関連する見積り明細を最新のコンバージョン率で更新します。続行しますか？',
    'LBL_QUOTES_CONVERSION_UNLOCK_MASSUPDATE_CONFIRM' => '{{lockConversionRatesName}} フィールド無効にすると、これらの Quote に関連する見積り明細を最新のコンバージョン率で更新します。続行しますか？',
];
