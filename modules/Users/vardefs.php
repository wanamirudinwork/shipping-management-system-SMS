...
$dictionary['User'] = [
    ...
    'fields' => [
        ...
        'sugarpdf_pdf_calendar_font_name_data' => [
            'name' => 'sugarpdf_pdf_calendar_font_name_data',
            'vname' => 'LBL_PDF_CALENDAR_FONT',
            'type' => 'enum',
            'showNullOption' => true,
            'source' => 'non-db',
            'function_bean' => 'Users',
            'function' => 'getCalendarExportFontListOptions',
            'user_preference' => true,
            'studio' => false,
            'defaultFromConfig' => 'defaultPdfCalendarFontNameData',
        ],
