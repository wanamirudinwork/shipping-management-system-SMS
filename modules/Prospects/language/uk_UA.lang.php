...
2. Натисніть кнопку "Зберегти", щоб завершити створення нового запису й повернутися до попередньої сторінки.',
    ...
    // Market
    'LBL_UNSUB' => 'Відписалися',
    'LBL_FORMS' => 'Форми',
    'LBL_FRIENDFORWARD' => 'Перенаправлення другу',
    'LBL_DELIVERYSTATUS' => 'Статус доставки',
    'LBL_DELIVERYMESSAGE' => 'Повідомлення про доставку',
    'LBL_CLICKED' => 'З натисканнями',
    'LBL_OPENED' => 'Відкрито',
];
