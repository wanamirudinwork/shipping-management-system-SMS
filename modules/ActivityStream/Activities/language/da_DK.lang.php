...
$mod_strings = [
    ...
    'TPL_ACTIVITY_LINK' => 'Sammenkædet {{{str "TPL_ACTIVITY_RECORD" "Activities" subject}}} til {{{str "TPL_ACTIVITY_RECORD" "Activities" object}}}.',
    'TPL_ACTIVITY_UNLINK' => 'Ikke linket {{{str "TPL_ACTIVITY_RECORD" "Activities" subject}}} til {{{str "TPL_ACTIVITY_RECORD" "Activities" object}}}.',
    ...
    'TPL_ACTIVITY_ON' => '{{#if object}} på {{{str "TPL_ACTIVITY_RECORD" "Activities" object}}}.{{/if}}{{#if module}} på {{getModuleName module}}.{{else}} {{/if}}',
    'TPL_COMMENT' => '{{{value}}}',
