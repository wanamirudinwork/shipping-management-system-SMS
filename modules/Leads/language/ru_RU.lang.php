...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала предварительных контактов',
...
После утверждения обязательного и желаемого модуля, нажмите Сохранить и Конвертировать, чтобы завершить преобразование.',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => 'Мои предварительные контакты для дальнейших действий',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Веб-активность',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => 'Целевые страницы',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'Управление событиями',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => 'Управление событиями',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Веб-активность',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Последнее действие Salesfusion',
];
