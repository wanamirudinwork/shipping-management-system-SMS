...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Хронология на потенциални клиенти',
...
След като потвърдите създаване на всеки от модулите, които да бъдат създадени, натиснете бутона „Запази и преобразувай“, за да приключите процеса на преобразуване.',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => 'Моите следвани потенциални клиенти',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Уеб активност',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => 'Целеви страници',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'Управление на събития',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => 'Управление на събития',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Уеб активност',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Последна дейност на Salesfusion',
];
