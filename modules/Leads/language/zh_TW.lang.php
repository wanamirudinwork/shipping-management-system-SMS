...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => '潛在客戶時間軸',
...
在確定每個必要和必須的模組後，按一下頂部的「儲存並轉換」按鈕，完成轉換。',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => '我的跟進潛在客戶',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => '網路活動',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => '著陸頁',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => '事件管理',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => '事件管理',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => '網路活動',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Salesfusion 上次活動',
];
