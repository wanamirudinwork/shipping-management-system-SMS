...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => '潜在客户时间轴',
...
在您确定所需和所需的模块后，单击上方的“保存并转换”按钮完成转换。',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => '我的跟进潜在客户',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Web 活动',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => '登陆页面',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => '事件管理',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => '事件管理',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Web 活动',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Salesfusion 上次活动',
];
