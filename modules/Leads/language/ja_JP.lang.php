...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'リードタイムライン',
...
必要なモジュールを確認した後、上部にある [保存して変換] ボタンをクリックし、変換を確定します。',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => 'フォローアップリード',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Web アクティビティ',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => 'ランディングページ',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'イベント管理',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => 'イベント管理',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Web アクティビティ',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Salesfusion の最後のアクティビティ',
];
