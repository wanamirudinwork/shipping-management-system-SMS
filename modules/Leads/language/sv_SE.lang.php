...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Tidslinje för leads',
...
2. Klicka på "Spara" för att spara den nya posten och återgå till föregående sida.',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => 'Mina uppföljningsleads',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Webbaktivitet',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => 'Landningssidor',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'Hantering av evenemang',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => 'Hantering av evenemang',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Webbaktivitet',
    'LBL_SALESFUSION_VIEW' => 'Försäljning/Fusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Försäljning/fusion Senaste aktivitet',
];
