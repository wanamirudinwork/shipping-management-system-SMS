...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Часова шкала потенційного клієнта',
...
Після затвердження обов&#39;язкового і бажаного модуля, натисніть Зберегти і Конвертувати, щоб завершити перетворення.',
    ...
    'LBL_LIST_MY_FOLLOW_UP_LEADS' => 'Мої потенційні клієнти для подальшого контакту',

    // Market
    'LBL_SF_WEBACTIVITY_LEADS_FROM_SF_WEBACTIVITY_TITLE' => 'Вебзахід',
    'LBL_SF_DIALOGS_LEADS_FROM_SF_DIALOGS_TITLE' => 'Цільові сторінки',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'Керування подіями',
    'LBL_SF_EVENTMANAGEMENT_LEADS_FROM_LEADS_TITLE' => 'Керування подіями',
    'LBL_SF_WEB_ACTIVITY_LEADS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Вебзахід',
    'LBL_SALESFUSION_VIEW' => 'SalesFusion',
    'LBL_SF_LASTACTIVITY_DEFAULT' => 'Остання дія Salesfusion',
];
