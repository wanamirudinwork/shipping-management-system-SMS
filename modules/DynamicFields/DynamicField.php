...
class DynamicField
{
    ...
    public function saveExtendedAttributes($field, $column_fields)
    {
        ...
        foreach ($field->vardef_map as $property => $fmd_col) {
            ...
            if (!isset($field->$property) || safeInArray($fmd_col, $column_fields) || safeInArray($property, $column_fields)
