...
<tr>
    ...
    <td>
        ...
        {else}
            <input type="hidden" name="defaultDate" value="{$default_date|sugar_escape:'html':'UTF-8'}">{$default_date|sugar_escape:'html':'UTF-8'}
        {/if}
    </td>
</tr>
<tr>
    ...
    <td>
        {if $hideLevel < 5}
            ...
            <input type="hidden" name="defaultTime" id="defaultTime" value="{$defaultTime|sugar_escape:'html':'UTF-8'}">
        {else}
            <input type="hidden" name="defaultTime" id="defaultTime" value="{$defaultTime|sugar_escape:'html':'UTF-8'}">{$defaultTime|sugar_escape:'html':'UTF-8'}
        {/if}
    </td>
</tr>
