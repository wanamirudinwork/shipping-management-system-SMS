...
<tr>
    ...
    <td>
        ...
        {else}
            <input type="hidden" name="ext1" value="{$cf.ext1|sugar_escape:'html':'UTF-8'}">
            {$cf.ext1|sugar_escape:'html':'UTF-8'}
        {/if}
    </td>
</tr>
<tr>
    ...
    <td>
        ...
        {else}
            <input type="hidden" name="default_value" value="{$cf.default_value|sugar_escape:'html':'UTF-8'}">
            {$cf.default_value|sugar_escape:'html':'UTF-8'}
        {/if}
    </td>
</tr>
<tr>
    ...
    <td>
        {if $hideLevel < 5}
            <input type='text' name='ext2' id='ext2' value='{$cf.ext2|sugar_escape:'html':'UTF-8'|default:5}'>
        ...
        {else}
            <input type="hidden" name="ext2" value="{$cf.ext2|sugar_escape:'html':'UTF-8'}">
            {$cf.ext2|sugar_escape:'html':'UTF-8'}
        {/if}
    </td>
</tr>
<tr>
