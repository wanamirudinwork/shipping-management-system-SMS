...
<tr>
	...
	<td>
    {if $hideLevel < 1}
	    <input id ="label_key_id" type="text" name="label" value="{$vardef.vname|sugar_escape:'html'}">
	{else}
		<input type="text" readonly value="{$vardef.vname|sugar_escape:'html'}" disabled=1>
		<input id ="label_key_id" type="hidden" name="label" value="{$vardef.vname|sugar_escape:'html'}">
	{/if}
	</td>
</tr>
<tr>
