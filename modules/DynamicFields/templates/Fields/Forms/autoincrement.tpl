...
{if $range_search_option_enabled}
    <tr>
        ...
        <td>
            ...
            {if $hideLevel > 5}<input type="hidden" name="enable_range_search" value="{$vardef.enable_range_search|sugar_escape:'html':'UTF-8'}">{/if}
        </td>
    </tr>
{/if}
...
<tr>
    ...
    <td>
        ...
        <input type="text" name="autoinc_next" id="autoinc_next" value="{$vardef.autoinc_next|sugar_escape:'html':'UTF-8'|default:1}" {if $MB}disabled=1{/if}>
        <script>addToValidateMoreThan('popup_form', 'autoinc_next', 'int', false,'{sugar_translate module="DynamicFields" label="COLUMN_TITLE_AUTOINC_NEXT"}', {$vardef.autoinc_next|sugar_escape:'html':'UTF-8'|default:1});</script>
...
<tr>
    ...
    <td>
        ...
        {if $hideLevel > 5}<input type="hidden" name="ext3" value="{$vardef.disable_num_format|sugar_escape:'html':'UTF-8'}">{/if}
    </td>
</tr>
