...
<tr>
    ...
    <td>
        {if $hideLevel < 5}
            <input type="text" name="default" id="default" value="{$vardef.default|sugar_escape:'html':'UTF-8'}" maxlength="{$vardef.len|sugar_escape:'html':'UTF-8'|default:50}">
        {else}
...
<tr>
    ...
    <td>
        {if $hideLevel < 5}
            <input type="text" name="len" id="field_len" value="{$vardef.len|sugar_escape:'html':'UTF-8'|default:25}"
                   onchange="forceRange(this,1,255);changeMaxLength(document.getElementById('default'),this.value);">
            <input type="hidden" id="orig_len" name="orig_len" value="{$vardef.len|sugar_escape:'html':'UTF-8'}">
        {if $action=="saveSugarField"}
        <input type="hidden" name="customTypeValidate" id="customTypeValidate" value="{$vardef.len|sugar_escape:'html':'UTF-8'|default:25}"
