                                            ...
                                            {if $allow_sales_stage_classification}
                                                ...
                                                {else}
                                                    {if (safeInArray($name, $sales_stage_won_options))}
                                                        {assign "sales_stage_key" "Closed Won"}
                                                    {elseif (safeInArray($name, $sales_stage_lost_options))}
                                                        {assign "sales_stage_key" "Closed Lost"}
                                                    {else}
                                                        {assign "sales_stage_key" "Open"}
                                                    {/if}

                                                    <span>
                                                        <span class="fieldValue" id="span_sales_stage_classification_{$name|escape:'html':'UTF-8'}">[{$sales_stage_classification_options[$sales_stage_key]|escape:'html':'UTF-8'}]</span>
                                                        <span class="fieldValue" id="span_edit_sales_stage_classification_{$name|escape:'html':'UTF-8'}" style="display:none">
                                                            {html_options name='sales_stage_classification_dropdown'
                                                                options=$sales_stage_classification_options
                                                                selected=$sales_stage_key
                                                                onchange='SimpleList.setSalesStageDropDownValue(this, $(this).find("option:selected").text(), true);'
                                                                onblur='SimpleList.setSalesStageDropDownValue(this, $(this).find("option:selected").text(), true);'
                                                            }
                                                        </span>
                                                    </span>
                                                {/if}
