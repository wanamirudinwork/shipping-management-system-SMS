...
/**
 * @var WorkFlowAlertShell $workflowAlertShell
 */
$workflowAlertShell = BeanFactory::getBean('WorkFlowAlertShells', $parentId);
/**
 * @var WorkFlow $workflow
 */
$workflow = $workflowAlertShell->get_workflow_object();
