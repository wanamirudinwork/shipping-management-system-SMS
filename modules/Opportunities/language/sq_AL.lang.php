...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Mundësitë e këtij tremujori',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mundësitë e mia të hapura ekzistuese të biznesit',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mundësitë e mia të hapura',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moduli {{plural_module_name}} të lejon të gjurmosh shitjet individuale nga fillimi deri në fund. Çdo regjistrim {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes, si dhe në lidhje me regjistrime të tjera të rëndësishme si {{quotes_module}}, {{contacts_module}} etj. {{module_name}} do të kalojë në disa faza shitjesh deri sa të shënohet si "Fitim i mbyllur" ose "Humbje e mbyllur". {{plural_module_name}} mund të shfrytëzohet edhe më tepër duke përdorur modulin {{forecasts_singular_module}} të Sugar-it për të kuptuar dhe parashikuar tendencat e shitjeve, si dhe për të fokusuar punën për të arritur kuotat e shitjeve.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moduli {{plural_module_name}} të lejon të gjurmosh shitje individuale dhe artikuj që u përkasin atyre shitjeve nga fillimi deri në fund. Çdo regjistrim {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes, si dhe të dhëna që kanë të bëjnë me regjistrime të tjera të rëndësishme, si {{quotes_module}}, {{contacts_module}} etj.

-Modifiko fushën e këtij regjistrimi duke klikuar një fushë individuale ose butonin "Modifiko".
-Shiko ose modifiko lidhje të regjistrimeve të tjera te nënpanelet duke kaluar çelësin majtas te "Shikimi i të dhënave".
-Bëj dhe shiko komentet e përdoruesit dhe historikun e ndryshimit të regjistrimit te {{activitystream_singular_module}} duke kaluar çelësin majtas te "Transmetimi i aktivitetit".
 -Ndiq ose shëno si të preferuar regjistrimin duke përdorur ikonën në të djathtë të emrit të regjistrimit.
-Veprime të tjera shtesë disponohen në menynë me lëshim "Veprimet" që shfaqet në të djathtë të butonit "Modifiko".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Moduli {{plural_module_name}} të lejon të gjurmosh shitje individuale dhe artikuj që u përkasin atyre shitjeve nga fillimi deri në fund. Çdo regjistrim {{module_name}} përfaqëson një shitje të mundshme dhe përfshin të dhënat përkatëse të shitjes, si dhe të dhëna të lidhura me regjistrime të tjera të rëndësishme, si p. sh. {{quotes_module}}, {{contacts_module}}, etj.

Për të krijuar një {{module_name}}:
1. Jep vlerat për fushat sipas dëshirës.
 - Fushat e shënuara si "Të domosdoshme" duhet të plotësohen para se të ruhen.
