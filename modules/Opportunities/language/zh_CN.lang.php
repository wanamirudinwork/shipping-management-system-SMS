...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => '本季度的商机',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => '我的开放现有商机',
    'LBL_MY_OPEN_OPPORTUNITIES' => '我的开放商机',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} 模块允许您从头到尾跟踪单次销售。每条 {{module_name}} 记录代表一次预期销售，包括相关销售数据并与其他重要记录（如 {{quotes_module}} 和 {{contacts_module}} 等）相关。{{module_name}} 通常会经历几个销售阶段，直到标记为“已结束并赢得客户”或“已结束但客户流失”。可以通过使用 Sugar 的 {{forecasts_singular_module}}ing 模块来进一步利用 {{plural_module_name}}，以了解和预测销售趋势，并专注于实现销售配额的工作。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} 模块允许您从头到尾跟踪单次销售以及属于这些销售的明细项目。每条 {{module_name}} 记录代表一次预期销售，包括相关销售数据并与 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关。

- 通过单击单个字段或“编辑”按钮来编辑此记录的字段。
- 通过将左下窗格切换为“数据视图”来查看或修改子面板中其他记录的链接。
- 通过将左下窗格切换为“活动流”，在 {{activitystream_singular_module}} 中发表和查看用户评论，以及记录更改历史。
- 使用记录名称右侧的图标关注或收藏此记录。
- “编辑”按钮右侧的“操作”下拉菜单中提供了更多操作。',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} 模块允许您从头到尾跟踪单次销售以及属于这些销售的明细项目。每条 {{module_name}} 记录代表一次预期销售，包括相关销售数据并与 {{quotes_module}}、{{contacts_module}} 等其他重要记录相关。
