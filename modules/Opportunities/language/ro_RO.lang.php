...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Oportunitățile acestui trimestru',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Oportunitățile mele de afaceri deschise existente',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Oportunitățile mele deschise',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date relevante de vânzare, precum și referitoare la alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc. Un {{module_name}} va progresa de obicei prin mai multe etape de vânzări până când este marcat fie „Închis câștigat", fie „Închis pierdut". {{plural_module_name}} pot fi valorificate și mai mult prin utilizarea {{forecasts_singular_module}} pentru a înțelege și a prezice tendințele de vânzări, precum și pentru a concentra munca pentru a atinge cotele de vânzări.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale și articolele asociate acestor vânzări de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date relevante privind vânzările, precum și date referitoare la alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
...
- Adăugați și vizualizați comentariile utilizatorilor și înregistrați istoricul modificărilor în {{activitystream_singular_module}} comutând panoul din stânga jos la „Flux de activitate".
- Urmăriți sau marcați ca preferată această înregistrare folosind pictogramele din dreapta numelui înregistrării.
- Acțiuni suplimentare sunt disponibile în meniul derulant Acțiuni din dreapta butonului Editare.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale și articolele asociate acestor vânzări de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date relevante privind vânzările, precum și date referitoare la alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
...
1. Introduceți valorile dorite pentru câmpuri.
 ...
 - Faceți clic pe „Afișează mai multe” pentru a afișa câmpuri suplimentare, dacă este necesar.
