...
$mod_strings = [
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Pardavimų „Focus“ ataskaitų sritis – konsolė',
    'LBL_OPPORTUNITIES_FOCUS_DRAWER_DASHBOARD' => 'Pardavimų „Focus“ ataskaitų sritis',
...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Šio ketvirčio galimybės',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mano atviros esamos verslo galimybės',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mano atviros galimybės',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modulis leidžia stebėti individualius pardavimus nuo pradžios iki pabaigos. Kiekvienas {{module_name}} įrašas rodo būsimą pardavimą ir apima atitinkamus pardavimo duomenis, taip pat susijusius su kitais svarbiais įrašais, tokiais kaip {{quotes_module}}, {{contacts_module}} ir kt. {{module_name}} paprastai pereis kelis pardavimo etapus, kol bus pažymėta „Uždaryta, laimėta“ arba „Uždaryta, pralaimėta“. {{plural_module_name}} galima dar labiau išnaudoti naudojant „Sugar“ {{forecasts_singular_module}} modulį, kad suprastumėte ir numatytumėte pardavimų tendencijas bei sutelktumėte darbą pardavimų kvotoms pasiekti.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulis {{plural_module_name}} leidžia stebėti atskirus pardavimus ir tiems pardavimams priklausančius eilutės elementus nuo pradžios iki pabaigos. Kiekvienas {{module_name}} įrašas rodo būsimą pardavimą ir apima atitinkamus pardavimo duomenis, taip pat susijusius su kitais svarbiais įrašais, tokiais kaip {{quotes_module}}, {{contacts_module}} ir kt.
...
- Atlikite ir peržiūrėkite vartotojų komentarus ir įrašykite pakeitimų istoriją {{activitystream_singular_module}} perjungdami apatinę kairiąją sritį į „Veiklos srautas“.
- Stebėkite šį įrašą arba įtraukite jį į parankinius naudodami piktogramas, esančias įrašo pavadinimo dešinėje.
- Papildomus veiksmus galima atlikti išskleidžiamajame meniu „Veiksmai“ mygtuko „Redaguoti“ dešinėje.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} suteikia galimybę nuo pradžios iki pabaigos stebėti atskirus pardavimus ir tiems pardavimams priklausančius eilutės elementus. Kiekvienas {{module_name}} įrašas reiškia būsimą pardavimą ir apima atitinkamus pardavimo duomenis, taip pat yra susijęs su kitais svarbiais įrašais, tokiais kaip {{quotes_module}}, {{contacts_module}} ir kt.
