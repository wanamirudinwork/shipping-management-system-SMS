...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Tämän vuosineljänneksen mahdollisuudet',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Avoimet olemassa olevat liiketoimintamahdollisuuteni',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Omat avoimet myyntimahdollisuuteni',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-moduulissa voit seurata yksittäisiä myyntitapahtumia alusta loppuun. Kukin {{module_name}}-moduulin tietue kuvastaa mahdollista myyntitietoa ja liittyy muihin tärkeisiin tietueisiin, kuten {{quotes_module}}, {{contacts_module}} jne. {{module_name}} etenee tavallisesti usean myyntivaiheen läpi, kunnes se merkitään joko "Suljetuksi voitetuksi" tai "Suljetuksi hävityksi". {{plural_module_name}}-moduulia voidaan hyödyntää vielä enemmän käyttäen Sugarin {{forecasts_singular_module}}-moduulia, mikä auttaa ymmärtämään ja ennakoimaan myyntitrendejä ja keskittymään saavuttamaan myyntikiintiöitä.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-moduulin avulla pystyt seuraamaan yksittäisiä myyntitapahtumia ja näihin myyntitapahtumiin liittyviä rivikohteita alusta loppuun. Kukin {{module_name}}-moduulin tietue kuvastaa mahdollista myyntitietoa ja liittyy muihin tärkeisiin tietueisiin, kuten {{quotes_module}}, {{contacts_module}} jne.

- Muokkaa tämän tietueen kenttiä napsauttamalla yksittäistä kenttää tai Muokkaa-painiketta.
- Tarkastele tai muokkaa linkkejä muihin tietueisiin alapaneeleissa vaihtamalla vasemman alapainikkeen tilaksi "Tietojen tarkastelu".
- Tee ja tarkastele käyttäjäkommentteja ja tietueen muutoshistoriaa moduulissa {{activitystream_singular_module}} vaihtamalla vasemman alapaneelin tilaksi "Aktiviteettivirta".
- Seuraa tai lisää tämä tietue suosikkeihin käyttämällä tietueen nimen oikealla puolella olevia kuvakkeita.
- Lisätoimintoja on saatavilla Muokkaa-painikkeen oikealle sijaitsevassa Toiminnot-pudotusvalikossa.',
...
1. Anna haluamasi arvot kenttiin.
 - "Pakollinen"-merkityt kentät on täytettävä ennen tallentamista.
 - Avaa lisäkenttiä tarvittaessa napsauttamalla "Näytä lisää".
