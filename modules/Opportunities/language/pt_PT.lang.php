...
//END DON'T CONVERT
    ...
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'As Minhas Oportunidades de Negócios Existentes Abertas',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'As Minhas Oportunidades Abertas',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O módulo {{plural_module_name}} permite-lhe acompanhar as vendas individuais do início ao fim. Cada {{module_name}} representa uma venda potencial e inclui dados de venda relevantes, bem como relativos a outros registos importantes, como {{quotes_module}}, {{contacts_module}}, etc. Um {{module_name}} normalmente progridirá através de várias fases de vendas até que seja marcado como "Fechado ganho" ou "Fechado perdido". O {{plural_module_name}} pode ser alavancado ainda mais usando o {{forecasts_singular_module}} do Sugar para entender e prever tendências de vendas, bem como focar o trabalho para atingir as cotas de vendas.',
