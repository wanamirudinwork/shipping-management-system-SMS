...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Bu Çeyreğin Fırsatları',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Açık Kalan Mevcut İş Fırsatlarım',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Açık Kalan Fırsatlarım',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modülü, bireysel satışları başından sonuna kadar izlemenizi sağlar. Her {{module_name}} modül kaydı, muhtemel satışı temsil eder ve ilgili satış verileri ve ayrıca {{quotes_module}}, {{contacts_module}} gibi diğer önemli kayıtlarla ilgili bilgileri içerir. Bir {{module_name}} "Başarıyla Kapandı" veya "Başarısızlıkla Kapandı" olarak işaretlenene kadar genellikle birkaç Satış Aşaması boyunca ilerler. {{plural_module_name}} satış eğilimlerini aynı zamanda satış kotalarına ulaşmak için odaklanma çalışmasını anlamak ve tahmin etmek üzere Sugar&#39;ın {{forecasts_singular_module}} yapma modülünü kullanarak daha da geliştirilebilir.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} modülü, bireysel satışları ve bu satışlara ait ilgili lakemleri başından sonuna kadar izlemenizi sağlar. Her {{module_name}} modül kaydı, muhtemel satışı temsil eder ve ilgili satış verileri ve ayrıca {{quotes_module}}, {{contacts_module}} gibi diğer önemli kayıtlarla ilgili bilgileri içerir.
...
- Sol altta yer alan paneli "Aktivite Akışı" olarak değiştirerek kullanıcı yorumları görün, oluşturun ve {{activitystream_singular_module}} kaydındaki değişiklik tarihçesini görün.
- Kayıt adının sağ tarafında bulunan simgeleri kullanarak bu kaydı takip edin veya favoriler arasına alın.
- Daha fazla işlem, Değiştir tuşunun sağındaki İşlemler açılır menüsünde bulunmaktadır.',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} modülü, bireysel satışları ve bu satışlara ait ilgili lakemleri başından sonuna kadar izlemenizi sağlar. Her {{module_name}} modül kaydı, muhtemel satışı temsil eder ve ilgili satış verileri ve ayrıca {{quotes_module}}, {{contacts_module}} gibi diğer önemli kayıtlarla ilgili bilgileri içerir. 

{{module_name}} kaydı oluşturmak için:
1. İstendiği şekilde alanlar için değerler girin.
- "Zorunlu" olarak işaretlenmiş alanların kaydetmeden önce girilmesi gereklidir.
