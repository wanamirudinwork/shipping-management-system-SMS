...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Möjligheter för detta kvartal',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mina öppna befintliga affärsmöjligheter',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mina öppna möjligheter',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}} låter dig spåra enskilda försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning och innehåller relevanta försäljningsdata samt relaterar till andra viktiga dokument, t.ex. {{quotes_module}}, {{contacts_module}} etc. En {{module_name}} går vanligtvis igenom flera försäljningsfaser tills den märks som antingen ”Stängd vunnen eller ”Stängd förlorad”. {{plural_module_name}} kan utnyttjas ännu mer genom användning av Sugars {{forecasts_singular_module}}-modul för att förstå och förutsäga försäljningstrender samt fokusera arbetet för att uppnå försäljningskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Med modulen {{plural_module_name}} kan du spåra enskilda försäljningar och de artiklar som hör till dessa försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning och innehåller relevanta försäljningsdata samt relaterar till andra viktiga poster såsom {{quotes_module}}, {{contacts_module}}, etc.
...
– Skapa och visa användarkommentarer och ändringshistorik för posten i {{activitystream_singular_module}} genom att växla den nedre vänstra rutan till ”Aktivitetsflöde”.
– Följ eller favoritmarkera den här posten med hjälp av ikonerna till höger om postens namn.
– Ytterligare åtgärder finns tillgängliga i rullgardinsmenyn Åtgärder till höger om knappen Redigera.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Med modulen {{plural_module_name}} kan du spåra enskilda försäljningar och de artiklar som hör till dessa försäljningar från början till slut. Varje {{module_name}}-post representerar en potentiell försäljning och innehåller relevanta försäljningsdata samt relaterar till andra viktiga poster såsom {{quotes_module}}, {{contacts_module}}, etc.

Så här skapar du en {{module_name}}:
1. Ange värden för de fält som önskas.
 – Fält som är märkta ”Obligatoriskt” måste fyllas i innan du sparar.
 – Klicka på ”Visa mer” för att visa ytterligare fält om det behövs.
