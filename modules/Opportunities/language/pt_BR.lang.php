...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Oportunidades deste trimestre',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Minhas oportunidades de negócios existentes abertas',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Minhas oportunidades em aberto',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'O {{plural_module_name}} permite acompanhar as vendas individuais do início ao fim. Cada registro de {{module_name}} representa uma possível venda e inclui dados de venda relevantes, bem como relacionados a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc. Um {{module_name}} normalmente progredirá por vários estágios de vendas até ser marcado como "Fechadas ganhas" ou "Fechadas perdidas". O {{plural_module_name}} pode ser aproveitado ainda mais usando o módulo {{forecasts_singular_module}} do Sugar para entender e prever tendências de vendas, bem como focar o trabalho para alcançar as cotas de vendas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'O módulo {{plural_module_name}} permite que você acompanhe vendas individuais e os itens de linha pertencentes a elas do início ao fim. Cada registro de {{module_name}} representa uma venda em potencial e inclui dados de venda relevantes, bem como relacionados a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc.
...
- Faça e veja comentários de usuários e histórico de alterações de registro no {{activitystream_singular_module}} alternando o painel inferior esquerdo para "Cadeia de atividades".
...
- Ações adicionais estão disponíveis no menu suspenso Ações à direita do botão Editar.',
    ...
    'LBL_HELP_CREATE' => 'O módulo {{plural_module_name}} permite que você acompanhe as vendas individuais e os itens de linha pertencentes a elas, do início ao fim. Cada registro de {{module_name}} representa uma venda em potencial e inclui dados de venda relevantes, bem como relacionados a outros registros importantes, como {{quotes_module}}, {{contacts_module}} etc.
