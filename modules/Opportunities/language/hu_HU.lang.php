...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Az idei negyedév lehetőségei',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Saját nyitott meglévő üzleti lehetőségeim',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Saját nyitott lehetőségek',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'A(z) {{plural_module_name}} modul lehetővé teszi az egyes értékesítések nyomon követését az elejétől a végéig. Mindegyik {{module_name}} rekord egy várható értékesítést képvisel, és tartalmazza a releváns értékesítési adatokat, valamint más fontos rekordokhoz kapcsolódik, mint például: {{quotes_module}}, {{contacts_module}} stb. Egy {{module_name}} általában több értékesítési fázison halad keresztül, amíg "lezárt, nyert" vagy "lezárt, elveszett" jelölést nem kap. {{plural_module_name}} még tovább kihasználható a Sugar {{forecasts_singular_module}} modul használatával az értékesítési trendek megértéséhez és előrejelzéséhez, valamint az értékesítési kvóták eléréséhez szükséges munka összpontosításához.',
