...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Les oportunitats d&#39;aquest trimestre',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Les meves oportunitats de negoci obertes existents',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Les meves oportunitats obertes',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El mòdul {{plural_module_name}} us permet fer un seguiment de les vendes individuals de principi a fi. Cada registre de {{module_name}} representa una possible venda i inclou dades rellevants de la venda, així com les relatives a altres registres importants com {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} normalment progressarà a través de diverses fases de venda fins que es marqui com a "Tancat guanyat" o "Tancat perdut". {{plural_module_name}} es pot aprofitar encara més mitjançant l&#39;ús del mòdul de {{forecasts_singular_module}} de Sugar per entendre i predir les tendències de venda, així com enfocar el treball per aconseguir quotes de vendes.',
...
- Feu comentaris i vegeu els dels usuaris i el registre de l&#39;historial de canvis a {{activitystream_singular_module}} alternant el panell inferior esquerre a "Seqüència d&#39;activitat".
...
2. Premeu "Desa" per finalitzar el nou registre i tornar a la pàgina anterior.',
