...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Les affaires de ce trimestre',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mes affaires commerciales existantes ouvertes',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mes affaires ouvertes',
...
- Afficher ou modifier les liaisons avec les autres enregistrements via les sous-panels en cliquant sur le bouton sur " Affichage des données ". 
- Afficher et participer aux commentaires et au flux d&#39;activité via le module {{activitystream_singular_module}} "Flux d’activité". 
