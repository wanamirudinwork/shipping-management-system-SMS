...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Угоди за цей квартал',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Мої відкриті існуючі бізнес-угоди',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Мої відкриті угоди',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} відображає потенційний продаж і містить відповідні відомості про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. {{module_name}} зазвичай проходить через декілька етапів продажу, доки його не буде позначено як «Закрито (успішний)» або «Закрито (втрачений)». {{plural_module_name}} можна використовувати ще ефективніше завдяки модулю Sugar {{forecasts_singular_module}}, що допомагає краще розуміти й передбачати тенденції продажів, а також зосереджувати роботу на досягненні встановлених квот продажів.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та позиції цих продажів від початку до кінця. Кожен запис {{module_name}} відображає потенційний продаж і містить відповідні відомості про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.

- Редагуйте поля цього запису, натиснувши на окреме поле або кнопку «Редагувати».
- Переглядайте або змінюйте посилання на інші записи в підпанелях шляхом перемикання лівої нижньої панелі на «Перегляд даних».
- Створюйте і переглядайте коментарі користувачів і історію редагування записів у {{activitystream_singular_module}} шляхом перемикання нижньої лівої панелі на «Стрічка активностей».
- Відстежуйте або додавайте до вподобань цей запис за допомогою іконок праворуч від назви запису.
- Додаткові дії доступні у випадаючому меню «Дії», праворуч від кнопки «Редагувати».',
