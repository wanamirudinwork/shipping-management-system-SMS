...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'فرص هذا الربع',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'فرص عملي الحالية المفتوحة',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'فرصي المفتوحة',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'تتيح لك وحدة {{plural_module_name}} تتبع المبيعات الفردية من البداية إلى النهاية. ويمثل كل سجل {{module_name}} عملية بيع محتملة ويتضمن بيانات مبيعات ذات صلة بالإضافة إلى ربطه بسجلات مهمة أخرى مثل {{quotes_module}} و {{contacts_module}}، وما إلى ذلك. وعادةً ما يمر سجل {{module_name}} عبر العديد من مراحل المبيعات حتى يتم وضع علامة "مغلق كفائز" أو "مغلق كخاسر". ويمكن الاستفادة من {{plural_module_name}} بشكل أكبر باستخدام وحدة {{forecasts_singular_module}} في Sugar لفهم وتوقع اتجاهات المبيعات بالإضافة إلى تركيز العمل على تحقيق حصص المبيعات.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'باستخدام وحدة {{plural_module_name}}، يمكنك تتبع كل عملية بيع على حدة، بالإضافة إلى العناصر التابعة لها، من البداية إلى النهاية. يمثل كل سجل{{module_name}} معاملة بيع محتملة ويحتوي على بيانات البيع المهمة، بالإضافة إلى ارتباطه بسجلات أخرى مهمة مثل {{quotes_module}} و{{contacts_module}} وغيرها. 

- لتعديل معلومات هذا السجل، انقر على أي حقل تريد تعديله، أو انقر على زر "تحرير". 
- لعرض أو تعديل الروابط إلى سجلات أخرى، انتقل إلى "عرض البيانات" في اللوحة السفلية اليسرى.
-ولإضافة تعليقات أو الاطلاع على سجل التغييرات، {{activitystream_singular_module}} انتقل إلى "مجرى النشاط" في اللوحة السفلية اليسرى. 
- لإضافة هذا السجل إلى قائمة المتابعة أو المفضلة، استخدم الأيقونات الموجودة على يمين اسم السجل. للوصول إلى المزيد من الإجراءات، انقر على قائمة "الإجراءات" المنسدلة بجانب زر "تحرير".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'باستخدام وحدة {{plural_module_name}}، يمكنك تتبع كل عملية بيع على حدة، بالإضافة إلى العناصر التابعة لها، من البداية إلى النهاية. يمثل كل سجل{{module_name}} معاملة بيع محتملة ويحتوي على بيانات البيع المهمة، بالإضافة إلى ارتباطه بسجلات أخرى مهمة مثل {{quotes_module}} و{{contacts_module}} وغيرها.

لإنشاء {{module_name}}:
1- قم بتوفير القيم للحقول حسب الرغبة.
 - يجب إكمال الحقول المميزة بعلامة "مطلوب" قبل الحفظ.
 - انقر على "إظهار المزيد" لعرض حقول إضافية إذا لزم الأمر.
2. انقر على "حفظ" لإتمام السجل الجديد والعودة إلى الصفحة السابقة.',
