...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Las oportunidades de este trimestre',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mis oportunidades de negocio existentes abiertas',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mis Oportunidades abiertas',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales de principio a fin. Cada registro de {{module_name}} representa una venta potencial e incluye datos relevantes de la venta, así como los relacionados con otros registros importantes, tales como {{quotes_module}}, {{contacts_module}}, etc. Un {{module_name}} por lo general avanzará a través de varias etapas de venta hasta que se marque como "Cerrado ganado" o "Cerrado perdido". {{plural_module_name}} se puede aprovechar aún más mediante el uso del módulo de {{forecasts_singular_module}} de Sugar para comprender y predecir las tendencias de ventas, así como enfocar el trabajo para lograr las cuotas de ventas.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales y los artículos pertenecientes a esas ventas de principio a fin. Cada registro de {{module_name}} representa una venta potencial e incluye datos relevantes de la venta, además de los relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc.

- Edite los campos de este registro con un clic en el campo individual o el botón Editar.
- Vea o modifique enlaces a otros registros en los subpaneles mediante el cambio del panel inferior izquierdo a "Vista de datos".
- Comente o vea comentarios de otros usuarios y el historial de cambios del registro en el {{activitystream_singular_module}} cambiando el panel inferior izquierdo a "Flujo de actividades".
- Siga o guarde como favorito este registro con los iconos a la derecha del nombre del registro.
- Hay acciones adicionales disponibles en el menú desplegable Acciones a la derecha del botón Editar.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'El módulo {{plural_module_name}} le permite realizar un seguimiento de las ventas individuales y los artículos pertenecientes a esas ventas de principio a fin. Cada registro de {{module_name}} representa una venta potencial e incluye datos relevantes de la venta, además de los relacionados con otros registros importantes como {{quotes_module}}, {{contacts_module}}, etc.
