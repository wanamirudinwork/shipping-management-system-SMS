...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Prilike ovog tromjesječja',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Moje otvorene postojeće poslovne prilike',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Moje otvorene prilike',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} omogućuje praćenje pojedinačnih prodaja od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja potencijalnu prodaju i uključuje relevantne podatke o prodaji, kao i podatke u vezi s ostalim važnim zapisima kao što su moduli {{quotes_module}}, {{contacts_module}} itd. Modul {{module_name}} obično će napredovati kroz nekoliko faza prodaje dok se ne označi kao "Zatvoreno kao uspjelo" ili "Zatvoreno kao neuspjelo". Modul {{plural_module_name}} može se još više iskoristiti korištenjem Sugarova modula {{forecasts_singular_module}}ing u svrhu razumijevanja i predviđanja trendova prodaje, kao i usmjeravanja poslovanja prema postizanju prodajnih kvota.',
...
- Uredite polja ovog zapisa klikom na pojedino polje ili gumb Uredi. 
- Pogledajte ili izmijenite poveznice na ostale zapise u podpločama prebacivanjem donjeg lijevog okna na „Prikaz podataka”. 
...
1. Unesite vrijednosti polja po želji.
 ...
 – Kliknite „Prikaži više” kako biste po potrebi otkrili dodatna polja.
2. Kliknite „Spremi” kako biste završili novi zapis i vratili se na prethodnu stranicu.',
