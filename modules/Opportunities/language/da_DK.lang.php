...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Dette kvartals muligheder',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mine åbne eksisterende forretningsmuligheder',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mine åbne salgsmuligheder',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulet {{plural_module_name}} giver dig mulighed for at spore individuelle salg fra start til slut. Hver {{module_name}}-optegnelse repræsenterer et potentielt salg og indeholder relevante salgsdata samt relaterer til andre vigtige optegnelser som {{quotes_module}}, {{contacts_module}} osv. {{module_name}} vil typisk gå gennem flere salgsstadier, indtil den markeres som enten "Lukket vundet" eller "Lukket tabt". {{plural_module_name}} kan udnyttes endnu mere ved at bruge Sugars {{forecasts_singular_module}}-modul til at forstå og forudsige salgstendenser samt fokusere arbejdet på at nå salgskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulet {{plural_module_name}} giver dig mulighed for at spore individuelle salg og linjeelementer, der tilhøre disse salg, fra start til slut. Hver {{module_name}}-post repræsenterer et potentielt salg og indeholder relevante salgsdata, og er relateret til andre vigtige optegnelser som {{quotes_module}}, {{contacts_module}} osv.

- Redigér felterne for denne post ved at klikke på et individuelt felt eller på knappen Redigér.
- Få vist eller rediger links til andre opteglenser i underpanelerne ved at skifte den nederste venstre rude til "Datavisning".
- Skriv og få vist brugerkommentarer, og registrér ændringshistorik i {{activitystream_singular_module}} ved at skifte den nederste venstre rude til "Aktivitetsstream".
- Følg eller angiv denne optegnelse som favorit ved at bruge ikonerne til højre for optegnelsens navn.
- Der er yderligere handlinger tilgængelige i rullemenuen Handlinger til højre for knappen Redigér.',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}}-modulet giver dig mulighed for at spore individuelle salg og de linjeelementer, der tilhører disse salg, fra start til slut. Hver {{module_name}}-optegnelse repræsenterer et potentielt salg og indeholder relevante salgsdata samt relaterer til andre vigtige optegnelser, såsom {{quotes_module}}, {{contacts_module}} osv.
...
2. Klik på "Gem" for at afslutte den nye optegnelse og vende tilbage til den forrige side.',
