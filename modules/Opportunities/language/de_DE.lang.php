...
//END DON'T CONVERT
    ...
    'LBL_MODIFIED_ID' => 'Geändert nach ID',
    ...
    'LBL_EXPORT_MODIFIED_USER_ID' => 'Geändert nach ID',
    'LBL_EXPORT_CREATED_BY' => 'Erstellt nach ID',
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Chancen dieses Quartals',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Meine offenen Geschäftsmöglichkeiten',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Meine offenen Verkaufschancen',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe von Anfang bis Ende verfolgen. Jeder {{module_name}}-Datensatz stellt einen potenziellen Verkauf dar und enthält relevante Verkaufsdaten sowie Informationen zu anderen wichtigen Datensätzen enthält, wie z. B. {{quotes_module}}, {{contacts_module}}etc. Ein {{module_name}} durchläuft in der Regel mehrere Verkaufsphasen, bis es entweder als "Geschlossen, "Gewonnen" oder "Abgeschlossen, Verloren" markiert wird. {{plural_module_name}} kann durch die Verwendung des Moduls {{forecasts_singular_module}} von Sugar weiter genutzt werden, um Verkaufstrends zu verstehen und vorherzusagen sowie die Arbeit zu fokussieren, um Verkaufsquoten zu erreichen.',
...
- Erstellen Sie Benutzerkommentare, zeigen Sie sie an und erfassen Sie den Änderungsverlauf eines Datensatzes im {{activitystream_singular_module}}, indem Sie den unteren linken Bereich auf „Aktivitäten-Stream“ umschalten.
...
- Weitere Aktionen finden Sie im Dropdown-Menü „Aktionen“ rechts neben der Schaltfläche „Bearbeiten“.',
    ...
    'LBL_HELP_CREATE' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe und die zu diesen Verkäufen gehörenden Einzelposten von Anfang bis Ende nachverfolgen. Jeder {{module_name}}-Datensatz steht für einen potenziellen Verkauf und enthält relevante Verkaufsdaten sowie Bezüge zu anderen wichtigen Datensätzen wie {{quotes_module}}, {{contacts_module}} usw.
