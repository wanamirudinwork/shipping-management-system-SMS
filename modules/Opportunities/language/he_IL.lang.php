...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'ההזדמנויות של רבעון זה',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'ההזדמנויות העסקיות הקיימות הפתוחות שלי',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'ההזדמנויות הפתוחות שלי',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות פרטניות מתחילתן עד סופן. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית, וכוללת נתוני מכירה רלוונטיים כמו גם נתונים הנוגעים לרשומות חשובות אחרות, כגון {{quotes_module}},‏ {{contacts_module}} ועוד. בדרך כלל, ההתקדמות של {{module_name}} תעבור כמה &#39;שלבי מכירה&#39;, עד לסימון בתור "נסגר בהצלחה" (Closed Won) או בתור "נסגר בהפסד" (Closed Lost). אפשר למנף מודול 
{{plural_module_name}} עוד יותר באמצעות מודול Sugar למודול {{forecasts_singular_module}}, כדי להבין ולחזות מגמות במכירות וכדי למקד את העבודה בהגשמה של מכסות מכירה.',
...
- אפשר לצפות בקישורים לרשומות נוספות או לשנות אותם בפאנלי המשנה, על-ידי שינוי מצב החלונית בפינה התחתונה ל"תצוגת נתונים".
- אפשר ליצור ולהציג תגובות משתמשים ולתעד את היסטוריית השינויים של אותו מודול {{activitystream_singular_module}} על-ידי שינוי מצב החלונית בפינה התחתונה ל"זרימת פעילות".
- אפשר לעקוב אחר רשומה זו או לסמן אותה כמועדפת באמצעות הסמלים לצד שמה.
