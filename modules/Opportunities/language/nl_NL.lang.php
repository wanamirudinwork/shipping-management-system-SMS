...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Opportunities van dit kwartaal',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mijn openstaande bestaande zakelijke opportunities',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mijn openstaande opportunities',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Met de module {{plural_module_name}} kunt u individuele verkopen van begin tot eind volgen. Elk {{module_name}} record vertegenwoordigt een potentiële verkoop en omvat relevante verkoopgegevens en met betrekking tot andere belangrijke records, zoals {{quotes_module}}, {{contacts_module}}enz. Een {{module_name}} doorloopt doorgaans verschillende verkoopfasen totdat het is gemarkeerd als "Gesloten gewonnen" of "Gesloten verloren". {{plural_module_name}} kan nog verder worden benut door gebruik te maken van Sugar&#39;s {{forecasts_singular_module}}Ing-module om verkooptrends te begrijpen en te voorspellen, en om gericht te werken aan het behalen van verkoopquota.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Met de module {{plural_module_name}} kunt u van begin tot eind de individuele verkoop volgen en de regelitems die bij elke verkoop horen. Elke {{module_name}}-record vertegenwoordigt een mogelijke verkoop en bevat zowel relevante verkoopgegevens als gegevens die betrekking hebben op andere belangrijke records, zoals {{quotes_module}}, {{contacts_module}}, etc.
...
- Meer acties zijn beschikbaar via het vervolgkeuzemenu aan de rechterkant van de knop Bewerken.',
