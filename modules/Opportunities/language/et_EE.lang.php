...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Selle kvartali võimalused',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Minu avatud olemasolevad ärivõimalused',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Minu avatud võimalused',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Moodul {{plural_module_name}} võimaldab teil jälgida individuaalset müüki algusest lõpuni. Iga mooduli {{module_name}} kirje kujutab endast potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning on seotud muude oluliste kirjetega, nagu {{quotes_module}}, {{contacts_module}} jne. {{module_name}} läbib tavaliselt mitu müügietappi, kuni sellele on märgitud kas "Lõpetatud võidetud" või "Lõpetatud kaotatud". Moodulit {{plural_module_name}} saab veelgi rohkem kasutada, kasutades Sugari moodulit {{forecasts_singular_module}}, et mõista ja prognoosida müügitrende ning keskenduda tööle müügikvootide saavutamiseks.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Moodul {{plural_module_name}} võimaldab jälgida algusest lõpuni üksikuid müüke ja nende müükide juurde kuuluvaid reaüksusi. Iga mooduli {{module_name}} kirje tähistab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid ning samuti muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne.
...
- Täiendavad toimingud on saadaval nupust Muuda paremal asuvas rippmenüüs Toimingud.',
    ...
    'LBL_HELP_CREATE' => 'Moodul {{plural_module_name}} võimaldab jälgida algusest lõpuni üksikuid müüke ja nende müükide juurde kuuluvaid reaüksusi. Iga mooduli {{module_name}} kirje tähistab potentsiaalset müüki ja sisaldab asjakohaseid müügiandmeid, samuti muid olulisi kirjeid, nagu {{quotes_module}}, {{contacts_module}} jne.

Mooduli {{module_name}} loomiseks toimige järgmiselt.
1. Sisestage soovitud väljade väärtused.
 - Väljad märgistusega „Kohustuslik“ peavad olema enne salvestamist täidetud.
