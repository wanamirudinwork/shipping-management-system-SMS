...
//END DON'T CONVERT
    ...
    'LNK_IMPORT_OPPORTUNITIES' => 'Importa Opportunità',
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Le opportunità di questo trimestre',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Le mie opportunità di business aperte esistenti',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Le mie opportunità aperte',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Le {{plural_module_name}} consente di monitorare le singole vendite dall&#39;inizio alla fine. Ogni {{module_name}} rappresenta una vendita potenziale e include dati di vendita pertinenti, nonché relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}}, ecc. Un {{module_name}} in genere progredisce attraverso diverse fasi di vendita fino a quando non viene contrassegnato come "Chiuso vinto" o "Chiuso perso". {{plural_module_name}} può essere sfruttato ulteriormente utilizzando il {{forecasts_singular_module}} di Sugar per comprendere e prevedere le tendenze di vendita e concentrare il lavoro per raggiungere le quote di vendita.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Il modulo {{plural_module_name}} consente di monitorare le singole vendite e gli elementi appartenenti a tali vendite dall&#39;inizio alla fine. Ogni record di {{module_name}} rappresenta una potenziale vendita e include i dati di vendita pertinenti, oltre ai dati relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}} ecc.

- Per modificare i campi di questo record fare clic su un singolo campo o sul pulsante Modifica.
- Per visualizzare o modificare i collegamenti ad altri record nei pannelli secondari impostare il riquadro in basso a sinistra su "Visualizzazione dati".
- Per creare e visualizzare i commenti degli utenti e registrare la cronologia delle modifiche in {{activitystream_singular_module}}, impostare il riquadro in basso a sinistra su "Flusso attività".
- Per seguire o aggiungere ai preferiti questo record utilizzare le icone a destra del nome del record.
- Ulteriori azioni sono disponibili nel menu a discesa Azioni posto a destra del pulsante Modifica.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Il modulo {{plural_module_name}} consente di monitorare le singole vendite e gli elementi appartenenti a tali vendite dall&#39;inizio alla fine. Ogni record di {{module_name}} rappresenta una potenziale vendita e include i dati di vendita pertinenti, oltre ai dati relativi ad altri record importanti come {{quotes_module}}, {{contacts_module}} ecc.

Per creare un {{module_name}}:
1. Fornire i valori per i campi come desiderato.
 - Prima del salvataggio compilare i campi contrassegnati con "Richiesto".
 - Fare clic su "Altri dettagli" per visualizzare i campi aggiuntivi, se necessario.
