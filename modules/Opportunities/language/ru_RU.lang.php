...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Сделки этого квартала',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Мои открытые существующие бизнес-сделки',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Мои открытые сделки',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи от начала и до конца. Каждая запись модуля {{module_name}} представляет собой потенциальную продажу и включает в себя соответствующие данные о продаже, а также относится к другим важным записям, таким как {{quotes_module}}, {{contacts_module}} и т.п. Любой модуль {{module_name}} обычно проходит через несколько этапов продаж, пока он не будет помечен как «Закрытая состоявшаяся продажа» или "Закрытая несостоявшаяся продажа». Модуль {{plural_module_name}} может быть использован еще шире за счет использования модуля Sugar {{forecasts_singular_module}} для понимания и прогнозирования тенденций продаж, а также для концентрации работы на достижении квот продаж.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} позволяет отслеживать индивидуальные продажи и продукты, принадлежащие этим продажам, от начала и до конца. Каждая запись {{module_name}} представляет собой ожидаемую продажу и включает в себя соответствующие данные о продаже, а также данные, связанные с другими важными записями, такими как {{quotes_module}}, {{contacts_module}} и т. д.


- Чтобы редактировать поля данной записи, нажмите на это поле или на кнопку «Правка». 
- Чтобы просмотреть или изменить ссылки, ведущие к другим записям, на субпанели переключите левую нижнюю панель в положение «Просмотр данных».
- Чтобы оставлять и просматривать пользовательские комментарии, а также изменять историю модуля {{activitystream_singular_module}}, переключите левую нижнюю панель в состояние «Лента мероприятий».
- Чтобы подписаться или добавить в Избранное данную запись, используйте значки справа от имени записи.
- Дополнительные действия доступны в выпадающем меню «Действия» справа от кнопки «Правка».',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} позволяет отслеживать индивидуальные продажи и принадлежащие им продукты от начала и до конца. Каждая запись {{module_name}} представляет собой ожидаемую продажу и включает в себя соответствующие данные о продаже, а также данные, связанные с другими важными записями, такими как {{quotes_module}}, {{contacts_module}} и т. д.
