...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Dette kvartalets muligheter',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Mine åpne eksisterende forretningsmuligheter',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Mine åpne muligheter',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg fra start til slutt. Hver enkelt {{module_name}} post representerer et potensielt salg og inkluderer relevante salgsdata samt relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}osv. En {{module_name}} vil vanligvis gå gjennom flere salgsfaser til den er merket enten "Lukket vunnet" eller "Lukket tapt". {{plural_module_name}} kan utnyttes ytterligere ved å bruke Sugars {{forecasts_singular_module}}-modul for å forstå og forutsi salgstrender samt fokusere arbeidet for å oppnå salgskvoter.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-modulen lar deg spore individuelle salg og linjeelementene som tilhører disse salgene fra start til slutt. Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevant salgsdata samt relasjoner til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv.

- Rediger feltene i denne posten ved å klikke på et individuelt felt eller redigeringsknappen.
- Vis eller endre lenker til andre poster i underpanelene ved å bytte nederste venstre panel til "Datavisning".
- Lag og vis brukernes kommentarer og endringshistorikk i {{activitystream_singular_module}} ved å bytte nederste venstre panel til "Aktivitetsstrøm".
- Følg eller favoriser denne posten ved å bruke ikonene til høyre for postenavnet.
- Ytterligere handlinger er tilgjengelige i rullegardinmenyen "Handlinger" til høyre for redigeringsknappen.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} lar deg spore individuelle salg og linjeelementene som tilhører disse salgene fra start til slutt. Hver {{module_name}}-post representerer et potensielt salg og inkluderer relevante salgsdata samt relatert til andre viktige poster som {{quotes_module}}, {{contacts_module}}, osv.

For å opprette en {{module_name}}:
1. Oppgi verdier for feltene etter behov.
 - Felt merket "Påkrevd" må fullføres før lagring.
 - Klikk på "Vis mer" for å vise flere felt om nødvendig.
2. Klikk på "Lagre" for å fullføre den nye posten og gå tilbake til den forrige siden.',
