...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => '今四半期の機会',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => '自分のオープンな既存のビジネス機会',
    'LBL_MY_OPEN_OPPORTUNITIES' => '自分のオープンな機会',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} モジュールを使用すると、個々の売上を最初から最後まで追跡できます。各 {{module_name}} レコードは将来の販売を表し、関連する販売データだけでなく、{{quotes_module}}、{{contacts_module}} 等のような他の重要なレコードに関連するものが含まれます。ひとつの {{module_name}} は通常、「Closed Won」または「Closed Lost」のいずれかのマークが付けられるまで、いくつかのセールスステージを通過します。 {{plural_module_name}} は、Sugar の {{forecasts_singular_module}} をするモジュールを使用して販売傾向を理解および予測し、販売ノルマを達成するための作業に集中します。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} モジュールにより、個々の商談とそれらの商談に属している商談品目を最初から最後まで追跡できます。各 {{module_name}} レコードは商談見込みを表し、関連する商談データだけではなく {{quotes_module}}、{{contacts_module}} などの他の重要なレコードに関連している商談データも含まれます。
...
・[編集]ボタンの右側にあるドロップダウンの[アクション]メニューから、追加のアクションが利用できます。',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}} モジュールにより、個々の商談とそれらの商談に属している商談品目を最初から最後まで追跡できます。各 {{module_name}} レコードは商談見込みを表し、関連する商談データだけでなく {{quotes_module}}、{{contacts_module}} などの他の重要なレコードに関連している商談データも含まれます。
