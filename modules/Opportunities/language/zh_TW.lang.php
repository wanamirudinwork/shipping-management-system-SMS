...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => '本季的商機',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => '我的開放現有商機',
    'LBL_MY_OPEN_OPPORTUNITIES' => '我的開放商機',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} 模組允許您全程追蹤個別銷售。每項 {{module_name}} 記錄代表一個潛在銷售，並且包括相關的銷售資料並關聯至 {{quotes_module}}、{{contacts_module}} 等其他重要記錄。{{module_name}} 通常會經過幾個銷售階段，直到其被標記為「已結束並贏得客戶」或「已結束但客戶流失」。透過使用 Sugar 的 {{forecasts_singular_module}}ing 模組，可以進一步利用 {{plural_module_name}} ，瞭解和預測銷售趨勢，以及集中精力實現銷售配額。',
