...
//END DON'T CONVERT
    ...
    'LBL_THIS_QUARTER_OPPORTUNITIES' => 'Οι Ευκαιρίες αυτού του τριμήνου',
    'LBL_MY_OPEN_EXISTING_BUSINESS' => 'Οι Ανοικτές Υπάρχουσες Επιχειρηματικές Ευκαιρίες Μου',
    'LBL_MY_OPEN_OPPORTUNITIES' => 'Οι Ανοικτές Ευκαιρίες Μου',
...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η ενότητα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αναπαριστά μια δυνητική πώληση και περιλαμβάνει σχετικά δεδομένα πωλήσεων, καθώς και δεδομένα που σχετίζονται με άλλες σημαντικές εγγραφές όπως οι {{quotes_module}}, {{contacts_module}}, κ.λπ. Μια ενότητα {{module_name}} θα περάσει τυπικά από αρκετά Στάδια πωλήσεων μέχρι να επισημανθεί είτε ως "Κλειστή κερδισμένη" ή ως "Κλειστή χαμένη". Η ενότητα {{plural_module_name}} μπορεί να αξιοποιηθεί ακόμα περισσότερο με χρήση της ενότητας {{forecasts_singular_module}} του Sugar για την κατανόηση και πρόβλεψη τάσεων πωλήσεων, καθώς και την εστίαση των εργασιών για την επίτευξη ποσοστών πωλήσεων.',
...
- Επεξεργαστείτε τα πεδία αυτής της εγγραφής κάνοντας κλικ σε ένα μεμονωμένο πεδίο ή στο κουμπί Επεξεργασία.
- Δείτε ή τροποποιήστε συνδέσμους προς άλλες εγγραφές στους υποπίνακες με εναλλαγή του παραθύρου κάτω αριστερά σε "Προβολή δεδομένων".
- Κάντε και δείτε σχόλια χρήστη και το ιστορικό αλλαγών των εγγραφών στην ενότητα {{activitystream_singular_module}} με εναλλαγή του πίνακα κάτω αριστερά σε "Ροή δραστηριότητας".
- Ακολουθήστε αυτή την εγγραφή ή προσθέστε τη στα αγαπημένα με τα εικονίδια στα δεξιά του ονόματος της εγγραφής.
...
Για τη δημιουργία μιας ενότητας {{module_name}}:
1. Παρέχετε τιμές για τα πεδία όπως επιθυμείτε.
 - Τα πεδία με την επισήμανση "Υποχρεωτικό" πρέπει να συμπληρωθούν πριν από την αποθήκευση.
 - Κάντε κλικ στην επιλογή "Εμφάνιση περισσότερων" για έκθεση περισσότερων πεδίων αν χρειάζεται.
