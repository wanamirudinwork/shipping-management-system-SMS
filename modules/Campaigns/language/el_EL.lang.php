...
$mod_strings = [
    ...
    //Market
    'LBL_POSTDATE' => 'Ημερομηνία Αποστολής',
    'LBL_SENT' => 'Εστάλη',
    'LBL_DELIVERED' => 'Παραδόθηκε',
    'LBL_TOTALOPENS' => 'Συνολικά Ανοίγματα',
    'LBL_TOTALCLICKS' => 'Συνολικά Κλικ',
    'LBL_PEOPLEWHOOPENED' => 'Άτομα που άνοιξαν',
    'LBL_PEOPLEWHOCLICKED' => 'Άτομα που έκαναν κλικ',
    'LBL_UNOPENED' => 'Κλειστά',
    'LBL_BOUNCED' => 'Ανεπίδοτα',
    'LBL_UNSUBSCRIBED' => 'Κατάργηση εγγραφής',
    'LBL_NOTREPORTED' => 'Δεν αναφέρθηκαν',
    'LBL_SOCIAL' => 'Κοινωνικό',
    'LBL_FORWARDS' => 'Προωθήσεις',
];
