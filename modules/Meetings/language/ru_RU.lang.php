...
$mod_strings = [
    ...
    'LBL_DATE_RECURRENCE_MODIFIED' => 'Дата изменения повторения',
    'LBL_SERIES_DELETED' => 'Серия удалена',
    ...
    'LBL_PURCHASEDLINEITEMS' => 'Приобретенные позиции каталога продуктов',
...
3. Нажмите "Сохранить", чтобы завершить создание новой записи и вернуться на предыдущую страницу.',
    ...
    'LBL_MEETINGS_TRANSCRIPTS_FROM_TRANSCRIPTS_TITLE' => 'Стенограммы',
    'LBL_MEETINGS_TRANSCRIPTS_FROM_MEETINGS_TITLE' => 'Стенограммы',
];
