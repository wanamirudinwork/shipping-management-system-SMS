...
$mod_strings = [
    ...
    'LBL_DATE_RECURRENCE_MODIFIED' => 'Дата на повторна промяна',
    'LBL_SERIES_DELETED' => 'Серията е изтрита',
    ...
    'LBL_PURCHASEDLINEITEMS' => 'Закупени редови позиции',
...
3. Натиснете "Съхрани", за да запазите новия запис и да се върнете на предишната страница.',
    ...
    'LBL_MEETINGS_TRANSCRIPTS_FROM_TRANSCRIPTS_TITLE' => 'Преписи',
    'LBL_MEETINGS_TRANSCRIPTS_FROM_MEETINGS_TITLE' => 'Преписи',
];
