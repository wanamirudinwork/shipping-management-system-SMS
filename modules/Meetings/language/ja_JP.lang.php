...
$mod_strings = [
    ...
    'LBL_DATE_RECURRENCE_MODIFIED' => '繰り返し変更日',
    'LBL_SERIES_DELETED' => '削除されたシリーズ',
...
3. 新しいレコードを確定し、前のページに戻るには「保存」をクリックします。',
    ...
    'LBL_MEETINGS_TRANSCRIPTS_FROM_TRANSCRIPTS_TITLE' => 'トランスクリプト',
    'LBL_MEETINGS_TRANSCRIPTS_FROM_MEETINGS_TITLE' => 'トランスクリプト',
];
