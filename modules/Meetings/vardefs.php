...
$dictionary['Meeting'] = [
    ...
    'fields' => [
        ...
        'repeat_count' => [
            ...
            'repeat_month' => [
                'name' => 'repeat_month',
                'vname' => 'LBL_CALENDAR_REPEAT_MONTH',
                'type' => 'enum',
        ...
        'original_start_date' => [
            ...
            'series_deleted' => [
            'name' => 'series_deleted',
            'vname' => 'LBL_SERIES_DELETED',
            'default' => 0,
            'type' => 'bool',
            'comment' => 'Whether the bean has been deleted via a series delete or not',
            'studio' => false,
            'reportable' => false,
            'hideacl' => true,
            ],
