...
class HealthCheckScannerMeta
{
    ...
    protected $meta = [
        ...
        588 => [
            'report' => 'maximumPathLengthLimitation',
            'bucket' => self::MANUAL,
            //@codingStandardsIgnoreStart
            'kb' => 'https://support.sugarcrm.com/Knowledge_Base/Installation_Upgrade/Troubleshooting_Health_Check_Output/Health_Check_Error_File_System_Maximum_Path_Length_Exceeded',
            //@codingStandardsIgnoreEnd
        ],
        // Bucket G
        901 => [
