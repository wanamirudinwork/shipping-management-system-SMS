...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => 'Encontrado smarty4ModifierDeprecation, este modificador foi preterido e será removido',
    ...
    'LBL_SCAN_441_LOG' => 'Alteração de tipo em %s para o campo %s: de %s para %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => 'Alteração de tipo em %s para o campo %s: de %s para %s',
    ...
    'LBL_SCAN_563_TITLE' => 'Utilização de personalização Monolog incompatível',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => 'O tipo de campo que não é blob é alterado para o tipo de campo blob. Isto não é permitido porque os tipos blob não podem ser indexados e podemos ter filtros que dependem da indexação deste campo.',
