...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => '发现 smarty4ModifierDeprecation，此修饰符已弃用且将被删除',
    ...
    'LBL_SCAN_441_LOG' => '%s（用于字段 %s%）中的类型从 %s 更改为 %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => '%s（用于字段 %s%）中的类型从 %s 更改为 %s',
    ...
    'LBL_SCAN_563_TITLE' => '使用不兼容的 Monolog 自定义',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => '非 blob 字段类型被更改为 blob 字段类型。这是不允许的，因为 blob 类型无法被索引，而我们可能依赖于该字段被索引来进行筛选。',
