...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => 'Намерен smarty4ModifierОтхвърляне, този модификатор е отхвърлен и ще бъде премахнат',
    ...
    'LBL_SCAN_441_LOG' => 'Промяна на типа в %s за полето %s:от %s да %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => 'Промяна на типа в %s за полето %s:от %s да %s',
    ...
    'LBL_SCAN_563_TITLE' => 'Използване на несъвместимо персонализиране на монолог',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => 'Типът поле, което не е BLOB, се променя на тип поле BLOB. Това не е позволено, тъй като типовете blob не могат да бъдат индексирани и може да имаме филтри, които разчитат на това поле да бъде индексирано.',
