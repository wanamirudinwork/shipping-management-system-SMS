...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => 'Hittade smarty4ModifierDeprecation, den här modifieraren är föråldrad och kommer att tas bort',
    ...
    'LBL_SCAN_441_LOG' => 'Ändring av typ i %s för fält %s: från %s till %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => 'Ändring av typ i %s för fält %s: från %s till %s',
    ...
    'LBL_SCAN_563_TITLE' => 'Användning av inkompatibel monolog-anpassning',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => 'Icke-blobfälttypen ändras till blobfälttypen. Detta är inte tillåtet eftersom blobtyper inte kan indexeras och vi kan ha filter som förlitar sig på att det här fältet indexeras.',
