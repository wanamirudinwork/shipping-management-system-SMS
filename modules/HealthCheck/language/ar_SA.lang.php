...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => 'تم العثور على smarty4ModifierDeprecation، تم إهمال هذا المعدل وسيتم إزالته',
    ...
    'LBL_SCAN_441_LOG' => 'تغيير النوع في %s للحقل %s: من %s إلى %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => 'تغيير النوع في %s للحقل %s: من %s إلى %s',
    ...
    'LBL_SCAN_563_TITLE' => 'استخدام تخصيص Monolog غير متوافق',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => 'تم تغيير نوع الحقل غير الكائن الثنائي كبير الحجم إلى نوع حقل كائن ثنائي كبير الحجم. هذا غير مسموح به لأنه لا يمكن فهرسة أنواع الكائنات الثنائية كبيرة الحجم وقد يكون لدينا عوامل تصفية تعتمد على فهرسة هذا الحقل.',
