...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_440_LOG' => 'smarty4ModifierDeprecation이 발견되면 이 수정자는 더 이상 사용되지 않으며 제거됩니다',
    ...
    'LBL_SCAN_441_LOG' => '필드 %s에 대해 %s에서 변경 사항 입력: 보낸 사람 %s 받는 사람 %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_441_TITLE' => '필드 %s에 대해 %s에서 변경 사항 입력: 보낸 사람 %s 받는 사람 %s',
    ...
    'LBL_SCAN_563_TITLE' => '호환되지 않는 Monolog 사용자 지정 사용',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_441_DESCR' => 'Blob이 아닌 필드 유형이 Blob 필드 유형으로 변경됩니다. Blob 형식을 인덱싱할 수 없고 인덱싱되는 이 필드에 의존하는 필터가 있을 수 있으므로 이는 허용되지 않습니다.',
