...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
    ...
    // Market
    'LBL_SF_WEBACTIVITY_CONTACTS_FROM_SF_WEBACTIVITY_TITLE' => 'Δραστηριότητα Ιστού',
    'LBL_SF_WEB_ACTIVITY_CONTACTS_FROM_SF_WEB_ACTIVITY_TITLE' => 'Δραστηριότητα Ιστού',
    'LBL_SF_DIALOGS_CONTACTS_FROM_SF_DIALOGS_TITLE' => 'Σελίδες Προορισμού',
    'LBL_SF_EVENTMANAGEMENT_CONTACTS_FROM_SF_EVENTMANAGEMENT_TITLE' => 'Διαχείριση Εκδηλώσεων',
    'LBL_SF_EVENTMANAGEMENT_CONTACTS_FROM_CONTACTS_TITLE' => 'Διαχείριση Εκδηλώσεων',
