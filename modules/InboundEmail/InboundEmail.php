...
eoq;
    ...
    /**
     * Creates, configures, and tests settings of a new ImapMailer object for
     * use with the given Mailbox. Returns the ImapMailer if the settings are
     * valid
     *
    ...
    {
        try {
            $mailer = $this->createImapMailer($mailbox);
            $mailer->setTrashFolder($this->get_stored_options('trashFolder'));
    ...
    /**
     * Builds an ImapMailer with the given Mailbox settings
     *
     * @param Mailbox $mailbox the Mailbox containing settings for the external mailbox
     * @return ImapMailer a new ImapMailer based on the given Mailbox
     */
    protected function createImapMailer(Mailbox $mailbox)
    {
        return new ImapMailer($mailbox, $this->email_user, $this->email_password, $this->eapm_id);
    }
