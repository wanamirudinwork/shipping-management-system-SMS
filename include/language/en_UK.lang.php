...
// Omnichannel
    ...
    'LBL_ACTIVITY_STATUS_READ_ONLY' => 'This action cannot be completed. The Status field for these activities&#39; module is set to "read only", preventing any Smart Guide actions that update the Status field.',
    'LBL_CHILD_ACTIVITY_STATUS_READ_ONLY' => 'This action cannot be completed. The Status field for these activities&#39; and or sub-activities&#39; modules are set to "read only", preventing any Smart Guide actions that update the Status field.',
    'LBL_GUIDE_CANCELLATION_ACTION_ACTIVITY_STATUS_READ_ONLY' => 'The Status field for some activities&#39; modules in the guide are set to "read only", these activities will remain unaltered on guide cancellation.',
