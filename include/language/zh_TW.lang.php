...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-landing-pages-xl' => '著陸頁 Xl',
        'sicon-web-xl' => '網路活動 Xl',
        'sicon-web-activity-detail-xl' => '網路活動詳細資訊 Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'SugarCRM、Sugar 和 3-D 立方體是 SugarCRM Inc. 的註冊商標。 ' .
        ...
        'SugarCRM ® 、Sugar Enterprise™ 和 Sugar™ 是 SugarCRM Inc. 的商標。',
    ...
    'LBL_EMAIL_CONNECTING' => '正在連接……',
    'LBL_EMAIL_NOT_AUTHORIZED' => '未授權',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => '您為正在使用的郵件帳戶選取的外寄郵件伺服器無效，請檢查設定。',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => '大規模更新',
...
執行此操作會立即使您註銷，下次登錄時您將需要使用驗證器應用驗證身份。',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => '結果集中有 1 項記錄。',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => '結果集中有 {{num}} 項記錄。',
...
「5. 在應用程式的動作菜單中按一下「匯入」選項，並選取文件上載」   ',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => '無法刪除資料夾。',
    'LBL_RECENTLY_RESOLVED_ISSUES' => '最近已解決',
    'LBL_OPEN_ISSUES' => '開啟 {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => '您的離線儲存體空間不足。將執行儲存體清理。這可能需要幾分鐘時間。',
    ...
    'LBL_VO_ADD_BTN' => '添加按鈕',
    'LBL_DASHBOARDS_CHANGED_ALERT' => '您的儀表板設定已變更，將自動重新整理儀表板',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => '商機記錄應至少有一個營收項目。',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => '是否要啟用進階記錄模式？',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => '已啟用進階記錄模式。',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => '進階記錄',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => '訓練和憑證',
    'LBL_WIZ_DOCUMENTATION' => '文件',
    'LBL_WIZ_KNOWLEDGE_BASE' => '說明文章',
    'LBL_WIZ_FORUMS' => 'SugarClub 社群',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => '顯示 Sugar Discover 報告。',
...
如需使用您已經輸入的值建立新記錄，請按一下螢幕右上角的「忽略重複並儲存」。',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => '行事曆',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => '載入預覽時發生錯誤。請再試一次。',
    ...
    'LBL_AI_OPP_WON_SCORE' => '贏得客戶預測分數',
    'LBL_AI_LEAD_CONV_SCORE' => '轉化預測分數',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => '使用 DocuSign 傳送文件並追蹤狀態。',
    // Base sales stages
    'LBL_OPEN' => '打開',
    ...
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => '授權無效',
    ...
    'LBL_LOGIN_SUGAR_BTN' => '使用 Sugar 認證登入',
    'LBL_DRI_STAGES' => '階段',
    'LBL_DRI_NO_SMART_GUIDES' => '未找到 {{{filterName}}}',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide 沒有階段',
    'LBL_DRI_START_SMART_GUIDE' => '開始 Smart Guide',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => '想要為此 {{{moduleName}}} 啟動 {{{templateName}}} 嗎？',
    'LBL_DRI_ACTIVE_GUIDES' => '作用中的 Smart Guide',
    'LBL_DRI_ARCHIVED_GUIDES' => '已封存的 Smart Guide',
    'LBL_VIEW_ATTACHMENTS' => '檢視附件',
    'LBL_VIEW_FILES' => '檢視檔案',
...
// Market
$app_strings['LBL_ATTENDED'] = '已參加';
$app_strings['LBL_REGISTERED'] = '已註冊';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = '在 Sugar Market 中檢視';
