...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'หน้า Landing Page',
        'sf_EventManagement' => 'การจัดการเหตุการณ์',
        'sf_webActivity' => 'กิจกรรมบนเว็บ',
        'sf_WebActivityDetail' => 'รายละเอียดกิจกรรมบนเว็บ',
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-event-mgmt-xl' => 'การจัดการเหตุการณ์ Xl',
        'sicon-landing-pages-xl' => 'หน้า Landing Page Xl',
        'sicon-web-xl' => 'กิจกรรมบนเว็บ Xl',
        'sicon-web-activity-detail-xl' => 'รายละเอียดกิจกรรมบนเว็บ Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'SugarCRM, Sugar และลูกบาศก์ 3-D เป็นเครื่องหมายการค้าจดทะเบียนของ SugarCRM Inc. ' .
        ...
        'SugarCRM ®, Sugar Enterprise™ และ Sugar™ เป็นเครื่องหมายทางการค้าของ SugarCRM Inc.',
    ...
    'LBL_EMAIL_CONNECTING' => 'กำลังเชื่อมต่อ...',
    'LBL_EMAIL_NOT_AUTHORIZED' => 'ไม่อนุญาต',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'เซิร์ฟเวอร์อีเมลขาออกที่เลือกสําหรับบัญชีอีเมลที่คุณใช้ไม่ถูกต้อง โปรดตรวจสอบการตั้งค่า',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => 'การอัปเดตครั้งใหญ่',
    ...
    'LBL_SEARCH' => 'ค้นหา',
    'LBL_SEARCH_SUGAR' => 'ค้นหา Sugar&#8230; ทั้งหมด',
...
การกระทำนี้จะพาคุณออกจากระบบทันที และคุณจะต้องยืนยันตนโดยใช้แอปยืนยันตนในการเข้าระบบครั้งต่อไป',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => 'มีระเบียน 1 อันในชุดผลลัพธ์',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => 'มีระเบียน {{num}} อันในชุดผลลัพธ์',
...
"5. คลิกตัวเลือกนำเข้าจากเมนูการดำเนินการในแอปพลิเคชัน และเลือกไฟล์นี้เพื่ออัปโหลด"
   ',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'ไม่สามารถลบโฟลเดอร์ได้',
    'LBL_RECENTLY_RESOLVED_ISSUES' => 'แก้ไขแล้วเมื่อเร็วๆ นี้',
    'LBL_OPEN_ISSUES' => 'เปิด {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'คุณมีพื้นที่ไม่เพียงพอสำหรับการเก็บข้อมูลออฟไลน์ ระบบจะล้างข้อมูลในพื้นที่เก็บข้อมูล ขั้นตอนนี้อาจใช้เวลานานหลายนาที',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'การกําหนดค่าแดชบอร์ดของคุณมีการเปลี่ยนแปลง และแดชบอร์ดจะได้รับการรีเฟรชโดยอัตโนมัติ',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'ระเบียนโอกาสควรมีรายการบรรทัดรายได้อย่างน้อยหนึ่งรายการ',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => 'คุณต้องการเปิดใช้งานโหมดการบันทึกขั้นสูงหรือไม่',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => 'เปิดใช้งานโหมดการบันทึกขั้นสูงแล้ว',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => 'การบันทึกขั้นสูง',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'การอบรมและใบรับรอง',
    'LBL_WIZ_DOCUMENTATION' => 'เอกสารประกอบ',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'บทความที่เป็นประโยชน์',
    'LBL_WIZ_FORUMS' => 'ชุมชน SugarClub',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'แสดงรายงาน Sugar Discover',
...
ในการสร้างระเบียนใหม่โดยใช้ค่าที่คุณป้อนไว้ ให้คลิก "ไม่สนใจรายการซ้ำและบันทึก" ที่ด้านขวาบนของหน้าจอ',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'ปฏิทิน',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'เกิดข้อผิดพลาดขณะโหลดตัวอย่าง โปรดลองอีกครั้ง',
    ...
    'LBL_AI_OPP_WON_SCORE' => 'ชนะคะแนนพยากรณ์',
    'LBL_AI_LEAD_CONV_SCORE' => 'อัตราการแปลงคะแนนพยากรณ์',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'ส่งเอกสารด้วย DocuSign และติดตามสถานะ',
    // Base sales stages
    'LBL_OPEN' => 'เปิด',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'ความคืบหน้า Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'แสดงแผนภูมิวงกลม Sugar Automate "Smart Guide ความคืบหน้า"',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'เข้าสู่ระบบด้วยข้อมูลเข้าระบบของ Sugar',
    'LBL_DRI_STAGES' => 'ขั้นตอน',
    'LBL_DRI_NO_SMART_GUIDES' => 'ไม่พบ {{{filterName}}}',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide ไม่มีขั้นตอน',
    'LBL_DRI_START_SMART_GUIDE' => 'เริ่มต้น Smart Guide',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'คุณต้องการเริ่มต้น {{{templateName}}} สำหรับ {{{moduleName}}} นี้หรือไม่',
    'LBL_DRI_ACTIVE_GUIDES' => 'Smart Guides ที่ใช้งานอยู่',
    'LBL_DRI_ARCHIVED_GUIDES' => 'Smart Guide ที่จัดเก็บถาวร',
    'LBL_VIEW_ATTACHMENTS' => 'ดูไฟล์แนบ',
    'LBL_VIEW_FILES' => 'ดูไฟล์',
...
$app_list_strings['sales_stage_classification_dom'] = [
    ['เปิด', 'เปิด'],
    ['ปิดโดยได้รับการขาย', 'ปิดโดยได้รับการขาย'],
    ['ปิดโดยไม่ได้รับการขาย', 'ปิดโดยไม่ได้รับการขาย'],
];

// Market
$app_strings['LBL_ATTENDED'] = 'เข้าร่วมแล้ว';
$app_strings['LBL_REGISTERED'] = 'ลงทะเบียนแล้ว';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'ดูใน Sugar Market';
