...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'Açılış Sayfaları',
        'sf_EventManagement' => 'Etkinlik Yönetimi',
        'sf_webActivity' => 'Web Etkinliği',
        'sf_WebActivityDetail' => 'Web Etkinliği Detayı',
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-event-mgmt-xl' => 'Etkinlik Yönetimi Xl',
        'sicon-landing-pages-xl' => 'Açılış Sayfaları Xl',
        'sicon-web-xl' => 'Web Etkinliği Xl',
        'sicon-web-activity-detail-xl' => 'Web Etkinliği Ayrıntıları Detayları Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'SugarCRM, Sugar ve 3-D Küp, SugarCRM Inc.&#39;in tescilli ticari markalarıdır. ' .
        ...
        'SugarCRM ®, Sugar Enterprise™ ve Sugar™, SugarCRM Inc&#39;in ticari markalarıdır.',
    'LBL_TRADEMARK2' => 'SugarCRM ®, Sugar Enterprise™ ve Sugar,™ SugarCRM Inc.&#39;in ticari markalarıdır.',
    ...
    'LBL_EMAIL_CONNECTING' => 'Bağlanıyor...',
    'LBL_EMAIL_NOT_AUTHORIZED' => 'Yetkilendirilmedi',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'Kullanmakta olduğunuz posta hesabı için seçilen giden posta sunucusu geçersiz, lütfen ayarı kontrol edin.',
  ...
  Lütfen değerleri değiştiriniz.',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => 'Toplu güncelleme',
    ...
    'LBL_SEARCH' => 'Ara',
    'LBL_SEARCH_SUGAR' => 'Tüm Sugar&#8230;&#39;da arayın',
...
Bu işlemi gerçekleştirmek anında oturumunuzu kapatacak ve bir dahaki oturum açmanızda kimlik doğrulama uygulamasını kullanarak kimlik doğrulama yapmanız gerekecek.',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => 'Sonuç setinde 1 kayıt bulunmaktadır.',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => 'Sonuç setinde {{num}} sonuç bulunmaktadır.',
    ...
    'LBL_RELATED_RECORDS' => 'İlgili {{module}}',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'Klasör silinemez.',
    'LBL_RECENTLY_RESOLVED_ISSUES' => 'Yakın Zamanda Çözüldü',
    'LBL_OPEN_ISSUES' => '{{module}} modülünü açın',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'Pano yapılandırmanız değişti, pano otomatik olarak yenilenecek',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'Fırsat kaydında en az bir Gelir Kalemi bulunmalıdır.',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => 'Gelişmiş günlük kaydı modunu etkinleştirmek istiyor musunuz?',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => 'Gelişmiş günlük kaydı modu etkinleştirildi.',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => 'Gelişmiş Günlük Kaydı',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'Eğitim ve Sertifikasyon',
    'LBL_WIZ_DOCUMENTATION' => 'Dokümantasyon',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'Yardım Makaleleri',
    'LBL_WIZ_FORUMS' => 'SugarClub Topluluğu',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'Sugar Discover raporunu görüntüler.',
...
2. Yeni kaydı tamamlamak ve {{plural_module_name}} liste görünümüne dönmek için "Kaydet" tuşuna basın.',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'Takvim',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'Önizleme yüklenirken bir hata oluştu. Lütfen tekrar deneyin.',
    ...
    'LBL_AI_OPP_WON_SCORE' => 'Kazanç Tahmini Puanı',
    'LBL_AI_LEAD_CONV_SCORE' => 'Dönüşüm Tahmini Puanı',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'DocuSign kullanarak belge gönderin ve durumu takip edin.',
    // Base sales stages
    'LBL_OPEN' => 'Aç',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'Sugar kimlik bilgileriyle giriş yapın',
    'LBL_DRI_STAGES' => 'Aşamalar',
    'LBL_DRI_NO_SMART_GUIDES' => '{{{filterName}}} bulunamadı',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide aşamaları yok',
    'LBL_DRI_START_SMART_GUIDE' => 'Smart Guide Başlat',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'Bu {{{moduleName}}} için {{{templateName}}} başlatmak istiyor musunuz?',
    'LBL_DRI_ACTIVE_GUIDES' => 'Etkin Smart Guide&#39;ler',
    'LBL_DRI_ARCHIVED_GUIDES' => 'Arşivlenen Smart Guide&#39;ler',
    'LBL_VIEW_ATTACHMENTS' => 'Ekleri Görüntüleyin',
    'LBL_VIEW_FILES' => 'Dosyaları Görüntüleyin',
...
$app_list_strings['sales_stage_classification_dom'] = [
    ['Açık', 'Aç'],
    ['Kapalı Kazandı', 'Başarıyla Kapandı'],
    ['Başarısızlıkla Kapandı', 'Başarısızlıkla Kapandı'],
];

// Market
$app_strings['LBL_ATTENDED'] = 'Katıldı';
$app_strings['LBL_REGISTERED'] = 'Kaydedildi';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'Sugar Markette Görüntüle';
