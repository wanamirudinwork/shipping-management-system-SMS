...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'Целевые страницы',
        'sf_EventManagement' => 'Управление событиями',
        'sf_webActivity' => 'Веб-мероприятие',
        'sf_WebActivityDetail' => 'Сведения о веб-активности',
    ...
    'moduleListSingular' => [
        ...
        'sf_Dialogs' => 'Целевая страница',
        'sf_EventManagement' => 'Управление событиями',
        'sf_webActivity' => 'Веб-активность',
        'sf_WebActivityDetail' => 'Сведения о веб-активности',
        'Transcripts' => 'Стенограмма',
    ],
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-event-mgmt-xl' => 'Управление событиями Xl',
        'sicon-landing-pages-xl' => 'Целевые страницы Xl',
        'sicon-web-xl' => 'Веб-активность Xl',
        'sicon-web-activity-detail-xl' => 'Сведения о веб-активности Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'SugarCRM, Sugar и 3-D куб являются зарегистрированными торговыми марками компании SugarCRM Inc. ' .
        ...
        'SugarCRM ®, Sugar Enterprise™ и Sugar™ являются торговыми марками SugarCRM Inc.',
    'LBL_TRADEMARK2' => 'SugarCRM®, Sugar Enterprise™ и Sugar™ являются товарными знаками SugarCRM Inc.',
    ...
    'LBL_EMAIL_CONNECTING' => 'Идет соединение...',
    'LBL_EMAIL_NOT_AUTHORIZED' => 'Не авторизовано',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'Сервер исходящей почты, выбранный для используемой вам учетной записи почты, недействителен. Проверьте настройки.',
 ...
 Пожалуйста, измените значения.',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => 'Групповое обновление',
    ...
    'LBL_SEARCH' => 'Поиск',
    'LBL_SEARCH_SUGAR' => 'Поиск по всему Sugar&#8230;',
...
Выполнение этого действия приведет к немедленному выходу из системы, и вам нужно будет пройти проверку подлинности с помощью приложения для проверки подлинности при следующем входе в систему.',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => 'В наборе результатов имеется 1 запись.',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => 'Число записей в наборе результатов: {{num}}.',
    ...
    'LBL_TABBED_DASHLET_MODULES_UNAVAILABLE' => 'Данные отсутствуют. У вас нет разрешения на доступ к этим модулям.' .
    " \nПожалуйста, обновите или удалите этот дашлет.",
    ...
    'LBL_ALT_NOT_SORTED' => 'Не отсортировано',
    'LBL_ALT_SORT_DESC' => 'Нисходящая сортировка',
    'LBL_ALT_SORT_ASC' => 'Нисходящая сортировка',
    'LBL_ALT_SORTABLE' => 'Сортируется',
    'LBL_ALT_NOT_SORTABLE' => 'Не сортируется',
    ...
    'LBL_CONFIRMATION_POPUP' => 'Всплывающее окно подтверждения',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'Невозможно удалить папку.',
    'LBL_RECENTLY_RESOLVED_ISSUES' => 'Недавно решено',
    'LBL_OPEN_ISSUES' => 'Открытый {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Недостаточно свободного места для автономного хранилища. Будет выполнена очистка хранилища. Это может занять несколько минут.',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'Конфигурация информационной панели изменилась, будет произведено автоматическое обновление этой панели.',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'Запись возможной сделки должна содержать по крайней мере одну статью дохода.',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => 'Включить расширенный режим ведения журнала?',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => 'Включен расширенный режим ведения журнала.',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => 'Расширенное ведение журнала',
    ...
    //14.0 Dashboards
    'LBL_BDR_CONSOLE' => 'Информационная панель BDR',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'Обучение и сертификация',
    'LBL_WIZ_DOCUMENTATION' => 'Документация',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'Статьи справки',
    'LBL_WIZ_FORUMS' => 'Сообщество SugarClub',
    ...
    'LBL_SUGAR_APPS_DASHLET_DESC' => 'Позволяет пользователям добавлять приложения Sugar на информационную панель',
    ...
    // Sugar Discover
    'LBL_SUGAR_DISCOVER_DASHLET' => 'Знакомство с Sugar',
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'Отображает отчет о знакомстве с Sugar.',
...
Чтобы создать новую запись, используя значения, недавно внесенные, нажмите "Игнорировать копии и сохранить" в верхнем правом углу экрана.',
    ...
    'LBL_CALENDAR_REPEAT_MONTH' => 'Месяц(ы) года',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'Календарь',
    ...
    'LBL_PMSE_ACTIVITY_CHANGE_FIELD_WARNING' => 'Следующие поля раскрывающегося списка содержат недопустимые параметры',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'При загрузке предварительного просмотра произошла ошибка. Повторите попытку.',
    ...
    'LBL_AI_OPP_WON_SCORE' => 'Оценка прогноза успешных сделок',
    'LBL_AI_LEAD_CONV_SCORE' => 'Оценка прогноза конверсии',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'Отправляйте документы с помощью DocuSign и отслеживайте их статус.',
    // Base sales stages
    'LBL_OPEN' => 'Открыто',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Отображает круговую диаграмму «Ход выполнения умного руководства» Sugar Automate.',
    ...
    'LBL_ACTIVITY_STATUS_READ_ONLY' => 'Это действие не может быть завершено. В поле «Статус» для модуля этого мероприятия установлено значение «только для чтения», что предотвращает любые действия Smart Guide, которые обновляют поле «Статус».',
    'LBL_CHILD_ACTIVITY_STATUS_READ_ONLY' => 'Это действие не может быть завершено. В поле «Статус» для модулей этого мероприятия или подчиненного мероприятия установлено значение «только для чтения», что предотвращает любые действия Smart Guide, которые обновляют поле «Статус».',
    'LBL_GUIDE_CANCELLATION_ACTION_ACTIVITY_STATUS_READ_ONLY' => 'В поле «Статус» для модулей некоторых мероприятий в этом руководстве установлено значение «только для чтения», и эти мероприятия останутся без изменений при отмене руководства.',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'Войти с учетными данными Sugar',
    'LBL_DRI_STAGES' => 'Стадии',
    'LBL_DRI_NO_SMART_GUIDES' => '{{{filterName}}} не найдено',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Отсутствуют стадии в умном руководстве',
    'LBL_DRI_START_SMART_GUIDE' => 'Запустить умное руководство',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'Хотите начать использование шаблона «{{{templateName}}}» для этого модуля «{{{moduleName}}}»?',
    'LBL_DRI_ACTIVE_GUIDES' => 'Активные умные руководства',
    'LBL_DRI_ARCHIVED_GUIDES' => 'Архивные умные руководства',
    'LBL_VIEW_ATTACHMENTS' => 'Показать вложения',
    'LBL_VIEW_FILES' => 'Показать файлы',
...
$app_strings['LBL_SHARED_WITH_ME'] = 'Со мной поделились';
...
$app_list_strings['sales_stage_classification_dom'] = [
    ['Открытый', 'Открытые'],
    ['Успешно закрытые', 'Успешно закрытые'],
    ['Закрытые без успеха', 'Закрытые без успеха'],
];

// Market
$app_strings['LBL_ATTENDED'] = 'Присутствовал';
$app_strings['LBL_REGISTERED'] = 'Зарегистрированный';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'Просмотр в Sugar Market';
