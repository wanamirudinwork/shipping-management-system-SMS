...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'ランディングページ',
        'sf_EventManagement' => 'イベント管理',
        'sf_webActivity' => 'Web アクティビティ',
        'sf_WebActivityDetail' => 'Webアクティビティの詳細',
    ...
    'moduleListSingular' => [
        ...
        'sf_EventManagement' => 'イベント管理',
        'sf_webActivity' => 'Web アクティビティ',
        'sf_WebActivityDetail' => 'Web アクティビティの詳細',
        'Transcripts' => 'トランスクリプト',
    ],
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-event-mgmt-xl' => 'イベント管理 Xl',
        'sicon-landing-pages-xl' => 'ランディングページ Xl',
        'sicon-web-xl' => 'Web アクティビティXl',
        'sicon-web-activity-detail-xl' => 'Web アクティビティの詳細 Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'SugarCRM、Sugarおよび3-DキューブはSugarCRM Inc. の登録商標です。 ' .
        ...
        'SugarCRM ®、Sugar Enterprise™、および Sugar™ は、SugarCRM Inc. の登録商標です。',
    'LBL_TRADEMARK2' => 'SugarCRM®、Sugar Enterprise™、およびSugar™ は、SugarCRM Inc. の商標です。',
    ...
    'LBL_EMAIL_CONNECTING' => '接続中...',
    'LBL_EMAIL_NOT_AUTHORIZED' => '未承認',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'お使いのメールアカウントに選択されている送信メールサーバーが無効です。設定をご確認ください。',
...
このアクションを実行するとすぐにログアウトされ、次回ログイン時に認証アプリを使用して認証する必要があります。',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => '結果セットには 1 つのレコードがあります。',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => '結果セットには、{{num}} のレコードがあります。',
...
"5. アプリケーションでアクションメニューのインポートオプションをクリックしてアップロードするファイルを選択します"   ',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'フォルダは削除できません。',
    'LBL_RECENTLY_RESOLVED_ISSUES' => '最近解決した',
    'LBL_OPEN_ISSUES' => '{{module}} を開く',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'ダッシュボードの構成が変更され、ダッシュボードが自動的に更新されます',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'オポチュニティレコードには、少なくとも 1 つの収益品目が含まれている必要があります。',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => '詳細ログモードを有効にしますか?',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => '詳細ログモードが有効になっています。',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => '詳細ログ',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'トレーニングと認定',
    'LBL_WIZ_DOCUMENTATION' => 'ドキュメンテーション',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'ヘルプ記事',
    'LBL_WIZ_FORUMS' => 'SugarClub コミュニティ',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'Sugar Discover レポートを表示',
...
代わりに、既存のレコードの値ではなく今入力した値を使用する場合は、[元にリセット] をクリックします。入力した値は既存のレコードに適用され、さらに追加の変更を加え、既存のレコードへの変更を確定する[保存] をクリックします。入力した値を使用して新しいレコードを作成するには、画面右上の[重複を無視して保存」をクリックします。',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'カレンダー',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'プレビューの読み込み中にエラーが発生しました。もう一度お試しください。',
    ...
    'LBL_AI_OPP_WON_SCORE' => '受注予測スコア',
    'LBL_AI_LEAD_CONV_SCORE' => 'コンバージョン予測スコア',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'DocuSign を使用してドキュメントを送信し、ステータスを追跡する。',
    // Base sales stages
    'LBL_OPEN' => '開く',
    'LBL_CLOSED_WON' => '受注',
    'LBL_CLOSED_LOST' => '失注',
    ...
    'LBL_CJ_WEBHOOKS' => 'Sugar Automate Webフック',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Smart Guide の進捗状況',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Sugar Automate の「Smart Guide の進捗状況」の円グラフを表示します。',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'スマートガイドの進行状況',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Sugar Automateの「スマートガイドの進行状況」の円グラフを表示します。',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'Sugar 認証情報を使ってログイン',
    'LBL_DRI_STAGES' => 'ステージ',
    'LBL_DRI_NO_SMART_GUIDES' => '{{{filterName}}} がありません',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide にステージがありません',
    'LBL_DRI_START_SMART_GUIDE' => 'Smart Guide を開始',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'この {{{moduleName}}} の {{{templateName}}} を開始しますか？',
    'LBL_DRI_ACTIVE_GUIDES' => 'アクティブな Smart Guide',
    'LBL_DRI_ARCHIVED_GUIDES' => 'アーカイブ済みの Smart Guide',
    'LBL_VIEW_ATTACHMENTS' => '添付ファイルを見る',
    'LBL_VIEW_FILES' => 'ファイルを見る',
...
$app_strings['LBL_SHARED_WITH_ME'] = '自分と共有';
...
// Market
$app_strings['LBL_ATTENDED'] = '出席';
$app_strings['LBL_REGISTERED'] = '登録済み';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'Sugar Market で表示';
