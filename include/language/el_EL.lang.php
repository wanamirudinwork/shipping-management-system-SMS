...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'Σελίδες Προορισμού',
        'sf_EventManagement' => 'Διαχείριση Εκδηλώσεων',
        'sf_webActivity' => 'Δραστηριότητα Ιστού',
        'sf_WebActivityDetail' => 'Λεπτομέρεια Δραστηριότητας Ιστού',
    ...
    'moduleListSingular' => [
        ...
        'sf_Dialogs' => 'Σελίδα Προορισμού',
        'sf_EventManagement' => 'Διαχείριση Εκδηλώσεων',
        'sf_webActivity' => 'Δραστηριότητα Ιστού',
        'sf_WebActivityDetail' => 'Λεπτομέρεια Δραστηριότητας Ιστού',
        'Transcripts' => 'Μεταγραφή',
    ],
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-event-mgmt-xl' => 'Διαχείριση εκδηλώσεων Xl',
        'sicon-landing-pages-xl' => 'Σελίδες Προορισμού Xl',
        'sicon-web-xl' => 'Δραστηριότητα Ιστού Xl',
        'sicon-web-activity-detail-xl' => 'Λεπτομέρειες Δραστηριότητας Ιστού Xl',
        ],
...
$app_strings = [
    ...
    'LBL_TRADEMARK' => 'Tο SugarCRM, τo Sugar και ο 3-D κύβος είναι σήματα κατατεθέντα της SugarCRM Inc. ' .
        ...
        'Οι επωνυμίες SugarCRM ®, Sugar Enterprise™ και Sugar™ είναι εμπορικά σήματα της SugarCRM Inc.',
    'LBL_TRADEMARK2' => 'Οι ονομασίες SugarCRM ®, Sugar Enterprise™ και Sugar™ είναι εμπορικά σήματα της SugarCRM Inc.',
    ...
    'LBL_EMAIL_CONNECTING' => 'Σύνδεση...',
    'LBL_EMAIL_NOT_AUTHORIZED' => 'Μη-εξουσιοδοτημένο',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'Ο διακομιστής εξερχόμενης αλληλογραφίας που έχει επιλεγεί για τον λογαριασμό αλληλογραφίας που χρησιμοποιείτε δεν είναι έγκυρος, ελέγξτε τη ρύθμιση.',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => 'Μαζική ενημέρωση',
    ...
    'LBL_SEARCH_SUGAR' => 'Αναζήτηση σε όλο το Sugar&#8230;',
...
Αν εκτελέσετε αυτήν την ενέργεια, θα αποσυνδεθείτε αμέσως και θα χρειαστεί να κάνετε ξανά έλεγχο ταυτότητας χρησιμοποιώντας την εφαρμογή ελέγχου ταυτότητας την επόμενη φορά που θα συνδεθείτε.',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => 'Υπάρχει 1 εγγραφή στο σύνολο αποτελεσμάτων.',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => 'Υπάρχουν {{num}} εγγραφές στο σύνολο αποτελεσμάτων.',
    ...
    'LBL_TABBED_DASHLET_MODULES_UNAVAILABLE' => 'Τα δεδομένα δεν είναι διαθέσιμα. Δεν έχετε άδεια πρόσβασης σε αυτές τις ενότητες.' .
    " \nΕνημερώστε ή αφαιρέστε αυτόν τον πίνακα στοιχείων.",
    ...
    'LBL_ALT_NOT_SORTED' => 'Δεν έχει ταξινομηθεί',
    'LBL_ALT_SORT_DESC' => 'Φθίνουσα Ταξινόμηση',
    'LBL_ALT_SORT_ASC' => 'Αύξουσα Ταξινόμηση',
    'LBL_ALT_SORTABLE' => 'Με δυνατότητα ταξινόμησης',
    'LBL_ALT_NOT_SORTABLE' => 'Χωρίς δυνατότητα ταξινόμησης',
    'LBL_ALT_SORT' => 'Είδος',
    ...
    'LBL_CONFIRMATION_POPUP' => 'Αναδυόμενο πλαίσιο επιβεβαίωσης',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'Δεν είναι δυνατή η διαγραφή του φακέλου.',
    'LBL_RECENTLY_RESOLVED_ISSUES' => 'Επιλύθηκαν πρόσφατα',
    'LBL_OPEN_ISSUES' => 'Άνοιγμα {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Έχετε εξαντλήσει τον χώρο για αποθήκευση offline. Θα εκτελεστεί εκκαθάριση αποθηκευτικού χώρου. Μπορεί να διαρκέσει αρκετά λεπτά.',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'Η διαμόρφωση του πίνακα εργαλείων σας έχει αλλάξει και ο πίνακας εργαλείων θα ανανεωθεί αυτόματα',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'Η εγγραφή ευκαιρίας πρέπει να έχει τουλάχιστον ένα Στοιχείο Γραμμής Εσόδων.',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => 'Θέλετε να ενεργοποιήσετε τη λειτουργία καταγραφής για προχωρημένους;',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => 'Η λειτουργία καταγραφής για προχωρημένους ενεργοποιήθηκε.',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => 'Καταγραφή για προχωρημένους',
    ...
    //14.0 Dashboards
    'LBL_BDR_CONSOLE' => 'Πίνακας εργαλείων BDR',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'Εκπαίδευση και πιστοποίηση',
    'LBL_WIZ_DOCUMENTATION' => 'Τεκμηρίωση',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'Άρθρα βοήθειας',
    'LBL_WIZ_FORUMS' => 'Κοινότητα SugarClub',
    ...
    'LBL_SUGAR_APPS_DASHLET_DESC' => 'Επιτρέπει στους χρήστες να προσθέτουν εφαρμογές Sugar σε ένα Dashboard',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'Εμφανίζει μια αναφορά Sugar Discover.',
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην απεικόνιση καταλόγου {{plural_module_name}}.',
    ...
    'LBL_CALENDAR_REPEAT_MONTH' => 'Μήνας(-ες) του έτους',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'Ημερολόγιο',
    ...
    'LBL_PMSE_ACTIVITY_CHANGE_FIELD_WARNING' => 'Τα ακόλουθα αναπτυσσόμενα πεδία περιέχουν μη έγκυρες επιλογές',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'Παρουσιάστηκε σφάλμα κατά τη φόρτωση της προεπισκόπησης. Προσπαθήστε ξανά.',
    ...
    'LBL_AI_OPP_WON_SCORE' => 'Βαθμολογία πρόβλεψης κερδισμένων πωλήσεων',
    'LBL_AI_LEAD_CONV_SCORE' => 'Βαθμολογία πρόβλεψης μετατροπής δυνητικών πελατών',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'Αποστολή εγγράφων με DocuSign και παρακολούθηση κατάστασης.',
    // Base sales stages
    'LBL_OPEN' => 'Ανοιχτό',
    ...
    'LBL_ACTIVITY_STATUS_READ_ONLY' => 'Δεν είναι δυνατή η ολοκλήρωση αυτής της ενέργειας. Το πεδίο Κατάσταση για αυτή τη μονάδα δραστηριοτήτων είναι ρυθμισμένο "μόνο για ανάγνωση", εμποδίζοντας οποιαδήποτε ενέργεια του Smart Guide που ενημερώνει το πεδίο Κατάσταση.',
    'LBL_CHILD_ACTIVITY_STATUS_READ_ONLY' => 'Δεν είναι δυνατή η ολοκλήρωση αυτής της ενέργειας. Το πεδίο Κατάσταση για αυτές τις μονάδες δραστηριοτήτων και/ή δευτερευουσών δραστηριοτήτων είναι ρυθμισμένο "μόνο για ανάγνωση", εμποδίζοντας οποιαδήποτε ενέργεια του Smart Guide που ενημερώνει το πεδίο Κατάσταση.',
    'LBL_GUIDE_CANCELLATION_ACTION_ACTIVITY_STATUS_READ_ONLY' => 'Το πεδίο Κατάσταση για κάποιες ενότητες δραστηριοτήτων στον οδηγό είναι ρυθμισμένο "μόνο για ανάγνωση", αυτές οι δραστηριότητες θα παραμείνουν αμετάβλητες μετά την ακύρωση του οδηγού.',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'Σύνδεση με διαπιστευτήρια Sugar',
    'LBL_DRI_STAGES' => 'Στάδια',
    'LBL_DRI_NO_SMART_GUIDES' => 'Δεν βρέθηκε {{{filterName}}}',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Ο Smart Guide δεν έχει στάδια',
    'LBL_DRI_START_SMART_GUIDE' => 'Εκκίνηση Smart Guide',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'Θέλετε να εκκινήσετε το {{{templateName}}} για την ενότητα {{{moduleName}}};',
    'LBL_DRI_ACTIVE_GUIDES' => 'Ενεργοί Smart Guides',
    'LBL_DRI_ARCHIVED_GUIDES' => 'Αρχειοθετημένοι Smart Guides',
    'LBL_VIEW_ATTACHMENTS' => 'Προβολή συνημμένων',
    'LBL_VIEW_FILES' => 'Προβολή αρχείων',
...
$app_list_strings['sales_stage_classification_dom'] = [
    ['Άνοιγμα', 'Άνοιγμα'],
    ['Έκλεισε Κερδισμένο', 'Έκλεισε Κερδισμένο'],
    ['Έκλεισε Χαμένο', 'Έκλεισε Χαμένο'],
];

// Market
$app_strings['LBL_ATTENDED'] = 'Παριστάμενοι';
$app_strings['LBL_REGISTERED'] = 'Εγγεγραμμένοι';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'Προβολή στο Sugar Market';
