...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => 'Mērķlapas',
        'sf_EventManagement' => 'Notikumu pārvaldība',
        'sf_webActivity' => 'Darbība tīmeklī',
        'sf_WebActivityDetail' => 'Informācija par darbībām tīmeklī',
...
//prospect list type dom
    ...
    //Service Duration
        ...
        'sicon-ai-xl' => 'Sugar prognoze Lg',
        'sicon-ai' => 'Sugar prognoze',
        ...
        'sicon-event-mgmt-xl' => 'Notikumu pārvaldība Xl',
        'sicon-landing-pages-xl' => 'Mērķlapas Xl',
        'sicon-web-xl' => 'Darbība tīmeklī Xl',
        'sicon-web-activity-detail-xl' => 'Informācija par darbībām tīmeklī Xl',
        ],
...
$app_strings = [
    ...
    'LBL_EMAIL_CONNECTING' => 'Savieno...',
    'LBL_EMAIL_NOT_AUTHORIZED' => 'Nav autorizēts',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => 'Izejošā pasta serveris, kas izvēlēts jūsu izmantotajam pasta kontam, nav derīgs, lūdzu, pārbaudiet iestatījumu.',
  ...
  Lūdzu nomainiet to vērtības.',
    ...
    'LBL_MASS_UPDATE_CHECKBOX' => 'Masveida atjaunināšana',
    ...
    'LBL_SEARCH' => 'Meklēt',
    'LBL_SEARCH_SUGAR' => 'Meklēt visu Sugar&#8230;',
...
Veicot šo darbību, jūs nekavējoties iziesiet, un nākamajā reizē jums būs jāveic autentifikācija, izmantojot autentifikācijas lietotni.',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => 'Rezultātu kopā ir 1 ieraksts.',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => 'Ir {{num}} ieraksti rezultātu kopā.',
...
"Šis ir importa faila paraugs, kurš piedāvā piemēru faila saturam, kurš ir gatavs importēšanai." "Faila formāts ir ar paplašinājumu .csv, kurš izmanto dubultās pēdiņas, lauku noteikšanai." "Galvenes rinda ir pirmā rinda failā un satur lauka iezīmes, kā redzams lietotnē." "Šīs iezīmes lieto, kartējot datus no faila uz lietojumprogrammas laukiem." "Piezīmes: Arī datubāzes lauku nosaukumus var lietot galvenes rindā. Tas noder gadījumos, kad tiek lietots phpMyAdmin vai cits datubāzes rīks, lai varētu importēt eksportēto datu sarakstu." "Kolonu secība nav tik nozīmīga, jo importēšanas procesā lauki tiek sakārtoti, balstoties uz galvenes rindu." "Lai lietotu failu kā veidni, veic sekojošas darbības:" "1.Izņemiet ierakstu parauga rindas" "2. Izņemiet palīdzības tekstu, kuru šobrīd lasāt" "3. Ievadiet savus datus paredzētajās rindās un kolonās" "4. Saglabājiet failus savā sistēmā, jums zināmā vietā" "5. Nospiediet uz importēšanas iespējas, kura atrodas darbību izvēlnē lietotnē, un izvēlieties failu, kuru augšuplādēt"   ',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => 'Mapi nevar izdzēst.',
    'LBL_RECENTLY_RESOLVED_ISSUES' => 'Nesen atrisinātie',
    'LBL_OPEN_ISSUES' => 'Atvērts {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Jums vairs nav vietas bezsaistes krātuvei. Tiks veikta krātuves tīrīšana. Tas var aizņemt vairākas minūtes.',
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => 'Jūsu informācijas paneļa konfigurācija ir mainījusies, un informācijas panelis tiks automātiski atsvaidzināts',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => 'Darījuma ierakstā ir jābūt vismaz vienam ieņēmumu posteņa vienumam.',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => 'Vai vēlaties iespējot papildu reģistrēšanas režīmu?',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => 'Iespējots papildu reģistrēšanas režīms.',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => 'Papildu reģistrēšana',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => 'Apmācība un sertifikācija',
    'LBL_WIZ_DOCUMENTATION' => 'Dokumentācija',
    'LBL_WIZ_KNOWLEDGE_BASE' => 'Palīdzības raksti',
    'LBL_WIZ_FORUMS' => 'SugarClub kopiena',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => 'Parāda Sugar Discover atskaiti.',
...
Lai izveidotu jaunu ierakstu, izmantojot ievadītās vērtības, uzklikšķiniet uz "Ignorēt dublikātu un saglabāt" ekrāna augšējā labajā stūrī.',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => 'Kalendārs',
...
// Omnichannel
    ...
    'LBL_PREVIEW_ERROR' => 'Ielādējot priekšskatījumu, radās kļūda. Lūdzu, mēģiniet vēlreiz.',
    ...
    'LBL_AI_OPP_WON_SCORE' => 'Uzvaras prognozes rezultāts',
    'LBL_AI_LEAD_CONV_SCORE' => 'Konversijas prognozes rezultāts',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => 'Sūtiet dokumentus, izmantojot DocuSign, un sekojiet statusam.',
    // Base sales stages
    'LBL_OPEN' => 'Atvērt',
    ...
    'LBL_LOGIN_SUGAR_BTN' => 'Pieteikties ar Sugar akreditācijas datiem',
    'LBL_DRI_STAGES' => 'Posmi',
    'LBL_DRI_NO_SMART_GUIDES' => 'Nav atrasts {{{filterName}}}',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide nav posmu',
    'LBL_DRI_START_SMART_GUIDE' => 'Sākt Smart Guide',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => 'Vai vēlaties sākt {{{templateName}}} šim {{{moduleName}}}?',
    'LBL_DRI_ACTIVE_GUIDES' => 'Aktīvie Smart Guides',
    'LBL_DRI_ARCHIVED_GUIDES' => 'Arhivētie Smart Guides',
    'LBL_VIEW_ATTACHMENTS' => 'Skatīt pielikumus',
    'LBL_VIEW_FILES' => 'Skatīt failus',
...
$app_list_strings['sales_stage_classification_dom'] = [
    ['Atvērt', 'Atvērt'],
    ['Aizvērts-noslēgts', 'Aizvērts-noslēgts'],
    ['Aizvērts-zaudēts', 'Aizvērts-zaudēts'],
];

// Market
$app_strings['LBL_ATTENDED'] = 'Piedalījās';
$app_strings['LBL_REGISTERED'] = 'Reģistrēts';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = 'Skatīt Sugar Market';
