...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'sf_Dialogs' => '登陆页面',
        'sf_EventManagement' => '事件管理',
        'sf_webActivity' => 'Web 活动',
        'sf_WebActivityDetail' => 'Web 活动详细信息',
        'Transcripts' => '转录',
    ],
...
漏洞',
        ...
        'sicon-event-mgmt-xl' => '事件管理 Xl',
        'sicon-landing-pages-xl' => '登陆页面 Xl',
        'sicon-web-xl' => 'Web 活动 Xl',
        'sicon-web-activity-detail-xl' => 'Web 活动详细信息 Xl',
        ],
...
$app_strings = [
    ...
    'LBL_FOLLOW' => '关注', // Record view header panel element
    ...
    'LBL_EMAIL_CONNECTING' => '正在连接...',
    'LBL_EMAIL_NOT_AUTHORIZED' => '未授权',
    'LBL_EMAIL_RE_AUTHORIZE_ACCOUNT' => '您使用的邮件帐户选择的出站邮件服务器无效，请检查设置。',
...
执行此操作会立即使您注销，下次登录时您将需要使用验证器应用验证身份。',
    ...
    'LBL_CONSOLE_FILTER_RESULT_ONE_RECORD' => '结果集中有 1 条记录。',
    'LBL_CONSOLE_FILTER_RESULT_MANY_RECORDS' => '结果集中有 {{num}} 条记录。',
...
"5. 在程序中从操作菜单中点击导入选项，并选择文件上传"',
    ...
    'LBL_DRIVE_FOLDER_DELETE_ERROR' => '无法删除文件夹。',
    'LBL_RECENTLY_RESOLVED_ISSUES' => '最近解决',
    'LBL_OPEN_ISSUES' => '打开 {{module}}',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => '您的离线存储空间不足。将执行存储清理。这可能需要几分钟时间。',
...
请在设备设置中设置 {{{biometryType}}}。设置后，在“主菜单” > “设置”中为 {{{brandName}}} 启用
 {{{biometryType}}}。",
    ...
    'LBL_DASHBOARDS_CHANGED_ALERT' => '您的仪表板配置已更改，仪表板将自动刷新',
    'LBL_LEAD_CONVERSION_MISSING_RLI' => '“商机”记录应至少包含一个收入行项目。',
    'LBL_LOGGING_CONFIRM_ADVANCED_MODE' => '是否要启用高级日志记录模式？',
    'LBL_LOGGING_ADVANCED_MODE_ENABLED' => '已启用高级日志记录模式。',
    'LBL_LOGGING_ADVANCED_MODE_LABEL' => '高级日志记录',
    ...
    //User wizard links
    'LBL_WIZ_SUGAR_TRAINING' => '培训与证书',
    'LBL_WIZ_DOCUMENTATION' => '文件',
    'LBL_WIZ_KNOWLEDGE_BASE' => '帮助文章',
    'LBL_WIZ_FORUMS' => 'SugarClub 社区',
    ...
    'LBL_SUGAR_DISCOVER_DASHLET_DESCRIPTION' => '显示 Sugar Discover 报告。',
...
若要使用您所输入的值创建新记录，单击屏幕右上方的“忽略复制并保存”。',
    ...
    'LBL_CALENDAR_DASHLET_DESCRIPTION' => '日历',
    ...
    'LBL_AGENT_WORKBENCH_FOLLOW_UP' => '关注',
...
// Omnichannel
    ...
    'LBL_AI_OPP_WON_SCORE' => '赢得客户预测分数',
    'LBL_AI_LEAD_CONV_SCORE' => '转化预测分数',
    ...
    'LBL_DASHLET_DOCUSIGN_DESCRIPTION' => '使用 DocuSign 发送文档并跟踪状态。',
    // Base sales stages
    'LBL_OPEN' => '打开',
    'LBL_CLOSED_WON' => '成单结束',
    ...
    'LBL_LOGIN_SUGAR_BTN' => '使用 Sugar 凭据登录',
    'LBL_DRI_STAGES' => '阶段',
    'LBL_DRI_NO_SMART_GUIDES' => '未找到 {{{filterName}}}',
    'LBL_DRI_NO_SMART_GUIDES_STAGES' => 'Smart Guide 没有阶段',
    'LBL_DRI_START_SMART_GUIDE' => '启动 Smart Guide',
    'LBL_DRI_START_SMART_GUIDE_CONFIRM' => '是否要为此 {{{moduleName}}} 启动 {{{templateName}}}？',
    'LBL_DRI_ACTIVE_GUIDES' => '活动的 Smart Guide',
    'LBL_DRI_ARCHIVED_GUIDES' => '存档的 Smart Guide',
    'LBL_VIEW_ATTACHMENTS' => '查看附件',
    'LBL_VIEW_FILES' => '查看文件',
...
$app_strings['LBL_SHARED_WITH_ME'] = '与我共享';
...
// Market
$app_strings['LBL_ATTENDED'] = '已参加';
$app_strings['LBL_REGISTERED'] = '已注册';
$app_strings['LBL_VIEW_IN_SUGAR_MARKET'] = '在 Sugar Market 中查看';
