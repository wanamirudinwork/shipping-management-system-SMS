...
class SugarApplication
{
    ...
    public function execute()
    {
        ...
        SugarMetric_Manager::getInstance()->setTransactionName('rest_' . $module . '_' . $this->controller->action ?? '');
        $this->controller->execute();
        if (empty($_REQUEST['entryPoint'])
            || $this->controller->checkEntryPointRequiresAuth($_REQUEST['entryPoint'])
        ) {
...
EOF;
    ...
    /**
     * Load dropdowns style
     */
    public static function preLoadDropdownsStyle()
    {
