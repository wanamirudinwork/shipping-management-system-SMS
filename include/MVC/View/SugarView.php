...
EOQ;
    ...
    public static function getJavascriptValidation()
    {
        ...
        $the_script = "<script type=\"text/javascript\">\n" . "\tvar time_reg_format = '" .
            ...
            "\tvar time_separator = '" . Escape::js($time_separator) ."';\n" .
            "\tvar cal_date_format = '" . Escape::js($cal_date_format) ."';\n" .
            "\tvar time_offset = $hour_offset;\n" . "\tvar num_grp_sep = '" . Escape::js($num_grp_sep) . "';\n" .
            "\tvar dec_sep = '" . Escape::js($dec_sep) ."';\n" . "\tvar date_reg_format_rpt = '" .
...
EOHTML;
    ...
    protected function _getModuleTab()
    {
        ...
        $defaultTab = (safeInArray('Home', $userTabs)) ? 'Home' : key($userTabs);
