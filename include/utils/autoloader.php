...
class SugarAutoLoader
{
    ...
    /**
     * Enables writing to class_map.php
     */
    public static bool $enableClassMapUpdates = true;
    ...
    {
        self::logDeprecation(__METHOD__ . ' is deprecated');
    ...
    public static function buildClassCache()
    {
        ...
        if (!self::$devMode && self::$enableClassMapUpdates) {
    ...
    {
        if (!self::$devMode && self::$classMapDirty && !empty(self::$classMap) && self::$enableClassMapUpdates) {
    ...
    {
        if (isset($GLOBALS['log']) && $GLOBALS['log'] instanceof \LoggerManager) {
