...
(function(app) {
    app.events.on("app:init", function() {
        ...
        app.utils = _.extend(app.utils, {
                ...
                TagBuilderFactory: function(type, name, attributes) {
                    ...
                    function CollectionTag() {
                        ...
                        this.compile = function compile() {
                            ...
                            let startingCollectionTag = `{#${name}${eachAttributes ? ' ' + eachAttributes : ''}}`;
                        ...
                        /**
                         * Resets the collection table fields.
                         *
                         * @return {CollectionTag}
                         */
                        this.resetCollectionTableFields = function() {
                            this.collectionTags.fields = [];
                        ...
                        this.setCollectionTags = function(startingCollectionTag, endingCollectionTag) {
                            this.collectionTags = this.collectionTags || {};
                            this.collectionTags.startingCollectionTag = startingCollectionTag;
                            this.collectionTags.endingCollectionTag = endingCollectionTag;
            ...
            /**
             * Toggles whether the #content div should take up the full available
             * space or have its smaller "floating" form
             */
            toggleFullContentDiv: function(toggle) {
                app.$contentEl.toggleClass('!content-full', !!toggle);
            }
        });
    });
})(SUGAR.App);
