...
(function register(app) {
    app.events.on('app:init', function init() {
        ...
        */
         ...
         * @return {Object} Sidecar model update data
         */
        UpdateRecord.prototype.normalizeRelateValue = function(fieldDef, fieldData, model) {
         ...
         * @return {Object} Sidecar model update data
         */
        UpdateRecord.prototype.normalizeParentValue = function(fieldDef, fieldData, model) {
