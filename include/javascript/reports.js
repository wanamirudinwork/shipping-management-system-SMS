	...
	return {
		...
		init: function(img, report_def_str, user_array, origImgPath) {
			...
			if (report_def_str == "") {
                ...
                SUGAR.reports.restrictDistinct(report_type);
		...
		prepareReportForProcessing: function() {
            ...
            report_def.show_distinct = document.ReportsWizardForm.show_distinct.checked;
			if (report_type != 'tabular')
		...
		selectReportType: function (reportType, matrixReport) {
			...
			if (matrixReport && matrixReport == true)
				isMatrix = true;
			SUGAR.reports.showWizardStep(0);
            SUGAR.reports.restrictDistinct(reportType);
		},
        ...
        /**
		 * This function restricts the use of the "Show Distinct" checkbox in the report wizard.
		 * @param {String} reportType - The type of the report (tabular, summation, matrix)
		 * @return {Void}
		 */
        restrictDistinct: function(reportType) {
            let distinctCheckbox = document.getElementById('show_distinct');
            if (reportType !== 'tabular' && distinctCheckbox &&
				distinctCheckbox.closest('tr').style.display !== 'none') {
                distinctCheckbox.closest('tr').style.display = 'none';
