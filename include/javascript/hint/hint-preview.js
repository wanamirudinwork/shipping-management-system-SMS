...
(function(app) {
    ...
    function _editStyles() {
        ...
        self && self.$('li[data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
    ...
    function _editStylesHintUndo() {
        ...
        if (tabbable._components) {
            const expectedNrOfComponents = 3;

            if (tabbable._components.length < expectedNrOfComponents) {
                return;
            }
