...
class ExtAPIDocuSign extends ExternalAPIBase
{
    ...
    public function createANewEnvelope($args)
    {
        ...
        $apiData = $this->getApiData($eapmBean);
        $accountId = $apiData['accountId'] ?? null;
     ...
     * @param DocuSign\Model\EnvelopeViewRequest $envelopeViewRequest
     * @return DocuSign\Model\ViewUrl|Array
     */
    public function createSenderView($createdEnvelopeId, $envelopeViewRequest)
    {
        $eapmBean = $this->getEAPMBean();
        if (empty($eapmBean)) {
        ...
        $senderView = $envelopeApi->createSenderView($accountId, $createdEnvelopeId, $envelopeViewRequest);
        return $senderView;
    }
