...
trait RecurringCalendarEventTrait
{
     ...
     * triggered.
     *
     * @param bool $seriesDeleted
     */
    public function markRepeatDeleted(bool $seriesDeleted = false)
    {
        ...
        $isSeriesDeleted = $seriesDeleted ? 1 : 0;
        ...
        foreach ($rows as $row) {
            ...
            if ($bean) {
                ...
                $db->query("UPDATE {$bean->table_name} SET deleted = 1, series_deleted = $isSeriesDeleted, date_modified = "
    ...
    public function createRecurringEvents(array $timeArray): array
    {
        ...
        foreach ($timeArray as $dateStart) {
            $date = SugarDateTime::createFromFormat($datetimeFormat, $dateStart, $gmtTimezone);
            ...
            $startDate = SugarDateTime::createFromFormat($datetimeFormat, $dateStart, $gmtTimezone);
    ...
    public function correctRecurrences(string $beanId)
    {
        ...
        foreach ($occurrences as $occurrence) {
            ...
            $targetOccurence->repeat_parent_id = null;
            $targetOccurence->recurring_source = null;
            $targetOccurence->rset = json_encode($rset);
            $targetOccurence->event_type = $this->event_type;
            $targetOccurence->date_modified = $dateModified;
            $targetOccurence->date_recurrence_modified = $this->date_recurrence_modified;

            $targetOccurence->save();
        }
        ...
        if ($newParentId) {
            ...
            $db->updateParams(
                ...
                $this->field_defs,
                $params,
                ['repeat_parent_id' => $beanId, 'deleted' => 0]
            );
        }
    }
