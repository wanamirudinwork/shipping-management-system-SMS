...
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Srn\Converter::class)]
class ConverterTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return array
     */
    public static function fromStringNotValidSrnProvider()
    {
        return [
            'invalidScheme' => [
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('fromStringNotValidSrnProvider')]
    ...
    public static function fromStringValidSrnDataProvider()
    {
        return [
            'full path tenant' => [
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('fromStringValidSrnDataProvider')]
     ...
     * @return array
     */
    public static function toStringNotValidSrnProvider()
    {
        $fixture = [
            'setPartition' => 'cloud',
            'setService' => 'idp',
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('toStringNotValidSrnProvider')]
