...
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\Authentication\UserMapping\SAMLUserMapping::class)]
class SAMLUserMappingTest extends \PHPUnit\Framework\TestCase
{
    /**
     *
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('getMappingDataProvider')]
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('mapIdentityDataProvider')]
    ...
    public static function getIdentityValueDataProvider()
    {
        return [
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('getIdentityValueDataProvider')]
