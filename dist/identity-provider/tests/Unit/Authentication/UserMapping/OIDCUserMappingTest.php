...
#[\PHPUnit\Framework\Attributes\CoversClass(\Sugarcrm\IdentityProvider\Authentication\UserMapping\OIDCUserMapping::class)]
class OIDCUserMappingTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @return array
     */
    public static function getMappingDataProvider(): array
    {
        return [
