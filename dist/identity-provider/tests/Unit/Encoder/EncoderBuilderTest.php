...
class EncoderBuilderTest extends \PHPUnit\Framework\TestCase
{
    public static function buildEncoderDataProvider()
    {
        return [
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('buildEncoderDataProvider')]
