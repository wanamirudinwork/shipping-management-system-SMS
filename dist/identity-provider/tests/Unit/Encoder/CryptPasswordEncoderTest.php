...
class CryptPasswordEncoderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function encodePasswordDataProvider()
    {
        return [
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('encodePasswordDataProvider')]
    ...
    public static function isPasswordValidDataProvider()
    {
        return [
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('isPasswordValidDataProvider')]
