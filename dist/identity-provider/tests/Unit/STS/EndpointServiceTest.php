...
#[\PHPUnit\Framework\Attributes\CoversClass(Sugarcrm\IdentityProvider\STS\EndpointService::class)]
class EndpointServiceTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var EndpointService
     */
     ...
     * @return array
     */
    public static function getKeysValidEndpointDataProvider()
    {
        return [
     ...
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('getKeysValidEndpointDataProvider')]
     ...
     * @return array
     */
    public static function getKeysInvalidEndpointDataProvider()
    {
        return [
            'endpointWithAllKeysType' => [
                'endpoint' => 'test',
     ...
     * @param string $keyType
     */
    #[\PHPUnit\Framework\Attributes\DataProvider('getKeysInvalidEndpointDataProvider')]
